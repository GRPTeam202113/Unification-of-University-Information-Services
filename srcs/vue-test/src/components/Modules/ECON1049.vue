...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Mathematical Economics and Econometrics',
year: 'Academic Year 2022',
credit: '30.00',
level: '1',
targetStudents: 'Year 2 Economics students',
offeringSchool: 'School of Economics',
taughtSemesters: 'Full year China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Xuewen Qian',
generalFurtherActivityDetail: '<br>Five tutorials in each semester.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To provide a sound basis in the fundamentals of mathematical methods used in economics.<br>2. To develop the ability to represent economic problems as mathematical problems and to solve them.<br>3. To provide a sound basis in statistical theory, appropriate to the subsequent study of econometrics.<br>4. To introduce the principles of regression analysis, on which much of the subsequent study of econometrics is based.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A4 Demonstrate understanding of verbal, graphical, mathematical and econometric representation of economic ideas and analysis, including the relationship between them.<br>A5 Show understanding of relevant mathematical and statistical techniques.<br>Intellectual Skills:<br>B1 Work with abstract concepts and in a context of generality.<br>B2 Reason logically and work analytically.<br>B3 Be able to evaluate, analyse and present quantitative data<br>Professional Practical Skills:<br>C2 Understand the sources and content of economic data and evidence, as well as appropriate methods of analysis (introducing)<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The first half of the module provides an introduction to the mathematical methods required for economic modelling, focusing on linear algebra, optimization and their role in formulating and solving economic problems. The second half introduces the statistical methods required for data analysis in Economics. We concentrate on statistical distribution theory and statistical inference before applying these concepts to the study of the linear regression model, whose extensions will be analysed in detail in subsequent Econometrics modules.</p><p>ECON1033 Introduction to Microeconomics and ECON1034 Introduction to Macroeconomics.</p><p>Please note: This module is assessed at the end of semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
assessmentFurtherActivityDetail: '<br>Five tutorials in each semester.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'ROGO 2',
weight: '20.00',
requirements: '1 hour online problem Set'
}, {
type: 'ROGO 1',
weight: '20.00',
requirements: '1 hour online problem Set'
}],
staffOffice: 'Room 305, IEB',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 (0)574 88180000(Ext.8680)',
staffDepartment: 'Faculty of Humanities and Social Sciences',
staffUrl: 'https://www.nottingham.edu.cn/en/Humanities-and-Social-Sciences/People/Profile.aspx?id=9d5a6549-eb8e-4ca8-96b1-0dbb41fc8116&amp;language=en-GB'
};
  },
  methods: {
    goPage() {
