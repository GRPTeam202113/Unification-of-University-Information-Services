...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Health Economics',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Year 3 Economics students or others with an interest in health behavior and health systems.',
