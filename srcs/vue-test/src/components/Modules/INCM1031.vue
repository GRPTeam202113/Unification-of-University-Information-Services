...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Media and Society',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><ul> <li>To provide a sound knowledge and critical understanding of the different factors underlying the development of the press, broadcasting and the internet</li> <li>To develop analytical and conceptual skills in writing on theoretical and substantive issues concerned with the social and political role of the mass media.</li> <li>To advance students through theoretical debates on the relationship between the media and politics, economic aspect of the media industry, and media and consumer society.</li> <li>To impart the knowledge required to understand the social forces and processes underlying the production of media texts, images and signs.<p> </p></li></ul></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><ul> <li>To understand the key social forces which have shaped the emergence of different media.</li> <li>To comprehend how media are embedded within different political, social and economic frameworks.</li> <li>To identify and assess the potential of new technologies such as the internet to widen democratic participation.</li> <li>To understand a broad range of arguments around the production, content and reception of media messages.<p> </p></li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module will critically evaluate the central role that the media play in an understanding of contemporary society. The course will guide you through a series of key debates around the development, composition and function of different kinds of media with a particular focus on newspapers, television and the internet. You will learn how to understand the relationship between media and society by analysing texts, audiences, media institutions and government regulations. The module will engage with the following key theoretical arguments: media and democracy, the public sphere, political communication, the watchdog function of the media, and alternative media.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
staffUrl: 'https://www.nottingham.edu.cn/en/Humanities-and-Social-Sciences/People/Profile.aspx?id=258be4bb-77c2-4427-8765-0a4eb9e2deb8&amp;language=en-GB'
};
  },
  methods: {
    goPage() {
