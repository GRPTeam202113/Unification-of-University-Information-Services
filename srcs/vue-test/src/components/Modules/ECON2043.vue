...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Experimental and Behavioural Economics',
...
type: 'Project1',
weight: '25.00',
requirements: 'Presentation and Group Essay (1500 words)'
}, {
type: 'exam1',
weight: '75.00',
