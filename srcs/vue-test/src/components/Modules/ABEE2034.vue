...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Architectural Engineering Design 4',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '<span style="font-size:11.0pt"><span style="font-family:&quot;Calibri&quot;,sans-serif"><span style="color:#1f497d">Design project report with calculation, drawings and explanations, 6000 words </span></span></span>'
}],
