...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Architectural Engineering Design 3',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'BEng Architectural Environment Engineering',
...
type: 'Coursework 1',
weight: '40.00',
requirements: '1 Project Report 1500 words'
}, {
type: 'Exam 1',
weight: '60.00',
