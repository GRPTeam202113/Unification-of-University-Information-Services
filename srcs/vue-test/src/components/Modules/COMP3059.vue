...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Mobile Device Programming',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Part II Undergraduate students in the School of Computer Science. This module is part of the Programming theme in the School of Computer Science.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To teach the principles of program design, and to give experience of designing and developing programs.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>ʥUnderstanding of the theory and practice of programming in the context of a mobile device.</p><p>Intellectual Skills:<br>ʥUnderstand and logically evaluate program requirements and specifications.<br>ʥUnderstand the complex ideas of programming solutions and relate them to particular problems.</p><p>Professional Skills:<br>ʥThe ability to write programs.<br>ʥThe ability to transfer programming skills between classes of devices.</p><p>Transferable Skills:<br>ʥThe ability to solve problems using programming including mathematical problems, to schedule and present their work and to retrieve additional learning material.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>You will look at the development of software applications for mobile devices, with a practical focus on the Android operating system. You will consider and use the software development environments for currently available platforms and the typical hardware architecture of mobile devices. You will spend around three hours per week in lectures and computer classes for this module.</p></div>',
...
type: 'Coursework 1',
weight: '30.00',
requirements: 'Series of assessed exercises'
}, {
type: 'Coursework 2',
weight: '40.00',
requirements: 'Assessed software development exercise'
}, {
type: 'Exam 1',
weight: '30.00',
