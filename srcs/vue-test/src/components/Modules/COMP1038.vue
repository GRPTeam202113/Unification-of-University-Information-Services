...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Programming and Algorithms',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science. This module is part of the Foundations of Computer Science theme in the School of Computer Science.',
...
type: 'Coursework 1',
weight: '75.00',
requirements: '4 pieces of weekly coursework'
}, {
type: 'Exam 1',
weight: '25.00',
