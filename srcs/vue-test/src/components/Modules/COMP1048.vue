...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Databases and Interfaces',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Mr Matthew Pike',
generalFurtherActivityDetail: '<br>Activities may take place every teaching week of the Semester or only in specified weeks. It is usually specified above if an activity only takes place in some weeks of a Semester<br><br>Further Activity Details:<br>One lectures (1 x 2hr) and 1 x 2hr practical per week.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><span style="color:#000000;"><span style="font-size:12px;"><span lang="EN-US"><span style="line-height:107%"><span style="font-family:"Arial",sans-serif">To provide students with a general introduction to the theory and practice of database systems. To enable students to gain experience with a modern database system through the use of the SQL language. To give an understanding of the structure and workings of database systems and provide some insight into recent developments. To give an understanding of the principles of event-driven programming. To enable students to gain experience with design and implementation of GUI interfaces within a database environment. </span></span></span></span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="margin-bottom:11px"><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">Knowledge and Understanding: Ability to understand and use SQL. An understanding of the ANSI/SPARC and relational models of database systems. Understanding of the principles of event-driven programming. Intellectual Skills: Basic knowledge of the mathematics underlying relational database systems. Ability to design and implement database systems. Ability to design and implement a simple Web GUI. Professional Skills: The use of SQL for database specification and manipulation. The use of web technologies and GUI interfaces for database front-end development. Transferable Skills: Understanding of the use and administration of database systems. Understanding the use of web technologies and GUI interfaces. </span></span></span></span></span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span style="color:#000000;"><span style="font-size:12px;"><span lang="EN-US"><span style="line-height:107%"><span style="font-family:"Arial",sans-serif">Co-requisite: COMP1034 Mathematics for Computer Scientists </span></span></span></span></span></p><p><span style="color:#000000;"><span style="font-size:12px;"><span lang="EN-US"><span style="line-height:107%"><span style="font-family:"Arial",sans-serif">Databases are everywhere and we interact with many different databases every day, using the web, using electronic calendars, diaries or timetables, making appointments, searching for contact details, shopping online, looking up directions, and many more things. These databases need to be both easy to use and fast. This module considers both the structure of databases, including how to make them fast, efficient and reliable, and the appropriate user interfaces which will make them easy to interact with for users. You will start by looking at how to design a database, gaining an understanding of the standard features that management systems provide and how you can best utilise them and then develop an interactive application to access your database. Throughout the lectures and computing sessions you will learn how to design and implement systems using a standard database management system, web technologies and GUI interfaces through practical programming/system examples. You will spend around two hours per week in lectures and two hours per week in organised computer labs studying for this module, and will be expected to spend additional time practising and completing your coursework.</span></span></span></span></span></p><p> </p></div>',
assessmentFurtherActivityDetail: '<br>Activities may take place every teaching week of the Semester or only in specified weeks. It is usually specified above if an activity only takes place in some weeks of a Semester<br><br>Further Activity Details:<br>One lectures (1 x 2hr) and 1 x 2hr practical per week.',
methodAndFrequency: [{
activity: 'Computing',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Coursework(Programming assignment)'
}, {
type: 'Coursework 2',
weight: '25.00',
requirements: 'Coursework(Programming assignment)'
