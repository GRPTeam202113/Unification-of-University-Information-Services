...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Engineering Management 2',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'This is a compulsory module for Mechanical Engineering students. Students from other courses and faculties, seeking a good understanding of a wide range of management topics, will find this module to be useful.',
...
assessmentTable: [{
type: 'Two in-term tests held under exam conditions',
weight: '100.00',
requirements: 'Two in-term tests held under exam conditions'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
