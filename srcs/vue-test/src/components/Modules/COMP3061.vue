...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Industrial Experience',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'This module is restricted to Part II and III UG students registered on programmes of study in the School of Computer Science.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of the module is to develop students who can independently self-manage, proactively interact and ethically apply their knowledge and skills in a real world context. <br>The students work to a set of graduate employability skills that are summarised in a list of skills (competencies).</p><p>They complete a personal skills audit at the start of the placement and are expected to improve their performance through a reflective self-improvement cycle of planning-doing-reviewing-learning-planning etc. Students collect evidence of their competence that they will use in their assessed portfolio. Whilst undertaking the activity the student should work in partnership with the supervisor/s to maximise their contribution to achieving the goals of the organisation.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Transferable, work-related and employability skills:<br> - knowledge of the language and culture of working environments<br> - career planning, including occupational awareness and judgement, awareness of work-related personal values, interests and skills, application and selection process skills<br> - skills and competences specific to Computer Science related roles<br> - practical skills appropriate to a discipline or profession<br> - professional communication skills (oral and written).</p><p>Higher Skills: <br> - critical thinking and analysis<br> - project and personal management skills.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Students taking part in activities relating to industrial experience in a Computer Science or Software Engineering enterprise may obtain academic credit for them. A full list of approved activities is available from the School Office. Activities will be related to demonstration of involvement in development of complex software in a team situation, subject to quality control procedures of an industrial or business practice. Evidence of working to and completing tasks relating to targets set by an employer and directly related to software development/programming will be required. Students will have undertaken an agreed number of hours on the activities, identified personal goals and targets in relation to these activities and maintained a reflective portfolio as a record of evidence of their competence and achievements. The nature of the activities undertaken will be subject to the approval of the module convenor before acceptance on the module.</p></div>',
