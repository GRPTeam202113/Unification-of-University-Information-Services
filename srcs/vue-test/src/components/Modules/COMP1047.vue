...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Systems and Architecture',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science. This module is part of the Operating Systems and Networks theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Ying Weng',
