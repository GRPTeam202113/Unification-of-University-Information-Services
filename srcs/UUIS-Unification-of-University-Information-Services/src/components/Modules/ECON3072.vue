...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Advanced Microeconomics',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to develop students" understanding of microeconomic theory with particular emphasis on showing the role information plays in markets. The material allows students to build on their prior learning in microeconomics.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A1 Demonstrate a broad knowledge of core areas of economics (practicing)<br>A3 Show understanding of analytical methods, both theory- and model-based.<br>Intellectual Skills:<br>B1 Work with abstract concepts and in a context of generality.<br>B2 Reason logically and work analytically.<br>B4 Be able to frame analysis of problems, identifying which parameters should be taken as fixed and why they might change<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module will cover topics in advanced microeconomics and decision theory. The precise content may vary from year to year, but the module will start from the basis established by ECON2028.</p><p>ECON2028 Microeconomic Theory is the requisite of this module.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
