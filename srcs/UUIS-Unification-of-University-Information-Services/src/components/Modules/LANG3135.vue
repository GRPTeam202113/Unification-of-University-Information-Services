...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Spanish 5B',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Priority will be given to students doing the module as a compulsory element of their degree.Successful completion of Spanish 5A or equivalent qualification. The Language Centre reserves the right to check students prior learning and qualifications and to move them to a more appropriate level if necessary.',
