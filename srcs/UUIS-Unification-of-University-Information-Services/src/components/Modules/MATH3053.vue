...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Game Theory',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Single Honours students from the School of Mathematical Sciences who have successfully completed Part I.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The purpose of this course is to show how games can be analysed, by computer and otherwise; how games can be related to numbers; the theory of a representative collections of (mathematical games); and how new games can be investigated and are related to other games. This course will broaden the students experience of using mathematics to analyse various situations in a logical manner. It will enable students to analyse familiar and unfamiliar situations in other areas of mathematics and elsewhere, where strategic decision-making is required.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>L1 – Find Nash equilibria and Pareto optima of games;<br>L2 – Construct and analyse games in extensive form, and apply alpha-beta pruning to game trees;<br>L3 – Understand the connection between combinatorial games and numbers, and determine the value of a game;<br>L4 – Find the Nim values of impartial games;<br>L5 – Analyse the properties of voting systems, and understand which of these properties are mutually exclusive.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Game theory contains many branches of mathematics (and computing); the emphasis here is primarily algorithmic. The course starts with an investigation into normal-form games, including strategic dominance, Nash equilibria, and the Prisoners Dilemma. We look at tree-searching, including alpha-beta pruning, the killer heuristic and its relatives. It then turns to mathematical theory of games; exploring the connection between numbers and games, including Sprague-Grundy theory and the reduction of impartial games to Nim.</p></div>',
