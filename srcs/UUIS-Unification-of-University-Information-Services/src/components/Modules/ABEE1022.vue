...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Architectural Humanities 1:  History of Architectural meaning from Antiquity to the Present Day',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: '1st year Architecture students',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>Familiarising students with major architectural styles and movements through an in-depth examination of key examples;Exploring the social and technological changes that brought the different architectural movements into being;Developing an understanding of the present state and practice of architecture; and teaching basic architectural history research methods.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Upon completion of the module, students will be able:</p><p>To both widen and deepen knowledge and understanding of architectural history, from antiquity to the present day (GC7.1, GA1);</p><p>To understand the influence of social, political, and religious contexts on architecture (GC2, GC5);</p><p>To understand the significance of technological changes to built form (GC2,  GC5,  GC8.1);</p><p>To develop key analytical, intellectual, and transferrable skills (GC2, GC5); </p><p>To use diagrams, models and other visual media to analyse, buildings (GA1);</p><p>To construct cogent arguments (GC2, GC5.3); </p><p>To introduce and practice basic research skills (GA1.6)</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module offers a chronological and thematic survey of the history of architecture from ancient times to the present day,  It aims to familiarises students with major architectural typologies (be they stylistic, functional, formal, structural, etc.) through an examination of key examples, and it also looks at the social and technological changes that brought them into being. Ultimately it should deepen the students" understanding of the present state and practice of architecture, and teach some of the basic methods of architectural history. It is vital to be aware of the evolutionary nature of architecture, and the way in which architectural lessons and achievements from the past inform the present and future of architectural development. We must learn from the past, in order to create for the future. With this in mind, this module is integrally linked to the first semester teaching programme, and particular with the Integrated Design in Architecture, and Architectural Design Studio modules.</p></div>',
...
type: 'Coursework 1',
weight: '80.00',
requirements: 'Individual 1200 words essay'
}, {
type: 'Coursework 2',
weight: '20.00',
