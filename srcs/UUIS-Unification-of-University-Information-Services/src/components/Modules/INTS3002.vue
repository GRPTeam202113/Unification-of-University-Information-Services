...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Dissertation: Preliminary Analysis',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Single Honours and Joint Honours in International Studies (compulsory). The module would also be available as an option to students on other degrees.',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '3000-word Dissertation proposal Proposal'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
