...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Software Engineering Group Project',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Only available to Part I undergraduate students in the School of Computer Science.',
...
generalFurtherActivityDetail: '<br>Further Activity Detail: Four introductory lectures; two group meetings per week, plus lectures supporting professional and quality issues.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To give some experience in the various different aspects of software engineering in groups. These include running meetings, making collective decisions, time and people management, giving presentations and demonstrations, and writing reports.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br> •Group projects may address topics in any area of the curriculum and so may address any of the knowledge and understanding outcomes. </p><p>Intellectual Skills:<br> •The ability to understand and logically evaluate requirements and specifications.<br> •The ability to think independently while giving due weight to the arguments of others.<br> •The ability to analyse systematically and effectively, substantial quantities of information.</p><p>Professional Skills:<br> •The ability to understand and make use of software engineering methodologies.<br> •The ability to evaluate, select and deploy tools and techniques.<br> •The ability to work effectively and ethically with users. </p><p>Transferable Skills:<br> •The ability to chair and minute meetings, work effectively in software engineering groups, give short technical presentations and demonstrations, and co-author technical reports.<br> •The ability to reflect upon and assess their own progress, strengths and weaknesses.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Working in groups of around five to six people, you"ll be assigned a supervisor who will provide you with a short written description of a computer application to be designed, programmed, and documented during the course of the module. Each group will meet twice a week, once with your supervisor and once without; you"ll also have four introductory one hour lectures.</p></div>',
assessmentFurtherActivityDetail: '<br>Further Activity Detail: Four introductory lectures; two group meetings per week, plus lectures supporting professional and quality issues.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Project 1',
weight: '80.00',
requirements: 'Group project deliverables: PROJECT SITE, 2 written reports, software, trade-fair-style demonstration, presentation, peer assessment.1500-3500 words each'
}, {
type: 'Report',
weight: '20.00',
requirements: 'Individual reflective statement : 500-1500 words'
}],
