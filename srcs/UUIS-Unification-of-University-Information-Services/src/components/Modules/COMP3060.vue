...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Development Experience',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of the module is to recognise the achievements of students who are excellent developers, and have applied these skills during their own time to increase their development experience. Grades are a mark of recognition of having significant development/programming experience.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Transferable, work-related and employability skills:- self-motivation, independence/autonomy</p><p>Higher skills:- problem solving- computational skills- project management skills- original thinking, innovation</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Students taking part in activities relating to Programming experience such as developing apps in their spare time, contributing to open source projects, or building things in hackathons may receive academic credit for showing they have experience and are an excellent developer. The emphasis of this experience module, is that you provide evidence of your significant extra-curricular software development experience. Students will only be able to register for this module with the approval of the convenor/School, once the material for assessment has been checked.</p></div>',
