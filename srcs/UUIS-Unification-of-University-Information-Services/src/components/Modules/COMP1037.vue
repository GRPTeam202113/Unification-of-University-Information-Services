...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Fundamentals of Artificial Intelligence',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science.This module is part of the AI, Modelling and Optimisation theme in the School of Computer Science.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce students to Artificial Intelligence, its history and some key AI techniques.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>ʥKnowledge of key AI techniques.</p><p>Intellectual Skills:<br>ʥThe ability to think independently while giving due weight to the arguments of others.<br>ʥThe ability to analyse algorithms.</p><p>Professional Skills:<br>ʥThe ability to evaluate available AI techniques and select those appropriate to a given problem.</p><p>Transferable Skills:<br>ʥThe ability to solve problems and communicate effectively in writing.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Through a two hour lecture once a week, this module gives you a broad overview of the fundamental theories and techniques of Artificial Intelligence (AI). You will explore how computers can produce intelligent behaviour, and will consider topics such as the history of AI, search techniques, data mining, machine learning, game playing techniques, neural networks, philosophical issues, and knowledge representation and reasoning.</p></div>',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Two pieces of coursework(Programming assignment)'
}, {
type: 'Exam 1',
weight: '75.00',
requirements: '1.5 hr written examination'
}],
