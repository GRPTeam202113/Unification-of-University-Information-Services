...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Media and Communication Research Methods 2',
year: 'Academic Year 2022',
credit: '10.00',
level: '4',
targetStudents: 'MA students in International Communications and related programmes at the University of Nottingham Ningbo campus Available to JYA/Erasmus students. This Module has been identified as being particularly suitable for first year students, including those from other Schools.',
...
type: 'Coursework',
weight: '100.00',
requirements: '<br />3500 word course work (100%)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
