...
export default {
  name: 'module',
  data() {
    return {moduleName: 'China, Russia and the United States',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Students of the School of International Studies and other Schools. Exchange students. Available to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>Through the study of the Cold War students will be introduced to key agents and forces shaping contemporary international history and current affairs.</p></div>',
...
type: 'coursework1',
weight: '30.00',
requirements: '1,500 words individual&nbsp;essay'
}, {
type: 'coursework2',
weight: '20.00',
requirements: '1 x Group Project and 1,000 word report'
}, {
type: 'Exam 1',
weight: '50.00',
