...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Modelling with Differential Equations',
...
staffName: 'Dr Hayk Mikayelyan',
generalFurtherActivityDetail: '<br>Activities may take place every teaching week of the Semester or only in certain weeks.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to provide students with tools which enable them to develop and analyse linear and nonlinear mathematical models based on ordinary and partial differential equations. Furthermore, it aims to introduce students to the fundamental mathematical concepts required to model the flow of liquids and gases and to apply the resulting theory to model physical situations. This module leads to further study of mathematical models in medicine and biology and fluid mechanics. It also provides a foundation for further study of differential equations.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">A student who completes this module successfully will be able to:</span></span></p><p><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">L1 Analyse systems of ordinary differential equations using linearisation and phase plane techniques;<br><br>L2 Apply the method of characteristics to solve linear and nonlinear first-order partial differential equations;<br><br>L3 - Obtain the canonical form of linear second-order partial differential equations and hence solve hyperbolic and parabolic equations;<br><br>L4 - Derive and solve a simple model equation for traffic flow;<br><br>L5 - Derive pathlines and streamlines for two-dimensional fluid flows;<br><br>L6 - Derive and apply Bernoulli equation for steady fluid flow.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The success of applied mathematics in describing the world around us arises from the use of mathematical models, often using ordinary and partial differential equations. This module continues the development of such models, building on the modules MATH1027 and MATH1029. It introduces techniques for studying linear and nonlinear systems of ordinary differential equations, using linearisation and phase planes. Partial differential equation models are introduced and analysed. These are used to describe the flow of heat, the motion of waves and traffic flow. Continuum models are introduced to describe the flow of fluids (liquids and gases, such as the oceans or the Earth atmosphere).</p></div>',
...
staffTelephone: '+86-574-88180000 ext.:9825',
