...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Mathematical Medicine and Biology',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Single Honours students from the School of Mathematical Sciences.Requisites: MATH2035 Modelling with Differential Equations',
offeringSchool: 'School of Mathematical Sciences',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: '',
generalFurtherActivityDetail: '<br>One two-hour class and two one-hour classes per week timetabled centrally, some of which may be used for examples classes and/or problem classes.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module gives students an introduction to how mathematics can be usefully applied to problems in medicine and biology. It introduces and uses a variety of widely-used techniques of applied mathematics and application of fundamental ideas regarding transport processes. The module covers some advanced topics using nonlinear mathematics.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully will be able to:<br>L1 - build mathematical models of simple biological and medical systems;</p><p>L2 - analyse a given mathematical model and identify the corresponding biological processes;</p><p>L3 - apply standard techniques to analyse nonlinear ordinary differential equations arising in mathematical biology;</p><p>L4 - analyse qualitatively the partial differential equations that describe spatially varying biological processes and medical applications;</p><p>L5 - state and apply central concepts of mathematical biology that are common across a large number of biological systems.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Mathematics can be usefully applied to a wide range of applications in medicine and biology. Without assuming any prior biological knowledge, this module describes how mathematics helps us understand topics such as population dynamics, biological oscillations, pattern formation and nonlinear growth phenomena. There is considerable emphasis on model building and development.</p></div>',
assessmentFurtherActivityDetail: '<br>One two-hour class and two one-hour classes per week timetabled centrally, some of which may be used for examples classes and/or problem classes.',
methodAndFrequency: [{
activity: 'Lecture',
