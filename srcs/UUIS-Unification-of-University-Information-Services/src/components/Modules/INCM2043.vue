...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Reading Film and Television',
...
type: 'Coursework 1',
weight: '30.00',
requirements: 'Analysis of a film frame: 1000-1,500 words'
}, {
type: 'Coursework 2',
weight: '70.00',
requirements: '2.000-2,500 word critical essay'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
