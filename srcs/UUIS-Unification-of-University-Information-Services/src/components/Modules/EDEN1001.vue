...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Studying Literature',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to provide students with:<br>• an introduction to selected literary texts at a level of imaginative engagement and analytic response appropriate to university study<br>• a basis of knowledge, working methods and appropriate terminology for subsequent work at university level</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><br>Knowledge and understanding of:<br>•  critical and theoretical approaches appropriate to the study of a range of representative texts (A1)<br>•  the literary, cultural and historical contexts for literature from the period 1500 to the present (A2)<br>•  the relationships between period and genre (A6)</p><p>Intellectual skills<br>•  the ability to think independently while giving due weight to the arguments of others (B2)</p><p>Professional skills<br>•  the ability to write accurately and grammatically and present written work according to the conventions appropriate to literary study (C3)<br>•  the ability to construct and communicate a sustained analysis of texts both verbally and in writing (C4)<br>•  the ability to conduct research and evaluate the material acquired both individually and as part of a team (C5)</p><p>Transferable skills<br>•  the ability to work productively with others to formulate and articulate ideas (D1)<br>•  the ability to retrieve information from databases and the Internet (D5)<br>  </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module introduces students to some canonical literary works, principally those originally written in English, and dominant critical approaches to them. Specifically, the module addresses academic methods such as close reading, constructing an argument, and handling critical material or applying conceptual apparatuses in literary analysis. Among other things, an emphasis will be placed on the development of the core skills for literary studies, including skills in reading, writing, researching and presentation. These elements are linked to readings of specific literary texts, focused on poetry and prose selected from the full range of the modern literary period but primarily from 19th century to present.</p></div>',
...
type: 'Exam',
weight: '40.00',
requirements: '1,000-word take-home exam'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
