...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Compilers',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Part II undergraduate students in the School of Computer Science. Also available to students from other Schools with the agreement of the module convenor.This module is part of the Programming theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Amin Farjudian',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide an understanding of how compilers work and how they are constructed. </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Learning Outcomes:  <br>•    Knowledge and Understanding<br>o    Knowledge of language and compiler design. <br>o    Understanding of the problems to be faced and the techniques and tools which may be used in the construction of medium sized programs.<br>•    Intellectual Skills<br>o    The ability to define and construct syntax-directed translation schemes and specifications.<br>o    Understand complex ideas and relate them to specific problems or questions.<br>o    The ability to gather information on and analyse the structure of medium sized computer programs.<br>•    Professional Skills<br>o    Programming in various paradigms.<br>o    Comprehend and apply software engineering methodologies, in particular capturing design through formal specifications and deriving implementations from those.<br>o    Evaluate available tools, applications, algorithms and data structures, and select those that are fit for purpose within a given domain, in particular tools for syntax analysis and syntax-directed translation.<br>•    Transferable Skills<br>o    The ability to use mathematics to solve problems and write detailed reports on the solutions adopted.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p>COMP1039 Programming Paradigms and COMP2049 Language and Computing are the reprequisites of this module</p><p>You will examine aspects of language and compiler design by looking at the techniques and tools that are used to construct compilers for high level programming languages. Topics covered include: parsing; types and type systems; run-time organisation; memory management; code generation; and optimisation. You will spend around four hours each week in lectures and computer classes for this module.</p></div>',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Combination of Programming and lab quizzes'
}, {
type: 'Exam 1',
weight: '75.00',
requirements: '2-hour written examination'
}],
staffOffice: 'Room 442, Sir Peter Mansfield Building',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 574 8818 0000 (ext 8634)',
