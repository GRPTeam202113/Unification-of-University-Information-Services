...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Microeconomic Theory',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To build upon the microeconomics the students encountered in year 2. The module will contribute to core knowledge and skills employed during year 4.<br>2. To develop analytical skills by employing standard diagrammatic analysis and reference to the underlying mathematical techniques.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module provides an intermediate-level economic analysis of the theories that are concerned with uncertainty, elementary game theory, strategic behavior of firms, general equilibrium and welfare, information and market design.</p><p>ECON1033 Introduction to Microeconomics is the requisite of this module.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
