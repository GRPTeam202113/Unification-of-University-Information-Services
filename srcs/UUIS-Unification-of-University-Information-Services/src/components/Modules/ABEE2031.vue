...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Control Systems for Built Environment',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'BEng Hons Architectural Environment Engineering',
...
type: 'Coursework 1',
weight: '15.00',
requirements: '1000 word report or equivalent calculations, drawings and simulation'
}, {
type: 'Coursework 2',
weight: '35.00',
requirements: '2000-word group report or equivalent calculations, drawings and simulation'
}, {
type: 'Exam 1',
weight: '50.00',
requirements: '2 hour unseen written examination'
}],
