...
export default {
  name: 'module',
  data() {
    return {moduleName: 'School of Education',
year: 'Academic Year 2022',
credit: '0.00',
level: '5',
targetStudents: '',
offeringSchool: 'School of Education',
...
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;width:262pt" width="349"> <colgroup> <col style="mso-width-source:userset;mso-width-alt:12763;width:262pt" width="349"/> </colgroup> <tbody> <tr height="20" style="height:15.0pt"> <td height="20" style="height:15.0pt;width:262pt" width="349">School of Education</td> </tr> </tbody></table></div>',
