...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Professional Ethics in Computing',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Part II undergraduate students in the School of Computer Science, in particular those on accredited programmes of study. Also available to taught postgraduate students in the School of Computer Science and students in other Schools subject to obtaining agreement from the module convenor. This module is part of the Foundations of Computer Science theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: '',
generalFurtherActivityDetail: '<br>For the weekly workshops, the class is usually split into 2 sections, hence 2 workshop sessions are timetabled per week, but each student is required to attend one workshop session per week; then during the workshops, students work in groups of 5, and individual as well as group activities should be completed by the end of each workshop.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To acquire the ability to recognise the professional, ethical, social and legal issues involved in the exploitation of computer technology, and be guided by the adoption of appropriate professional, ethical and legal practices. To apply these professional ethics perspectives to contemporary situations and to reflect on one own experience and practice. To understand and be able to participate within the professional, social and legal framework within which one would have to operate as a professional.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br> 1.1 Ethics theories.<br> 1.2 Privacy issues in computer systems.<br> 1.3 Cyber-behaviour through computer systems.<br> 1.4 Intellectual and intangible property.<br> 1.5 Safety, reliability and dependability.<br> 1.6 Sustainability and social issues in computing.</p><p>Intellectual Skills<br> 2.1 Pervasive nature of computer systems.<br> 2.2 Ethical reasoning and deliberative discussions.</p><p>Professional Skills:<br> 3.1 The nature of professionalism.<br> 3.2 Professional codes in computing.<br> 3.3 Accreditation/certification/licensing of computing professionals.</p><p>Transferable Skills:<br> 4.1 Critical thinking.<br> 4.2 Reasoning and communicating arguments.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module looks broadly into professional ethics within the scope of the computing discipline. It covers a range of professional, ethical, social and legal issues in order to study the impact that computer systems have in society and the implications of this from the perspective of the computing profession. In particular, the module covers topics such as introduction to ethics, critical thinking, professionalism, privacy, intellectual and intangible property, cyber-behaviour, safety, reliability accountability, all these within the context of computer systems development. <br><br></p></div>',
assessmentFurtherActivityDetail: '<br>For the weekly workshops, the class is usually split into 2 sections, hence 2 workshop sessions are timetabled per week, but each student is required to attend one workshop session per week; then during the workshops, students work in groups of 5, and individual as well as group activities should be completed by the end of each workshop.',
methodAndFrequency: [{
activity: 'Lecture',
