...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Corpus Linguistics (MA)',
year: 'Academic Year 2022',
credit: '20.00',
level: '4',
targetStudents: 'Students following the MA in Applied Linguistics.Open to students on the MA Teaching English to Speakers of Other Languages as well as other MA programmes within the School.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>After completing this module, students will -<br>•    Have a good understanding of the methodology of using corpus in the study of language <br>•    Understand the basis of corpus construction<br>•    Become familiar with corpus processing and search tools<br>•    Become familiar with quantitative analysis of corpus, and<br>•    Apply corpus linguistic methodology to various subfields of applied linguistics</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding of<br>•    critical and analytical method in relation to spoken and written discourse stored in electronic format;<br>•    applications of corpus analysis in different areas of applied linguistics;<br>•    methodological issues in producing and interpreting sets of language data (corpora).<br>Intellectual skills:<br>•    an ability to engage in close and logical analysis of texts and arguments;<br>•    an ability to apply theoretical frameworks in practical analysis. <br>Professional skills:<br>•    the ability to use on-line resources (corpora and corpus tools) and evaluate the material thus collected;<br>•    the ability to produce an assignment to a professional disciplinary standard. <br>Transferable skills:<br>•    the use of computer-mediated research and expressive skills;<br>•    the ability to word-process material and communicate effectively in writing.</p></div>',
