...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide students with a basic knowledge and understanding of the main stream computer modelling techniques used in modern engineering practice, including Finite Element techniques and Computational Fluid Dynamics (CFD).</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>LO1 – Understand the theoretical background of numerical methods used in engineering analysis, Finite Element and Computational Fluid Dynamics techniques. LO2 – Identify and apply appropriate computer modelling techniques to solve specific engineering problems. LO3 – Demonstrate an understanding of how computer programmes can be used to solve practical solid and fluid mechanics problems in engineering. LO4 – Evaluate the accuracy and sources of error in solving solid and fluid mechanics problems in engineering using computational models.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Introduction to numerical methods in engineering, Finite Element analysis of structures, pin-jointed elements, Computational Fluid Dynamics (CFD) for thermo-fluids problem.</p></div>',
...
type: 'Coursework 1',
weight: '30.00',
requirements: '<span lang="EN-GB" style="line-height: 107%; font-family: &quot;Arial&quot;,sans-serif; font-size: 12pt; mso-fareast-font-family: &quot;Times New Roman&quot;; mso-ansi-language: EN-GB; mso-fareast-language: EN-GB; mso-bidi-language: AR-SA;"><font color="#000000">Two assignments&nbsp;</font></span>'
}, {
type: 'Exam 1',
weight: '70.00',
requirements: ' '
