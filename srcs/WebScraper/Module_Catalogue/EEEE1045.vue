...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Contemporary Engineering Themes A',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide an introduction to a variety of electrical and electronic themes that are found in contemporary systems.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>By the end of this module, students should be able to: 1. Demonstrate an ability to critically appraise technology: Identification of key breakthroughs and the critical enablers for practical deployment. 2. To demonstrate a fundamental understanding of the technologies underpinning selected contemporary systems and be able to perform basic calculations to quantify key aspects of their operation. 3. To demonstrate a basic appreciation of the commercial and socio-economic drivers of the engineering research and development process.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This course provides an introduction to a variety of themes that are at the forefront of contemporary electrical and electronic engineering systems. The presentations will cover critical technological enablers and breakthroughs and their commercial and socio-economic impact which drive the engineering research and development process. This provides a broader context for the material covered in the co-requisite modules. The topics covered will vary each year and typical subjects might include: </p><p>· Smart Grids </p><p>· Medical Electronics </p><p>· Electric Transportation </p><p>· Big Data </p><p>Note: 3 subjects will be covered.</p><p style="margin-bottom:11px"><span style="font-size:10pt"><span style="line-height:107%"><span style="font-family:Verdana,sans-serif">Reassessment of this module, if required, will be by 100% coursework.</span></span></span></p></div>',
