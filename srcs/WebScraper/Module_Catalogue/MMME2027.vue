...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Electromechanical Devices',
...
generalFurtherActivityDetail: '<br>Two one-hour lecture and one one-hour exercise class per week, reinforced with a total (per student per year) of one electronics laboratory, one electrical engineering (AC circuits and induction motor) laboratory, and one computer-aided learning (Rogo) test.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to explain how electricity and electronic principles can be used to achieve practical tasks in mechanical engineering, measure mechanical quantities and provide mechanical power. It also aims to give students an understanding of the importance of electrical and electronic subsystems in mechanical designs. A further aim is to prepare students for the use of electrical and electronic approcahes within their individual and group project work.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module students will be able to:</p><p>•LO1 – Analyse simple electrical and electronic circuits •LO2 – Describe and identify electronic components •LO3 – Apply electrical and electgronic principles to the measurement of a variety of physical quantities •LO4 – Describe and analyse the operation of simple electrical actuators and electrical machines</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Electrical machines and circuits: DC circuits, electromagnetism, capacitance, transducers, AC circuits, rectification, induction motor, amplifiers, combinational &amp; sequential logic, transformers. Sensors: application of basic electrical and electronic principles to sensors for position, displacement, velocity, acceleration and strain, rotary sensors. Actuator: solenoids, stepper motor. Signals and conversion: analog and digital data, ADCs, DACs.</p></div>',
assessmentFurtherActivityDetail: '<br>Two one-hour lecture and one one-hour exercise class per week, reinforced with a total (per student per year) of one electronics laboratory, one electrical engineering (AC circuits and induction motor) laboratory, and one computer-aided learning (Rogo) test.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'ROGO exam',
weight: '4.00',
requirements: 'Rogo-based assessment'
}, {
type: 'Lab REPORT 1',
weight: '16.00',
requirements: ' '
