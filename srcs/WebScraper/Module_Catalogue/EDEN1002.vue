...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Theory and Practice in Linguistics',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'BA English Language and Literature. BA English Language and Applied Linguistics. BA English Studies and International Business. Available to JYA/Erasmus students.',
offeringSchool: 'School of Education and English',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: '',
generalFurtherActivityDetail: '<br>3 hours weekly sessions for 1 semester with one session comprising a 1.5 hour lecture and the other a 1.5 hour seminar with further individual consultations and in-class discussions. Seminars are designed to reinforce important concepts and ideas introduced in the lecture, with an orientation to fostering students’ ability to identify and analyze linguistic ideas in their everyday communication.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This introductory module allows students to gain a basic understanding of the core areas of Linguistics as an academic discipline. It is designed to equip students for further studies in the field of Linguistics as a whole, and to develop knowledge of basic terminology, linguistic analysis and theoretical approaches to language.<br>At the end of this module, students should be able to define the discipline, and the main pre-occupations of its sub-fields. They will have a solid background which they can apply to further study of language in context.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding:<br>• The ability to define core principles of language in the study of linguistics<br>• The ability to develop a systematic understanding of the phonological, morphological, syntactic and semantic features of language<br>• The ability to define major linguistic theories in the study of linguistics, and in its sub-fields<br>• The ability to describe and distinguish different areas of study within linguistics<br>Intellectual skills:<br>• The ability to compare and contrast linguistic concepts and theories<br>• The ability to apply linguistic concepts and theories to linguistic data in order to gain a deeper understanding of language phenomena from a linguistic perspective<br>• The ability to reflect and debate, to think critically about linguistic concepts and ideas and to explore possible answer for linguistic puzzles<br>• The ability to critically  evaluate linguistic theories<br>Professional practical skills:<br>• The ability to identify and explain everyday language use from a linguistic perspective<br>• The ability to analyze instances of linguistic data according to basic phonological, morphological, syntactic, semantic and pragmatic principles<br>• The ability to recognize issues and problems related to language and language use in real life and propose possible solutions <br>Transferable (key) skills:<br>• The ability to communicate clearly and effectively in writing and discussion<br>• The ability to retrieve information from a range of written and digital resources and present the results professionally<br>• The ability to participate in teamwork and learn from peers<br>• The ability to reflect upon and assess your own progress, strengths and weaknesses.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>•This module introduces students to the core areas of Linguistics including:<br>The structure of Language: Phonetics and Phonology; Morphology; Syntax. <br>•Language meaning: Semantics and Pragmatics<br>•Theories of first and second language acquisition <br>•Other major topics in linguistics such as language variation, language and culture, e-language, historical linguistics</p><p>Please note: This module is assessed at the end of Autumn semester. First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
assessmentFurtherActivityDetail: '<br>3 hours weekly sessions for 1 semester with one session comprising a 1.5 hour lecture and the other a 1.5 hour seminar with further individual consultations and in-class discussions. Seminars are designed to reinforce important concepts and ideas introduced in the lecture, with an orientation to fostering students’ ability to identify and analyze linguistic ideas in their everyday communication.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Exam',
weight: '100.00',
requirements: '2 hour examination at the end of the Autumn Semester<br />Or<br />72 hour take home examination at the end of the Autumn Semester'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
