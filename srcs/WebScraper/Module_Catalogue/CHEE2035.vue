...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Analytical Measurement',
...
staffName: 'Prof Jun HE',
generalFurtherActivityDetail: '<br>There will be three 2-hour and one 1-hour practical sessions. Learning outcomes from the practical sessions will be assessed in the end of module examination, as will components taken from the in-class statistics tutorials.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims primarily to provide students with the necessary pre-requisite skills required for the study of modules that require a foundation knowledge of measurement. To provide students with a working knowledge of basic measurement principles and practice.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A1.2.1 Have a knowledge and understanding of mathematics necessary for the analysis of and to support applications of key chemical engineering principles and processes.</p><p> </p><p>Use of lecture, laboratory practice and examination to apply relevant statistics to quantification and measurement uncertainty.</p><p> </p><p>A1.2.3 Have a knowledge and understanding of scientific principles, namely the relevant aspects of physics, chemistry, biochemistry, biology and materials science, to enable the understanding of chemical engineering principles.</p><p> </p><p>Use of lecture, laboratory practice and examination of scientific principles which underpin measurement.</p><p> </p><p>A3.2.2 Be able to undertake well-planned experimental work and to interpret, analyse and report on experimental data.</p><p> </p><p>By laboratory practice and examination of principles of measurement.</p><p> </p><p>A3.2.3 Be able to find and apply, with judgement, information from technical literature and other sources.</p><p> </p><p>Use technical literature to complement understanding of principles of measurement to a variety of analytical techniques.</p><p> </p><p>A6.0.1 Have the ability to handle uncertainty and complexity.</p><p> </p><p style="margin: 0in 0in 8pt;"><span style="font-family:calibri,sans-serif;"><span style="font-size:11.0pt;">Achieved through a comprehensive understanding of fitness for purpose and how this is intrinsically linked to quality control and quality assurance.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is designed to give an introduction, in both theory and practice to the principles of analytical measurement. Analytical measurement techniques relevant to chemical and environmental engineers will be outlined. Particular emphasis of the module is towards Quality Control, Quality Assurance and Accreditation and how these underpin the topic. The use of statistics for the assessment of data qualilty in analytical measurement is also emphasised.</p></div>',
assessmentFurtherActivityDetail: '<br>There will be three 2-hour and one 1-hour practical sessions. Learning outcomes from the practical sessions will be assessed in the end of module examination, as will components taken from the in-class statistics tutorials.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Presentation 1',
weight: '15.00',
requirements: 'group/ individual presentation based on practical activities. 20 minutes'
}, {
type: 'Exam 1',
weight: '85.00',
