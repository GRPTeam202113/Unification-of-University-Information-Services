...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Language and Intercultural Communication',
...
weight: '90.00',
requirements: '3000 words mini research project, analytical essay or critical exploration'
}, {
type: 'Portfolio',
weight: '10.00',
