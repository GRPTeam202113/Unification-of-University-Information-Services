...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Hydrology and Hydrogeology',
...
generalFurtherActivityDetail: '<br>Lectures and example classes.',
...
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A2.1.1 Understand the principles of fluids and solids formation and processing.</p><p> </p><p>·  Demonstrate knowledge and understanding in hydrology and hydrogeology via coursework and final exam.</p><p> </p><p>A2.1.2 Be proficient in applying these principles to problems involving fluid flow, heat transfer, mass transfer and reaction engineering.</p><p> </p><p>·  Demonstrate problem solving in hydrology and hydrogeology via coursework and final exam.</p><p> </p><p>A2.3.2 Understand the role of empirical correlation and other approximate methods.</p><p> </p><p style="margin: 0in 0in 8pt;"><span style="font-family:calibri,sans-serif;"><span style="font-size:11.0pt;">·  Demonstrate understanding of empirical correlation and numerical modelling relevant to hydrology and hydrogeology via coursework and final exam.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is designed for students with an interest in water resources, and provides an understanding of the movement and storage, pollution and pollution control, and the water-resource provision from both surface and sub-surface waters.</p></div>',
assessmentFurtherActivityDetail: '<br>Lectures and example classes.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Project 1',
weight: '20.00',
requirements: 'Research Essay'
}, {
type: 'Exam 1',
weight: '80.00',
requirements: '2 hour exam, end of Autumn Semester'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
