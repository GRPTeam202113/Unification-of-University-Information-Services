...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Introduction to Image Processing',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Part I undergraduate students in the School of Computer Science. Also available to students from other Schools with the agreement of the module convenor.This module is part of the AI, Modelling and Optimisation theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Jianfeng Ren',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce the fundamentals of digital image processing theory and practice. To gain practical experience in writing programs for manipulating digital images. To lay the foundation for studying advanced topics in related fields.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding:<br> •Experience implementing programs that manipulate images<br> •Understanding fundamental techniques in image processing and analysis, and their limitations<br> •Appreciation of the underlying mathematical principles of the field. </p><p>Intellectual Skills:<br> •Apply knowledge of image processing techniques to particular tasks<br> •Evaluate different techniques in the context of image manipulation and processing.</p><p>Professional Skills:<br> •Evaluate the applicability of various algorithms and operators to particular tasks.</p><p>Transferable Skills:<br> •Address real problems and assess the value of their proposed solutions, retrieve and analyse information from a variety of sources and produced detailed written reports on the result.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p style="line-height: normal;"><span style="font-size: 12px;"><strong><span style="color: rgb(0, 57, 101);"><span style="font-family: arial,sans-serif;">Prerequisites: </span></span></strong><span style="color: rgb(0, 57, 101);"><span style="font-family: arial,sans-serif;">COMP1039 or COMP1038 or equivalent programming experience. COMP1034 or equivalent knowledge of mathematics.</span></span></span></p><p>This module introduces the field of digital image processing, a fundamental component of digital photography, television, computer graphics and computer vision. You will cover topics including: image processing and its applications; fundamentals of digital images; digital image processing theory and practice; and applications of image processing. You will spend around three hours in lectures and computer classes each week for this module.</p></div>',
...
type: 'Coursework 1',
weight: '40.00',
requirements: '2000 word Programming assignment/report'
}, {
type: 'Exam 1',
weight: '60.00',
requirements: 'one hour written examination'
}],
...
staffTelephone: '86 574 8818 0000 (ext 8805)',
