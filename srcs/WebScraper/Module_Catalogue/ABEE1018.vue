...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Architectural Design Studio 1b',
...
generalFurtherActivityDetail: '<br>Weekly tutorials, periodic field studies and project reviews, criticisms on completion of each coursework project, and private study.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><ul> <li>To develop students skills and approaches to architectural design at a basic level, culminating in the design of a building on an urban site. </li> <li>To practice a process of design investigation and development. </li> <li>To assist students in the acquisition of the following contribute Graduate Attributes, as described in the Royal Institute of British Architects (RIBA) “Prescription of Qualifications: RIBA Criteria at Part 1”:</li> <li>The ability to generate design proposals using understanding of a body of knowledge, some at the current boundaries of professional practice and the academic discipline of architecture (GA1.1).</li> <li>The ability to apply a range of communication methods and media to present design proposals clearly and effectively (GA1.2). </li> <li>The ability to evaluate evidence, arguments and assumptions in order to make and present sound judgments within a structured discourse relating to architectural culture, theory and design (GA1.4).</li> <li>To fulfil in part the ARB/RIBA “Prescription of Qualifications” criteria, specifically the General Criteria (GC) at Part 1, for students participating in the Architecture course. </li></ul></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module, students will: </p><p>1. demonstrate the ability to create architectural designs that satisfy both aesthetic and technical requirements, as well as starting the process of learning to prepare and present building design projects of a modest scale, complexity, and type in a given context, using a range of media, and in response to a brief (GC1,GC1.3)</p><p>2. Demonstrate knowledge how the theories, practices and technologies of the arts influence architectural design (GC3.1) </p><p>3. Demonstrate an understanding of the relationship between people and buildings, and the need to relate buildings and the spaces between them to human needs and scale (GC 5.1, GC10.3) </p><p>4. Demonstrate an understanding the way in which buildings fit into their local context (GC 5.3) </p><p>5. Demonstrate an understanding of the need to investigate and review precedents relevant to the function and organization strategy of the design proposals (GC7.1) </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This studio-based module develops students" basic design, drafting, model making and drawing skills. A number of short design studies will introduce historical precedents and computer aided drawing programmes. These exercises will feed into a small comprehensive design project of a public building. This work will also test the student awareness of the technical performance of buildings.</p></div>',
assessmentFurtherActivityDetail: '<br>Weekly tutorials, periodic field studies and project reviews, criticisms on completion of each coursework project, and private study.',
methodAndFrequency: [{
activity: 'Workshop',
...
type: 'Coursework 1',
weight: '100.00',
requirements: 'Portfolio of design projects, models, reports and sketchbooks and individual student briefing document'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
