...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Topics in Time Series Econometrics',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The main aims of the module are:</p><p>Introduction of the concept of unit roots, and the consequences of that concept for the analysis of economic time series - in particular, the importance of cointegration analysis and error-correction models.</p><p>The introduction of other time series - analytic concepts and tools that have found applicability in Economics. These include multivariate models of stationary and non-stationary time series processes and the analysis of their long run behaviour.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A5 Show understanding of relevant mathematical and statistical techniques.</p><p>Intellectual Skills:<br>B1 Work with abstract concepts and in a context of generality.<br>B3 Be able to evaluate, analyse and present quantitative data.</p><p>Professional / Practical Skills:<br>C2 Understand the sources and content of economic data and evidence, as well as appropriate methods of analysis.<br>C3 Be familiar with differing approaches to analysing a given economic problem and the history and development of economic ideas.</p><p>Transferable Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is a continuation of the module on time series analysis taken in the second semester of the second year. While the earlier module was devoted to basic time series model building methodology, applicable over a broad range of disciplines, the present module concentrates on those developments which can be applied in the subject of Economics. In particular, the emphasis will be on aspects of the behaviour of typical economic time series, and the implications of that behaviour in practical analysis, such as the construction of models linking economic time series. The key issues addresses will be the identification of non-stationarity through the construction of formal tests and the implications for modelling with non-stationary data. Particular attention will be paid to the contributions of Sir Clive Granger to the spurious regression problem and to cointegration analysis, for which he was ultimately awarded the `Nobel Prize`.</p><p>Prerequisite: ECON2032 Econometrics I , ECON2033 Econometrics II </p><p>Please note this module is assessed at the end of in Autumn semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
