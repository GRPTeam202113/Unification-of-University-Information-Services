...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Foundation Calculus and Mathematical Techniques',
year: 'Academic Year 2022',
credit: '15.00',
level: '0',
targetStudents: 'Students registered on all Engineering Programmes, including Architectural Environment Engineering, at The University of Nottingham Ningbo, China.',
...
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><span style="font-size: medium;"><span style="font-family: calibri;">A student who completes this module successfully should be able to:</span></span></p><p> </p><p><strong><span style="font-size: medium;"><span style="font-family: calibri;">A Knowledge and understanding</span></span></strong></p><ul> <li style="font-weight: normal;">Consolidate prior knowledge and understanding of the differential calculus of a function of a single variable.</li> <li style="font-weight: normal;">Use standard integration techniques and perform definite integration.<br> </li></ul><p><strong><span style="font-size: medium;"><span style="font-family: calibri;">B Intellectual skills</span></span></strong></p><ul> <li style="font-weight: normal;">Reason logically and work analytically.</li> <li style="font-weight: normal;">Perform with high levels of accuracy.</li> <li style="font-weight: normal;">Manipulate mathematical formulae, algebraic equations &amp; standard functions.</li> <li style="font-weight: normal;">Apply fundamental mathematical concepts to problems of a routine nature in engineering or science.<br> </li></ul><p><strong><span style="font-size: medium;"><span style="font-family: calibri;">C Professional practical skills</span></span></strong></p><ul> <li style="font-weight: normal;">Construct and present mathematical arguments with accuracy and clarity.<br> </li></ul><p><strong><span style="font-size: medium;"><span style="font-family: calibri;">D Transferable (key) skills</span></span></strong></p><ul> <li style="font-weight: normal;">Communicate mathematical arguments using standard terminology.</li></ul><p><span style="font-size: 11pt;"><span style="font-family: calibri,sans-serif;">             Use of e-learning and self-study skills.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module provides a course to consolidate previous studies in differential calculus and introduce a range of mathematical topics used in the analysis of problems in engineering and physical sciences. The module will cover techniques and applications of differentiation, integration, and differential equations. Application to solving real life problems is developed.</p></div>',
...
type: 'mid-sem exam',
weight: '30.00',
requirements: 'mid-sem written exam'
}, {
