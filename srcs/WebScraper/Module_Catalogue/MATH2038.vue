...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Statistical Models and Methods',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The purpose of this module is to introduce a wide range of statistical concepts and methods fundamental to applications of statistics, and also to introduce the key concepts and theory of linear models, illustrating their application via practical examples drawn from real-life situations. Students will acquire knowledge and skills of relevance to a professional statistician.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully will be able to: L1 - apply methods concerning estimation of parameters in standard statistical models; in particular the method of moments and the maximum likelihood method.;L2 - apply methods for interval estimation; in particular, exact and approximate confidence intervals based on asymptotic theory.;L3 - perform statistical hypotheses tests using data from studies (such as t and F-tests, comparison of models and parameter values).;L4 - apply methods for analysing categorical data and methods without having to make distributional assumptions (non-parametric statistics).;L5 - fit a linear model to data, both manually and using statistical software;L6 - check model fit, diagnose errors, and perform model selection amongst the class of linear models</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The first part of this module provides an introduction to statistical concepts and methods. A wide range of statistical models will be introduced to provide an appreciation of the scope of the subject and to demonstrate the central role of parametric statistical models. The key concepts of inference including estimation and hypothesis testing will be described. Special emphasis will be placed on maximum likelihood estimation and likelihood ratio tests. While numerical examples will be used to motivate and illustrate, the content will emphasis the mathematical basis of statistics. Topics include maximum likelihood estimation, confidence intervals, likelihood ratio tests, categorical data analysis and non-parametric procedures.<br><br>The second part of the module introduces a wide class of techniques such as regression, analysis of variance, analysis of covariance and experimental design which are used in a variety of quantitative subjects. Topics covered include the general linear model, least squares estimation, normal linear models, simple and multiple regression, practical data analysis, and assessment of model adequacy. As well as developing the theory, practical experience will be obtained by the use of a statistical computer package.</p></div>',
...
type: 'Coursework 1',
weight: '15.00',
requirements: 'Advanced take-home exercise on statistical data analysis and hypotheses tests using software packages (spring)'
}, {
type: 'Inclass Exam 1 (Written)',
weight: '10.00',
requirements: 'Inclass test (autumn)'
}, {
type: 'Exam 1',
weight: '75.00',
