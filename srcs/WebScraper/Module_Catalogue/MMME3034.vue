...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'RSA Design Projects',
...
staffName: 'Dr Bingjian Liu',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To further design skills within both creative design and manufacturing detail. Specifically; in the first project, students will be able to use people Centred Research to find creative approaches to difficult problems. Students will be able to present these often complex ideas graphically to a good standard. In the second project, students will be able to detail a simple product for manufacture by injection moulding. They will develop their design ready for manufacture using analytical techniques to determine moulding parameters.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module students will be able to: <br></p><li>1 Deal with complex problems and open design briefs, managing the design process to produce suitable design proposals.<br></li><li>2 Use varying people Centred Research� skills to understand issues and to develop solutions to problems set in the design brief.<br></li><li>3 Present complex ideas, products and systems in a simple graphical way. Presentation material will be suitable for audience and quickly understandable.<br></li><li>4 Design and detail a component for manufacture by the Injection moulding process.<br></li><li>5 Use Mold Flow analysis software to analyse a part and produce an accurate costing for its production.<br><p></p></li></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This is a project based module for Product Design and Manufacture students in their 3rd year. The module comprises of 2 projects, developing a number of different themes that run through the discipline. Through practical design work the students will be faced with the problems of managing different constraints and producing cohesive design proposals. The students will develope their skills in receiving design briefs, managing time and resources and presenting design solutions.</p></div>',
...
staffTelephone: '0574-88180000-8589',
