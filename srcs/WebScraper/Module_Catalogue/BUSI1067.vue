...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Computers in Business',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Available to Qualifying Year business school students (Compulsory for FAM major, Optional for IBE).There is a limited number of places on this module. Students are reminded that enrolments which are not agreed by the Offering School in advance may be cancelled without notice.Available to JYA/Erasmus students.',
...
generalFurtherActivityDetail: '<br>Further Activity Detail:12 90 minutes lectures, 4 90 minutes computer lab seminars and 1 presentation session',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide participants with a solid understanding of the application and impact of computers and the Internet, especially in small businesses. To ensure a hands-on competence in the use of spreadsheets.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding<br>This module develops a knowledge and understanding of:</p><ul> <li>The development, management and exploitation of information systems and their impact upon organizations.</li> <li>The comprehensive use of relevant communication and information technologies for application in business and management.</li> <li>The importance of sustainability issues, including an understanding of the challenges and opportunities arising from the activities of people and organisations on the economic, social and environmental conditions of the future.</li></ul><p>Intellectual skills<br>This module develops:</p><ul> <li>The ability to create, evaluate and access a range of options, together with the capacity to apply ideas and knowledge to a range of business and other situations.</li> <li>Professional practical skills<br>This module develops:</li> <li>The effective use of communication and information technology (CIT) skills for business applications.</li> <li>The ability to conduct research into business and management issues, either individually or as part of a team, including a familiarity with a range of business data, research resources and appropriate methodologies.</li></ul><p>Transferable (key) skills<br>This module develops:</p><ul> <li>Effective oral and written communication skills in a range of traditional and electronic media.</li></ul><p> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module will introduce the use of computers and IT in business today - and in particular spreadsheet modelling - via a lab based assessment and a case study group report and presentation.</p></div>',
assessmentFurtherActivityDetail: '<br>Further Activity Detail:12 90 minutes lectures, 4 90 minutes computer lab seminars and 1 presentation session',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Project 1',
weight: '50.00',
requirements: '2500 word group project report and presentation'
}, {
type: 'Project 2',
weight: '50.00',
requirements: '1500 word individual coursework'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
