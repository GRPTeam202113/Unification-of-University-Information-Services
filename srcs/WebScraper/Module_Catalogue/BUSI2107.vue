...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Introductory Econometrics',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Compulsory for FAM and IBEThere is a limited number of places on this module. Students are reminded that enrolments which are not agreed by the Offering School in advance may be cancelled without notice.',
offeringSchool: 'Nottingham University Business School China',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Eric Evans Osei Opoku',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce participants to the theory and practice of applied econometric modelling.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><strong>Knowledge and understanding</strong></p><p>This module develops a knowledge and understanding of</p><p>Relevant quantitative and computing techniques, including mathematical and statistical</p><p>methods, econometrics and the use of econometric software to estimate models using actual</p><p>economic data.</p><p>Economic data and its appreciation.</p><p>Econometrics, and its use on actual economic, financial or social data, using suitable statistical</p><p>or econometric software</p><p>Mathematical methods for economics</p><p>Statistical methods for economics</p><p>The nature, sources and uses of quantitative data and an ability to select and apply appropriate</p><p>methods that economists might use to analyze such data.</p><p> </p><p><strong>Professional practical skills</strong></p><p>This module develops</p><p>Numeracy and quantitative skills to manipulate data, evaluate, estimate and model business</p><p>problems, functions and phenomena</p><p>Facility with key concepts used in decision making including expectations.</p><p> </p><p><strong>Transferable (key) skills</strong></p><p>This module develops</p><p>Subject specific transferable skills including abstraction, analysis, deduction and problem</p><p>framing.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><strong>PRE-REQUISITE</strong>   </p><p>Please note that for this module, the following pre-requisite applies:</p><p>           BUSI2105 Quantitative Methods 2A</p><p><em>(Please ignore</em>    Requisites: N/A     <em>below)</em></p><p>This module will provide an introduction to the theory and practice of quantitative economic modelling at a basic level. The theoretical framework will be developed around the classical regression model and its extensions, with theoretical understanding being supplemented with computer-based practical examples of model construction and data analysis.</p><p>Re-assessment format is decided by the school.</p></div>',
