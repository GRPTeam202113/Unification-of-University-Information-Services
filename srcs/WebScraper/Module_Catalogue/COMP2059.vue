...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Developing Maintainable Software',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Part I undergraduate students in the School of Computer Science only. This module is part of the Software Engineering theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr BOON GIIN LEE',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><span style="color:#000000;"><span style="font-size:12px;"><span lang="EN-US"><span style="line-height:107%"><span style="font-family:"Arial",sans-serif">To build on first year programming modules and further develop programming ability and experience, including ability to develop and understand a large piece of software, build user interfaces and follow a realistic design and testing procedure.  </span></span></span></span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">- Learn to understand, refactor and add to large pieces of third-party software.<br>- Ability to identify and use design diagrams; follow an engineering methodology (e.g. agile); refactor code; use APIs and libraries; apply user interface design guidelines; code GUIs; document code.<br>- Knowledge and Understanding: Understanding large software systems and the quality, organisation and design issues associated with working with such code; agile development approaches; software component interaction; event-based programming; modern interface paradigms.<br>- Intellectual Skills: Understand and logically evaluate program requirements and specifications; understand the complex ideas of programming solutions and relate them to particular problems.<br>- Professional Skills: Practical experience of "real world" coding. Design and write object-oriented programs and GUIs.<br>- Understand modern development IDEs (e.g. Eclipse) and relevant engineering software tools (e.g. git).<br>- Transferable Skills: Object-oriented problem-solving; scheduling and presenting work; applying learning material. </span></span></span></span></span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span style="font-size:12px;">Prerequisites: COMP1035 Software Engineering and COMP1039 Programming and Paradigm</span></p><p><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">This module builds on your basic Java programming and software engineering skills developed in Year 1, extending it to working with larger third-party software systems, and the challenges associated with this.<br>Topic examples include:- design diagrams and modelling; GUI programming; testing software engineering methodologies (including agile development and tools); refactoring; design patterns and SOLID principles; all in the context of understanding and developing maintainable third-party code. You will spend around three hours per week in lectures, two hours per week in computer classes studying for this module.</span></span></span></span></span></span></p></div>',
...
type: 'Coursework1',
weight: '75.00',
requirements: 'code submission: electronic submisson of refactored code and added-on component(s) to some existing software, repository and documentation'
}, {
type: 'Exam 1',
weight: '25.00',
