...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Renewable Generation Technologies',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Available to BEng Electrical and Electronic Engineeringstudents. Available to exchange students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module will enable students to analyse resources and conversion technologies for generating electricity from a range of renewable and sustainable energy types and systems.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>By the end of the module students should be able to:</p><ul> <li>analyse power generation capacities of sustainable energy sources and select appropriate types of renewable energy for some typical applications;</li> <li>select appropriate technologies for electrical power generation from renewable energy;</li> <li>demonstrate an understanding of the use of renewable energy within the electricity power system including constraints and incentives.</li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module covers the analysis and design of renewable and sustainable energy systems. It covers the various types of renewable energy and the resources available. It uses an understanding of the physical principles of various types of energy resources in order to develop analytical models which can be applied to the design of renewable energy systems, including energy conversion and storage, especially for electrical power generation.</p><p>It includes;</p><ul> <li>Wind power: wind probability distributions, wind turbine performance and control, comparison of generator types</li> <li>Hydro and tidal power: resource assessment, turbine types and principles</li> <li>Solar power, including PV cell equivalent circuit, analysis of losses, matching to DC and AC power systems</li> <li>Wave power systems, including wave energy characteristics, types of energy converter</li> <li>Characteristics of synchronous and induction generators</li> <li>Embedded generation; types of generator and operation of RE within the power system</li> <li>Economic and environmental assessment of energy conversion technologies.</li></ul><p>Reassessment of this module, if required, will be by 100% exam.</p></div>',
...
type: 'Exam 1',
weight: '50.00',
requirements: 'End of module exam'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
