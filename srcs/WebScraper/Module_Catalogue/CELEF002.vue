...
credit: '15.00',
level: '0',
targetStudents: 'First year students at the Ningbo campus',
offeringSchool: 'Centre for English Language Education',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Mr Peter Sturman',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="margin-bottom:11px"><span style="font-size:11pt"><span style="line-height:normal"><span style="font-family:"Calibri",sans-serif"><span lang="EN-GB" style="color:#515151">To enhance students’ knowledge of Management Information Systems and IT in Business, the technical skills that support this, and to raise awareness and competence in teamwork and project management, basic coding and the application of IT in resource management using EndNote and Mapperley.</span></span></span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><span style="font-size:11pt"><span style="font-family:"Calibri",sans-serif">Students will be able to </span></span></p><ul> <li><span style="font-size:11pt"><span style="font-family:"Calibri",sans-serif">demonstrate their knowledge of Management Information Sytems</span></span></li> <li><span style="font-size:11pt"><span style="font-family:"Calibri",sans-serif">show critical awareness of IT-related issues in Business</span></span></li> <li><span style="font-size:11pt"><span style="font-family:"Calibri",sans-serif">demonstrate creative and practical IT skills in website design and creation including basic level coding  in HTML, CSS and Javascript</span></span></li> <li><span style="font-size:11pt"><span style="font-family:"Calibri",sans-serif">display project management, team-work, decision-making and problem-solving capabilities through work on group project.</span></span></li></ul><p><span lang="EN-GB" style="font-size:11.0pt"><span style="font-family:"Calibri",sans-serif">demonstrate responsibility through peer assessment.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span style="font-size: 12px;"><span style="font-family: arial,helvetica,sans-serif;"><font color="#000000"><span style="padding: 0in; border: 1pt windowtext; border-image: none;">This module will help students develop an understanding of the essential role of information in business and how information is secured, shared, distributed and digitalized to ensure competitiveness, flexibility, and success. The course also includes a team-based and team-assessed case study project on topics related to Information Technology in business, with supporting workshops on team and project management, coding, and reference management skills. This module helps students become aware of the forces driving business change in a digital world and introduces some of the technical skills that support this. The course</span></font><span style="color: black; mso-fareast-font-family: DengXian; mso-fareast-theme-font: minor-fareast; mso-bidi-font-family: "Times New Roman"; mso-ansi-language: EN-US; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA;">is comprised of 11 2-hour lectures, four 1.5-hour laboratory tutorials and semester-length project.</span></span></span></p></div>',
...
weight: '50.00',
requirements: 'Lecture and Textbook online assessment'
}, {
type: 'lab',
weight: '50.00',
requirements: 'Laboratory and Case Study'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
