...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Media and Communication Theory',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>• Study communications theories and their relationship to concepts of society and culture;• Apply communications theories to an understanding of communications within and between differing institutional, social and cultural settings;• Critically assess the limitations of existing theoretical concepts as a means of understanding communications; and, where possible, suggest alternatives.</p></div>',
...
type: 'Coursework 1',
weight: '50.00',
requirements: 'Coursework essay 2,000 words'
}, {
type: 'Exam 1',
weight: '50.00',
requirements: ' '
