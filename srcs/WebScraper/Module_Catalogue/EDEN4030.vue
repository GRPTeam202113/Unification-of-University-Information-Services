...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Advanced Translation',
...
staffName: '',
generalFurtherActivityDetail: '<br>One three-hour workshops per week in which students will present prepared translations for comment and discussion and practice translating sources on sight.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><br>This module aims at developing students’ skills in translation to the point where they are able to operate across a wide range of subject areas as professional translators with an effort to facilitate the students in focusing on real-life translation tasks and becoming familiar with the problems encountered in professional translation and possible solutions.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding<br>A1 Knowledge and understanding of linguistic, textual and cultural issues relating to translation, and techniques for resolving difficulties<br>A3 Enriched knowledge and understanding of the lexis, structures and functions of English<br>A5 intercultural awareness of social and situational issues<br>Intellectual skills<br>B1 Critical analysis of source materials and strategies for resolving translation problems<br>B3 Ability to mediate between people and cultures<br>B4 Critical assessment of own and others’ translation<br>Professional, practical skills<br>C2 Ability to translate between English and Chinese across a wide range of subject areas<br>C3 Presentation, public speaking skills<br>C4 Research, planning and preparation for translation assignments<br>C6 Clear written and oral communication in both languages<br>Transferable (key) skills<br>D1 Oral and written communication and presentation skills<br>D2 Independent learning skills<br>D4 Time management and organisational skills<br>D5 Skill of working effectively under pressure<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><br>Contents of this module will mainly focus on translating texts of various genres, both into Chinese and into English. Students will have hands-on experience in this module, including: how to adapt to the target readership, how to assess a translation project, how to deal with problems that professional translators encounter.<br>Please note this module is assessed at the end of in Spring semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.<br> </p></div>',
assessmentFurtherActivityDetail: '<br>One three-hour workshops per week in which students will present prepared translations for comment and discussion and practice translating sources on sight.',
methodAndFrequency: [{
activity: 'Workshop',
...
type: 'Assignment',
weight: '50.00',
requirements: '<br />Coursework translations'
}, {
type: 'Exam',
weight: '50.00',
requirements: '<br />One 1.5-hour written examination'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
