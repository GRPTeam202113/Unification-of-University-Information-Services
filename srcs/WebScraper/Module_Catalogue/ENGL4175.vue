...
credit: '60.00',
level: '4',
targetStudents: 'Students following MA Applied Linguistics and MA Applied Linguistics and English Language Teaching',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module will provide students with: <br></p><li>the opportunity to research in depth a topic of their choice, under the direction of a subject specialist; <br></li><li>the skills and methodologies required to carry out sustained independent research.<p></p></li></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><strong>Knowledge and understanding:</strong></p><p>of a topic related to the scholarly interests and critical skills developed by the student during the MA course.<br><br><strong>Intellectual skills</strong></p><p>Students will develop the ability:</p><ul> <li>to evaluate current research and scholarship relating to a chosen topic;</li> <li>to devise research topics and develop methodologies appropriate to them; to analyse individual texts or topics within an intellectual framework informed by current scholarship.</li></ul><p><br><strong>Professional skills</strong><br>Students will develop the ability:</p><ul> <li>to articulate knowledge and understanding of the chosen area of study;</li> <li>to carry out research in a variety of media;</li> <li>to evaluate and make sure of the material acquired; to present their research accurately in writing.</li></ul><p><br><strong>Transferable skills</strong><br>Students will develop the ability:</p><ul> <li>to work independently and with some degree of originality or creative application;</li> <li>to make judgements according to the available evidence</li> <li>to communicate their findings clearly in writing.<p> </p></li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Students will choose a topic in consultation with an appropriate supervisor. There will be two published deadlines for submission of dissertation proposals: one for the initial proposal (usually in March) and one for the agreed proposal signed by the student and the supervisor (usually in April). The topic will normally be based on interests and skills that the students have developed in the course of the modules already studied. The topic of a MA ALELT dissertation needs to be relevant to language teaching.</p><p>Please note this module is assessed at the end of both Autumn and Spring semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
