...
credit: '60.00',
level: '4',
targetStudents: 'Students taking MA International Relations and World History and MA International Relations and International Business',
...
generalFurtherActivityDetail: '<br>Meetings with supervisors: 5 hours Information workshops: 5 hours Research 350 hours writing and redrafting: 240 hours.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>Aim: to provide students with the experience of undertaking a large-scale research topic as a basis for further post-graduate studies or professional work.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>a Knowledge and understanding A1 Gain knowledge in specific issues areas of globalisation and transnational politicsb Intellectual skills B1 Identify and evaluate key problems associated with a specific topic in the field of globalisationB2 Local, selecte and evaluate crticially and at an advanced level a variety of primary and secondary resourcesB3 Devise research topics and develop basic skills in investigating in and writing about these.c Professional practical skills C1 Plan, research and write up an original piece of researchC2 Develop individual analysis and interpretations of data within the broad framework of current analysis of world politics.d Transferable (key) skills D1 Demonstrate initiative in their approach to topics and show evidence of advanced critical and original thinkingD2 Gain specific knowledge of particular issue areas of global governanceD3 Take responsibility for their own work and continued professional development.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The dissertation is an extended piece of research or policy-oriented report in the field of global or transnational politics. All students will have a supervisor appointed at the end of the Autumn semester and they will be expected to consult regularly with their supervisor during and towards the end of the project. All dissertation students will be required to make use of both primary and secondary material and incorporate this into their dissertation.</p><p>Please note this module is assessed at the end of summer semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
assessmentFurtherActivityDetail: '<br>Meetings with supervisors: 5 hours Information workshops: 5 hours Research 350 hours writing and redrafting: 240 hours.',
methodAndFrequency: [{
activity: 'Un Assign',
numberOfWeeks: ' ',
...
type: 'Dissertation',
weight: '100.00',
requirements: 'Dissertation word count: 15000 words'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
