...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Logistics and Supply Chain Management',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'All business school students',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>Logistics and Supply Chain Management (LSCM) principles lie at the heart of modern day business operations. This module provides an awareness of key fundamentals. Particular focus is placed on competitive advantage in the context of cost and value as well as the operational and economic aspects relating to transport and logistics operations. Students are encouraged to critically engage with theory and practice by reference to academic literature and application.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><strong>knowledge of understanding</strong><br>This module develops a knowledge and understanding of:</p><ul> <li>The dynamics of the global economy and international business &amp;/or an awareness of cultural, legal/regulatory, political, and economic differences across countries &amp;/or an appreciation of management issues from a global perspective.</li> <li>The development and operation of markets for resources, goods and services.</li> <li>Customer expectations, service and orientation.</li> <li>The management of resources and operations.</li> <li>The development, management and exploitation of information systems and their impact upon organizations.</li> <li>The comprehensive use of relevant communication and information technologies for application in business and management.</li></ul><p><strong>Intellectual skills</strong><br>This module develops:</p><ul> <li>The ability to create, evaluate and access a range of options, together with the capacity to apply ideas and knowledge to a range of business and other situations.</li></ul><p><strong>Professional practical skills</strong><br>This module develops:</p><ul> <li>Qualitative skills including the ability to work with case studies.</li> <li>The ability to apply business models to business problems and phenomena.</li> <li>The ability to conduct research into business and management issues, either individually or as part of a team, including a familiarity with a range of business data and research resources and appropriate methodologies.</li></ul><p><strong>Transferable (key) skills</strong><br>This module develops:</p><ul> <li>Effective oral and written communication skills in a range of traditional and electronic media.</li> <li>Effective self-management in terms of time, planning and behaviour, motivation, self-starting, individual initiative and enterprise.</li> <li>The interpersonal skills for effective listening, negotiating, persuasion and presentation.</li></ul><p> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module provides an introduction to logistics and supply chain management (LSCM) within the international context. As such, the module examines: how LSCM strategies contribute to businesses" competitive advantage; the relationship aspects between business partners in delighting end-customers; and supporting operational activities and the international transport of goods. The module is taught by reference to academic literature and management practice, including case-studies and application to special topics such as humanitarian logistics and international trade.</p><p>Re-assessment format is decided by the school.</p></div>',
