...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Materials and Manufacturing',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Students in the first year of the Department of M3, those outside the Department requiring an introduction to materials behaviour and manufacturing processes',
...
staffName: '',
generalFurtherActivityDetail: '<br>Activities may take place every teaching week of the Semester or only in specified weeks. It is usually specified above if an activity only takes place in some weeks of a Semester<br><br>Further Activity Details:<br>Each student will attend the laboratory for up to 3 sessions. These sessions cover the basics of materials behaviour and manufacturing of materials. Visits and demonstrations will also take place at the University of Nottingham Advanced Manufacturing centre to view demonstrations of some of the latest state of the art equipment.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of this module is to introduce students to the properties of materials, the main failure mechanisms which a designer will be concerned with and the core high and low value manufacturing processes used in engineering applications.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module students will be able to:</p><p>LO1 – Comprehend the basic attributes of materials related to their class (including failure)</p><p>LO2 – Describe a range of manufacturing processes; understand key engineering principles and apply them to analyse those manufacturing processes</p><p>LO3 – Apply the knowledge from LO1 and LO2 to fundamental design problems in other parts of the curriculum</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This year long module introduces students to the properties of materials, the main failure mechanisms which a designer will be concerned with (e.g overload, fracture, creep, fatigue).and core manufacturing methods used in engineering applications. It includes the following topics:</p><p>• the role of materials and material properties in the design process.</p><p>• the selection and use of materials.</p><p>• the basic science underlying material properties and approaches to avoid failure of materials to provide the knowledge with which to design materials with better properties. For each property (or group of properties), a case study of practical design application will be addressed.</p><p>• an introduction to Manufacturing in the UK</p><p>an introduction to high value – low volume and low value – high volume manufacturing processes including: casting, machining, moulding, forming, powder processing, heat treatment, surface finishing and assembly.</p><p>• an introduction into Additive manufacturing</p><p>• an introduction to Manufacturing metrology</p></div>',
...
type: 'Coursework 1',
weight: '20.00',
requirements: 'Lab Assessment report'
}, {
type: 'Inclass Exam 1 (Written)',
weight: '10.00',
requirements: 'Mid sessional test (Autumn semester), &nbsp;45mins-1hr'
}, {
type: 'Exam 1',
weight: '70.00',
requirements: 'End of module examination (Spring semester)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
