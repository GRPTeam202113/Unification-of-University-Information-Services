...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Operating Systems & Concurrency',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Part I undergraduate students in the School of Computer Science only. This module is part of the Operating Systems and Networks theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Qian Zhang',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To teach the theoretical background and practical implementation of traditional operating systems.To consider the history and development of Operating Systems.To convey a basic understanding of the concepts, problems, and techniques of concurrent programming and concurrency in operating systems.To show how these can be used to write simple concurrent programs.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>ʥA broad view of operating system principles.<br>ʥKnowledge of key issues in the practical implementation of operating systems.<br>ʥUnderstanding of the concepts, problems and techniques of concurrent programming.</p><p>Intellectual Skills:<br>ʥThe ability to think independently while giving due weight to the arguments of others.<br>ʥThe ability to understand complex concepts and apply them to specific situations.</p><p>Professional Skills<br>ʥEnhanced programming skills.<br>ʥThe ability to write simple concurrent programs.</p><p>Transferable Skills<br>ʥThe ability to solve OS design problems.<br>ʥThe ability to solve problems.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This course covers the fundamental principles that underpin operating systems and concurrency. Topics in operating systems that are covered include the architecture of operating systems, process and memory management, storage, I/O, and virtualisation. The principles of concurrency will be introduced from both the perspective of an operating system and user applications. Specific topics on concurrency include: hardware support for concurrency; mutual exclusion and condition synchronisation; monitors; safety and liveness properties of concurrent algorithms, and the use of threads and synchronisation.</p></div>',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Programming assignment which coursework will involve the writing of one or multiple programs utilising operating system API functions and mechanisms to support concurrency and multithreading'
}, {
type: 'Exam 1',
weight: '75.00',
requirements: '2 hours written examination'
}],
staffOffice: 'Room 407, Sir Peter Mansfield Building',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 574 8818 0000(ext 6603)',
