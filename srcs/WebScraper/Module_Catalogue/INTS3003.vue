...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Dissertation: Final Presentation',
year: 'Academic Year 2022',
credit: '30.00',
level: '3',
targetStudents: 'Single Honours and Joint Honours in International Studies (compulsory).',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '1 x 10,000-word dissertation'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
