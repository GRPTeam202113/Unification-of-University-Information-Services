...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Interpreting and Translation in Science and Technology',
...
staffName: 'Ken Chen',
generalFurtherActivityDetail: '<br>Activities mainly concern translating of authentic texts in the subject areas and related mock conferences by students’ own contribution or by guest speakers.  <br>In addition to attending weekly workshops, students are also encouraged to attend relevant lectures offered by the Divisions of Engineering, Sustainable Development, and Computer Science.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module enables students to deepen their conceptual knowledge and understanding in the fields of Engineering, Science and Technology, and to become familiar with the challenges of translating and interpreting in these fields. Students will work both into Chinese and into English.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>1 Knowledge and understanding A2 Knowledge and understanding of linguistic, interpersonal, ethical, business and cultural issues relating to interpreting, and techniques for resolving difficulties A3 Enriched knowledge and understanding of the lexis, structures and functions of English A5 intercultural awareness of social and situational issues Intellectual skills B2 Critical analysis of interpreting assignments and strategies for resolving problems B3 Ability to mediate between people and cultures B4 Critical assessment of own and others’ translation and interpreting Professional, practical skills C1 Ability to interpret between English and Chinese in consecutive and, subject to module profile, simultaneous mode across a wide range of subject areas C3 Presentation, public speaking skills C4 Research, planning and preparation for interpreting and translation assignments C6 Clear written and oral communication in both languages Transferable (key) skills D1 Oral and written communication and presentation skills D2 Independent learning skills D3 Interpersonal skills D4 Time management and organizational skills D5 Skill of working effectively under pressure</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><br>Students build up a portfolio of translations and consecutive interpreting experience in the particular areas of Engineering, Science and Technology. Skills of peer- and self-criticism of translations and interpretations are developed in a workshop setting, where general issues arising from the translations and interpretations are also discussed.</p></div>',
assessmentFurtherActivityDetail: '<br>Activities mainly concern translating of authentic texts in the subject areas and related mock conferences by students’ own contribution or by guest speakers.  <br>In addition to attending weekly workshops, students are also encouraged to attend relevant lectures offered by the Divisions of Engineering, Sustainable Development, and Computer Science.',
methodAndFrequency: [{
activity: 'Workshop',
...
type: 'Coursework',
weight: '50.00',
requirements: 'Two pieces of translation from Chinese into English and two from English into Chinese, each about 700 words in length, which involve familiarizing with the terminologies, syntactical and contextual features.'
}, {
type: 'Final exam',
weight: '50.00',
requirements: 'One sight translation exam (two directions)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
