...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Fluid Mechanics and the Built Environment 2',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Architecture and Environmental Design year 3 Students',
