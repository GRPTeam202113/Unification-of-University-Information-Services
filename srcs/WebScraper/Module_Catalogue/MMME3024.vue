...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Computer Aided Engineering',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'For BEng Mechanical Engineering and Product Design and Manufacture programmes.',
...
generalFurtherActivityDetail: '<br>Students will be expected to make use of the computer laboratories to complete work outside the timetabled classes.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide students with some advanced practical CAE skills particularly for use in project work and industry. Also to provide students with an awareness of the computational tools available for use within the design process.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>LO1 ¨C Apply core engineering and mathematical principles to evaluate CAE system analyses and appreciate their limitations.LO2 ¨C Identify data sources, extract and synthesise data from various sources to create complex models and analyses.LO3 ¨C Identify and critically evaluate developing CAE tools and techniques.LO4 ¨C Understand and appreciate the principles of design intent and design process within the context of CAE.LO5 ¨C Justify and communicate techniques selected for model generation and analysis.LO6 ¨C Provide visualisations as computer models and renderings of a product, component or system. (IED outcome).</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module includes further development of modelling and analysis techniques within CAE (currently Creo) introduced in MM1DM1 and MM2DM2 to enable the student to create, display and analyse complex forms and assemblies. Various elements of CAE will be covered including, solid &amp; surface modelling, rendering and analysis. Review of the CAE software and industry.</p></div>',
assessmentFurtherActivityDetail: '<br>Students will be expected to make use of the computer laboratories to complete work outside the timetabled classes.',
methodAndFrequency: [{
activity: 'Practicum',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Group presentation (approx 10 hours work outside the timetables classes)'
}, {
type: 'Coursework 2',
weight: '75.00',
requirements: 'Advanced modelling assignment (approx 20 hours work outside timetabled classes)'
}],
