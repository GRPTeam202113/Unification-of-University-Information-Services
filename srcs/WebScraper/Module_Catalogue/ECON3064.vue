...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Advanced Monetary Economics',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Seminar and Group Essay (1500 words) + 40-minute presentation'
}, {
type: 'Exam 1',
weight: '75.00',
requirements: '1.5&nbsp;Hours--written exam.'
}],
staffOffice: 'Room 303, IEB',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 (0)574 8818 8443',
staffDepartment: 'Faculty of Humanities and Social Sciences',
staffUrl: 'https://www.nottingham.edu.cn/en/Humanities-and-Social-Sciences/People/Profile.aspx?id=a480af91-88c1-41c0-baae-7f7cdf591ca4&amp;language=en-GB'
};
  },
  methods: {
    goPage() {
