...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Intermediate Mathematical Economics',
...
staffName: 'Dr Chee Kian Leong',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The goal of this module is to enhance the student’s quantitative preparation, with the special focus on economic dynamics as these are useful pre-requisites for Level 3 modules in microeconomics, macroeconomics, econometrics and advanced mathematical economics.</p><p>This module bridges the gap between the Level 1 Mathematical Economics and Econometrics module and the Level 3 Advanced Mathematical Economics module.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding:</p><p>This module develops a knowledge and understanding of:<br>-Show understanding of analytical methods, both theory- and model-based.<br>-Show understanding of relevant mathematical and statistical techniques.</p><p>Intellectual skills:</p><p>-Reason logically and work analytically.<br>-Be able to frame analysis of problems, identifying which parameters should be taken as fixed and why they might change</p><p>Professional practical skills:</p><p>-Be familiar with differing approaches to analysing a given economic problem and the history and development of economic ideas</p><p>Transferable (key) skills:</p><p>-Apply mathematical, statistical and graphical techniques in an appropriate manner.<br>-Use appropriate IT packages effectively..<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>1. Further Topics in linear algebra<br>2. Differential Equations 1: First order and second order equations, Phase Diagrams<br>3. Differential Equations 2: System of Differential Equations<br>4. Dynamic Optimization 1: Calculus of variations<br>5. Dynamic Optimization 2: Optimal Control Theory<br>6. Difference Equations, Lag Operators<br>7. Discrete time optimization<br> </p><p>Please note this module is assessed at the end of in Autumn semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
staffTelephone: '+86 (0)574 8818 9315 or +86 (0)574 8818 0125',
