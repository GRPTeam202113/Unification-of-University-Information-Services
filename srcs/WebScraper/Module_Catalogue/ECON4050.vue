...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Economics of Corporate Finance',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of this module is to provide a guide to this new area of financial economics.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A Knowledge and Understanding. Students should demonstrate<br> A2 An understanding of advanced theoretical methods (including graphical and mathematical representations of economic ideas)<br>A4 An advanced knowledge of specialisms in economics, including the current state of research in that field<br>A5 An understanding of institutions, policies and the broader context in which specific economic analysis is applied<br>B Intellectual Skills. Students should be able to<br>B2 Use analysis, deduction and induction to solve economic problems<br>B3 Apply economic theory to economic institutions and policies</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module offers an introduction to the economics of Corporate Finance. It is designed to provide students with the basic theoretical background in this area that is necessary for any applied work. Emphasis is placed on the analysis of simple models and their applications. The module covers a variety of topics with substantial time devoted for covering issues directly related to the financial needs of firms, such as capital structure, credit rationing and corporate governance. The module also examines the role of financial intermediaries analyzing bank failures and, consequently, the scope for banking regulations. The last part of the module looks closely at the relationship between the financial sector and the real economy thus offering the background for any applied work related to the link between financial development and economic fluctuations.</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Assignment1',
weight: '10.00',
requirements: '6 homework assignments.&nbsp;'
}, {
type: 'Exam1',
weight: '90.00',
