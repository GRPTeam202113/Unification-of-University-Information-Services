...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Database Design and Implementation',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'FAM, IBM, IBC, IBL, BE and IBEu.Available to JYA/Erasmus students.',
offeringSchool: 'Nottingham University Business School China',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Zhao Cai',
generalFurtherActivityDetail: '<br>4 lab sessions for the semester',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>•To provide basic understanding of database systems and their business applications.</p><p>•To provide practical skills to create a database system using a suitable modern database management system.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>This module develops:</p><ul> <li>an understanding of the development, management and exploitation of information systems and their impacts upon organizations;</li> <li>the cognitive skills of critical thinking, analysis and synthesis;</li> <li>the practical skills of effectively using communication and information technology (CIT) skills to develop business applications;</li> <li>effective self-management in terms of time, planning and behavior, motivation, self-starting, individual initiative and enterprise;</li> <li>an appetite for reflective, adaptive and collaborative learning.</li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module contains:</p><p>1. Data Modeling<br>2. SQL<br>3. Data Mining<br>4. Dynamic Webpages<br>5. Data Visualization<br>6. Transaction Processing</p><p>Re-assessment format is decided by the school.</p></div>',
assessmentFurtherActivityDetail: '<br>4 lab sessions for the semester',
methodAndFrequency: [{
activity: 'Computing',
...
type: 'Coursework 1',
weight: '70.00',
requirements: '3.000 word group project'
}, {
type: 'Exam 1',
weight: '30.00',
requirements: 'One 1 hour multiple choice exam'
}],
