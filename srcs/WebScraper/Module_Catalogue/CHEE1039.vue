...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'An Introduction to Structure, Periodicity and Coordination Chemistry',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 10pt; text-align: justify; line-height: normal; -ms-text-justify: inter-ideograph;"><span style="font-size: 12pt;"><span style="font-family: times new roman,serif;">To show how trends in chemical properties can be related to the structure of the</span></span></p><p style="margin: 0in 0in 10pt; text-align: justify; line-height: normal; -ms-text-justify: inter-ideograph;"><span style="font-size: 12pt;"><span style="font-family: times new roman,serif;">Periodic Table and rationalise descriptive inorganic chemistry. To develop an appreciation of the relationship between the position of an element in the periodic table and the atomic properties, bonding characteristics and the consequences for the structural chemistry. To introduce and explain the fundamental principles underlying d-electron element (transition metal) chemistry, to give an insight into the application of crystal field and molecular orbital theories to the structure of, and bonding in, co-ordination complexes of the d-electron elements and to develop the ability to predict the chemistry of the d-electron elements from their position in the Periodic Table.</span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 10pt; text-align: justify; line-height: normal; -ms-text-justify: inter-ideograph;"><span style="font-size: 12pt;"><span style="font-family: times new roman,serif;">By the end of this module, a successful student will: have gained a good working knowledge of the key aspects of inorganic chemistry (interpretation of the periodic table, atomic properties, electron configuration, periodicity, structure and bonding, symmetry, coordination complexes and their properties), which underpin much of the study of Chemistry; be able consider various chemical aspects, then select and apply suitable methods in order to tackle unseen problem solving scenarios; have gained an appreciation of the atomic/molecular basis of many key quantities and ideas used in Chemistry.</span></span></p><p style="margin: 0in 0in 10pt; text-align: justify; line-height: normal; -ms-text-justify: inter-ideograph;"><span style="font-size: 12pt;"><span style="font-family: times new roman,serif;">Transferable/Key Skills: problem-solving, scientific deduction, and written communication skills.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span lang="EN-GB" style="line-height: 115%; font-family: "Times New Roman",serif; font-size: 12pt; mso-fareast-font-family: "Times New Roman"; mso-ansi-language: EN-GB; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA;"><font color="#000000">Atomic structure; Quantum numbers; Electronic configuration; Building the periodic table using theory; Periodicity; Chemical bonding; Lewis structures; Molecular shape and symmetry; Intermolecular interactions; Ligands and how they coordinate to metal centres; Bonding in transition metal complexes; Crystal field and molecular orbital theory; Geometries of complexes and isomerism; UV/vis spectroscopic and magnetic properties of octahedral, tetrahedral and square planar complexes; Reaction kinetics and thermodynamics; Trends in the properties of d-block element complexes. Formative feedback is given on the material in this module via the associated tutorials. Summative feedback is provided after the exam by the module convenor.</font></span></p></div>',
