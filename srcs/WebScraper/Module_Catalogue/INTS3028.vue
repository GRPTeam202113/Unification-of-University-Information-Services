...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Global Development Politics',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Students of the School of International Studies and Exchange students',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of this module is to provide students with advanced knowledge in a specific issue area of world development politics. Students will become familiar with issues pertaining to global unequal development, examining why some countries have developed and others have stagnated. The main focus will be on global questions of international development politics and problems of economic and socio-political development. The course will provide a foundation to interrogate and critically examine social structures, institutions, socio-economic hierarchies and development policies as theories meet practice. The Global South will receive particular attention.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A. Knowledge and understanding<br>1) Students will acquire a general understanding of the development process, its main actors, methods and discourses including competing development narratives. <br>2) They will gain in-depth knowledge of major theories dealing with international development.<br>3) They will gain knowledge of particular actors of global development policies (state agencies, international organisations, non-governmental organisations)<br>4) In addition, they will acquire in-depth knowledge of specialist areas of development, such as structural adjustment, health, debt, technology, environmental sustainability (climate change debates) etc.<br>B. Intellectual skills<br>1) Critical understanding of abstract concepts of modernisation, development, economy and welfare<br> 2) Comparison and discussion of different theoretical models of socio-economic development<br>3) Historical understanding of the world distribution of wealth and resources<br>C. Professional practical skills<br>1) Research and writing of abstract subject matters<br>2) Oral and written presentations through engaging in regular seminar group discussion and debates and through the oral reporting of group discussion outcomes.<br>3) Ability to coordinate group work detail, develop consensus and work to tight deadlines. <br>4) Analysis of current economic affairs: newspaper analysis, information collection and exploitation<br>5) Data mining and presentation<br>6) Digital capabilities through the honing of skills related to conducting online academic searches<br>7) Develop and utilise videography skill sets to create learning content in forms of a vlog. <br> <br>D. Transferable (key) skills<br>1) Use of information resources: electronic sources, library, newspapers, others.<br>2) Use of different presentation techniques: PowerPoint Presentation, oral presentations, drama skits, video presentation, written reports and posters. <br>3) Group work and division of labour in group projects<br>4) Effective Policy Briefing Report Writing <br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This specialization module will look at theories and experiences of economic development. It will address the sociological, political and ethical questions related to modernization and compare different theoretical approaches to development. It will furthermore consider the practical problems arising from development management and organisation and take the role of international organisations, NGOs and state actors under close scrutiny.<br>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.<br> </p></div>',
...
type: 'Coursework 1',
weight: '30.00',
requirements: '1800 word Essay'
}, {
type: 'Coursework 2',
weight: '20.00',
requirements: 'Group Activity and 1200 word group report'
}, {
type: 'exam',
weight: '50.00',
requirements: '2 questions in 2 hours'
}],
