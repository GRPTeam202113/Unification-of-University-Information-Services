...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Stochastic Models',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Single Honours students from the School of Mathematical Sciences.Requisites: MATH2039 Probability Models and Methods',
offeringSchool: 'School of Mathematical Sciences',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: '',
generalFurtherActivityDetail: '<br>Two one-hour and one two-hour classes per week timetabled centrally, some of which may be used for examples classes and/or problem classes.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The purpose of this module is to broaden the students" knowledge and experience of stochastic processes by studying a wide range of stochastic models that have application in the natural sciences and in industry.<br>This course builds upon the ideas of stochastic processes introduced in the module MATH2039. Students will acquire knowledge and skills of the analysis and application of stochastic models.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully should be able to:</p><p>L1 - derive and apply basic properties of homogeneous Poisson processes;</p><p>L2 - state and apply basic properties of continuous-time Markov chains (e.g. definition of chain; holding times and jump probabilities; Chapman-Kolmogorov equations );</p><p>L3 - derive forward and backward equations and equilibrium distributions for continuous-time Markov chains;</p><p>L4 - state and apply basic properties of chain-binomial and carrier-borne epidemic models (e.g. definitions of Reed-Frost and Greenwood models; calculation of epidemic chain probabilities; calculation of final size distributions);</p><p>L4 - state and apply basic results and methods for analysing queues (e.g. method of stages; Little Theorem; mean busy period)</p><p>L5 - state and apply basic results and methods for system reliability (e.g. reliability function; parallel and series systems; new-better-than-used distributions; calculation of optimal block replacement schemes);</p><p>L6 - state and apply Ito Lemma (e.g. for calculating expectations and integrals);</p><p>L7 - solve simple stochastic differential equations.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>In this module the ideas of discrete-time Markov chains, introduced in the module MATH2039, are extended to include more general discrete-state space stochastic processes evolving in continuous time and applied to a range of stochastic models for situations occurring in the natural sciences and industry. The module begins with an introduction to Poisson processes and birth-and-death processes. This is followed by more extensive studies of epidemic models and queueing models, and introductions to component and system reliability. The course finishes with a brief introduction to Stochastic Differential Equations. Students will gain experience of classical stochastic models arising in a wide variety of practical situations. In more detail, the course includes:<br>• homogeneous Poisson processes and their elementary properties;<br>• birth-and-death processes - forward and backward equations, extinction probability;<br>• epidemic processes - chain-binomial models, parameter estimation, deterministic and stochastic general epidemic, threshold behaviour, carrier-borne epidemics;<br>• queueing processes - equilibrium behaviour of single server queues;<br>• queues with priorities;<br>• component reliability and replacement schemes;<br>• system reliability;<br>• Stochastic differential equations and Ito lemma.</p></div>',
assessmentFurtherActivityDetail: '<br>Two one-hour and one two-hour classes per week timetabled centrally, some of which may be used for examples classes and/or problem classes.',
methodAndFrequency: [{
activity: 'Lecture',
