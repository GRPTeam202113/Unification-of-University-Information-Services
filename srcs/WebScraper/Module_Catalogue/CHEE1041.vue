...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Process Engineering Principles',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Students major in Chemical Engineering and Environmental Engineering only.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 0pt; text-align: justify; line-height: 115%;">To provide an understanding of the fundamental material and energy balances that underpins process engineering. To provide knowledge and understanding of the methods of calculating material and energy balances around a process flowsheet and to practical laboratory experience in engineering processes. The module introduces the basic principles and concepts behind basic unit operations used in chemical and environmental processes and applications. The module enables understanding so that students are able to apply separation processes in given applications and use appropriate calculation techniques to size process equipment.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="text-align: justify;">A2.2.1 Understand the principles of material and energy balances.<br>• Exemplar material balances based on rudimentary designs.<br>A2.3.1 Be familiar with, and able to apply, a range of appropriate tools such as dimensional analysis and mathematical modelling.<br>• For unit conversion.<br>A2.3.2 Understand the role of empirical correlation and other approximate methods.<br>• Do iterative methods to determine the correct outputs of multi staged evaporators.<br>A2.4.1 Understand and be able to apply methods to analyse the characteristics and performance of a range of typical mixing, separation, and similar processing steps for fluids, particulates and multi-phases.<br>• Analyse a series of different feeds and outputs to determine the basic operation of separation necessary.<br>A2.4.3 Understand and be able to estimate the effect of processing steps upon the state of the material being processed, and on the end product in terms of its composition, morphology and functionality.<br>• The number of stages required to achieve desired composition of the extract.<br>A2.5.1 Understand the principles of batch and continuous operation and criteria for process selection.<br>• Generate a series of different separation techniques using both the batch and continuous processes with material and energy balances associated.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 0pt; text-align: justify;">The module is designed to cover material balances including once-through and recycle systems; flowsheets for continuous processes; batch processes; steady and unsteady state operation; reacting and non-reacting systems; energy balances; combustion calculations; heat balances in chemical and physical systems; enthalpy/composition diagrams. In addition, the module covers the principals of physical separation processes namely basic separation principles, cross-current and counter-current leaching process, single and multiple effect evaporation, vapour recompression integrated with evaporator, crystallization separation processes and stagewise and continuous liquid-liquid extraction processes. Principles of operation, design concepts and sizing of process equipment are included.</p></div>',
...
weight: '20.00',
requirements: 'Practical Assessment Week (per semester)'
}, {
type: 'In-Class Test',
weight: '10.00',
requirements: 'In-Class Test (Autumn semester)'
}, {
type: 'Written Report',
weight: '10.00',
requirements: 'Group lab report (Spring semester)'
}, {
type: 'Exam 1',
weight: '60.00',
requirements: 'Three-hour examination at end of Spring semester.'
}],
