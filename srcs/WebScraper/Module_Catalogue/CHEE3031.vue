...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Process Simulation 1',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to promote an understanding of steady-state process simulation by computer. It has an objective to illustrate the benefits and limitations of using commercial simulation software for process design</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>2.3.1 Be familiar with, and able to apply, a range of appropriate tools such as dimensional analysis and mathematical modelling.</p><p>A2.3.2 Understand the role of empirical correlation and other approximate methods.</p><p>A2.3.3 Be competent in the use of numerical and computer methods, including industry-standard chemical engineering software, for solving chemical engineering problems (detailed knowledge of computer coding is not required).</p><p>A5.2.5 Be effective users of IT.</p><p>All the above are assessed using commercial software (Hysys) in the open-book class test and the individually assigned coursework question.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is an introduction to steady-state process simulation by computer. Students will use a commercial package in a design environment and will develop an understanding of the benefits and drawbacks of such tools. Students will complete a series of assignments in their own time. (The current package is HYSYS)</p></div>',
...
type: 'Coursework 1',
weight: '50.00',
requirements: 'Submission of 1 flowsheet simulations with presentation and interpretation of main engineering results. Questions will be individually assigned to each student.'
}, {
