...
type: 'Coursework 1',
weight: '30.00',
requirements: 'The students will answer questions as well as program graphics systems to demonstrate that they understand computer graphics principles and techniques.'
}, {
type: 'Coursework 2',
weight: '70.00',
requirements: 'Programming project designing and implementing a 3D graphics scene, plus a written report and a demonstration of the project.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
