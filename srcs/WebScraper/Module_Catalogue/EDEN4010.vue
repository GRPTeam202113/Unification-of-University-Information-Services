...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Leading and managing changes in International Higher Education',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>•  synthesise material from the previous three units into a coherent vision of internationalisation;<br>•  engage students in considering the implications for an HE institution as a whole of adopting a commitment to greater internationalisation;<br>•  encourage participants to reflect critically on their own practice and that of other departments in their institution in relation to internationalisation;<br>•  provide an opportunity for critical engagement with models of change management and evaluation in their application to significant institutional development;<br>•  provide experience of small-scale empirical data gathering, analysis and reporting.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p> </p><p> Knowledge and understanding<br>A student who completes the module should be able to:<br>• understand and critically analyse key implications and consequences of internationalism across all functions and departments of an HE institution;<br>• critically evaluate major models of institutional change management in relation to the internationalisation of an HE institution;<br>• plan an internationalisation evaluation regime based on an understanding of current good models and practice;<br>• understand and critically analyse key issues of strategy and management in international and transnational HE.</p><p>Intellectual skills<br>A student who completes the module should have improved the following intellectual skills:<br>• undertaking critical analysis and evaluation of both educational research literature and policy documents;<br>• synthesising diverse ideas on internationalisation into a coherent vision;<br>• knowing how to develop written and oral arguments about educational matters.</p><p>Professional and practical skills<br>A student who completes the module should have developed the following professional and personal skills:<br>• taking a research-informed and evidence-based approach to professional activities;<br>• developing action plans for diverse needs from an overall strategy document;<br>• ability to carry out a focussed interview for data gathering purposes and to interpret and use appropriately the data obtained.</p><p>Transferable skills<br>A student who completes the module should have improved the following transferable skills:<br>• problem solving in terms of bringing diverse perspectives and needs together into a coherent programme;<br>• capacity to appreciate diverse perspectives and meanings of internationalisation from different functional positions;<br>• critical reflection on professional practice as an active engagement with theories;<br>• integrating personal research findings with professional practice.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p>In this module we examine the practical demands of moving towards an enhanced internationalisation of higher education across all functions and departments. Using theories of personal and institutional change and change management, and we shall explore the realities of practice in your, and other participants, institutions. Drawing on areas studied earlier in the course, such as interpretations of internationalisation, tensions between higher educations various roles, and the effect of regulatory mechanisms, we will analyse their implications for all aspects of the higher education life: from teaching and research, through social activities to accommodation, catering and security. This will be used to identify change and development needs in various functions and constituencies (management, administration, students, academic staff, etc.). We shall discuss and develop strategies for change, looking at issues such as staff knowledge and skills development, and organisational structures and cultures. We shall also consider what success in internationalisation might involve, and how to achieve and evaluate it. To help keep this process firmly based in contemporary institutional realities, you will carry out a small piece of research into one department/function within your own or another institution.<br>Please note this module is assessed at the end of Spring semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '6000 words research report supported by 1 or 2 interviews'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
