...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Energy and Waste',
...
type: 'Project 1',
weight: '10.00',
requirements: 'Calculation exercise and written report'
}, {
type: 'Exam 1',
weight: '90.00',
