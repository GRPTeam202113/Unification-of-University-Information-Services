...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Language and Context',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '3000 word essay at end of Spring Semester'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
