...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Media and Communication Research Methods 1',
year: 'Academic Year 2022',
credit: '10.00',
level: '4',
targetStudents: 'MA students in International Communications and related programmes at the University of Nottingham Ningbo campus. Available to JYA/Erasmus students.',
...
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module offers an introduction to media and communication research methods. Through convenor-guided, team-instructed and student-centred learning of key research methods and specific research examples, students learn how to choose and use qualitative, quantitative or mixed methods for their research projects. They also learn how to critically review previous studies on a topic of their choice, how to design a feasible research project, and how to generate research questions and/or hypotheses. Furthermore, they also learn how to write a research proposal, how to effectively and specifically phrase research questions and/or hypotheses, how to conduct a research project, and how to structure and write a dissertation. Specific research methods selected by the convener include those involved in cultural studies, film studies, media studies, and communication studies.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Presentation',
weight: '40.00',
requirements: '10 minutes + 5 minutes of Question and Answer'
}],
