...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'A Global History of Empire-the British Empire',
year: 'Academic Year 2022',
credit: '20.00',
level: '4',
targetStudents: 'Students of the School International Studies',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To encourage students to think critically about Britain role in the history of the world over the past four hundred years from the point of view of Britain culture and current politics; connecting Britain national history, with European history and world history.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On the completion of this module, students should have acquired:<br>Knowledge:<br>• Explain the British Empire role and responsibility in the international system; • Display a sound understanding of the history of the British Empire as well as many possible causes of that history; • Understand many basic theoretical approaches to studying British Imperial History; • Demonstrate knowledge of the relationship between the global and domestic political arenas.<br>Intellectual skills:<br>• Think critically and imaginatively about the subject matter; • Assess the key approaches to historiographical debates and assess their applicability to Britain; • Use and interpret primary and secondary sources, and be aware of competing interpretations of the subject; • Construct independent and coherent arguments (the seminar format allows greater development of oral skills).<br>Professional and practical skills:<br>• Select, sift and synthesise information from a range of primary and secondary sources; • Identify and compare key arguments in the material; • Demonstrate appropriate referencing and bibliographic skills; • Use the intranet to access the library catalogue.<br>Transferable skills:<br>• The module will also develop students’ ability: • to manage a large and disparate body of information; • to express themselves clearly, coherently and fluently in written essays, as well as in class presentations; • to work and learn independently and actively with others; • to manage and take responsibility for their own learning; • to respect the views of others; • to use IT to prepare their assessed essays and contribute to class discussions.</p><p> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module builds upon the students’ understanding of history and global politics and applies their comprehension of these fields to a specific case-study. The module will encourage students to analyse Britain’s historical role in the international system and its engagement with other powers. In particular, it will consider the rise and expansion of the British Empire from Queen Elizabeth I to the Winds of Change in Africa; Britain’s involvement in the emerging globalised world order; Britain’s diplomacy and the construction of Britain’s foreign policy; the Wars of Empire and the effects of globalization</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'A 1000-word written assignment (report or analysis of primary source)'
}, {
type: 'coursework2',
weight: '75.00',
requirements: 'A 3000-word essay'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
