...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Advanced Interpreting',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The module enables students to develop further the competence and confidence to interpret between Chinese and English, with the additional component of simultaneous interpreting. They will develop the whole range of interpreting skills to a high level of professional competence.</p></div>',
...
type: 'Mid-term exam',
weight: '30.00',
requirements: 'Midterm exam in teaching week 6 on simultaneous interpreting without text, both ways about 6 minutes each'
}, {
type: 'Final exam',
weight: '40.00',
requirements: 'Final exam in the designated week on simultaneous interpreting with text, both ways, 6-8 minutes each'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
