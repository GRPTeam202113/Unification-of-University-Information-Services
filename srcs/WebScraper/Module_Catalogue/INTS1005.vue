...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Understanding the West: Europe as Cradle of Western Civilization',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Students on the degree of European Studies, International Studies, and International Studies with Language. Compulsory for European Studies and International Studies. Accessible to Exchange students until further notice.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>On successful competition of this class students will build a solid knowledge foundation in quantitative political methodology and be ready for more advanced courses in the field.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>(a) Knowledge and understanding.<br>•  explain and interpret key ideas, institutions, cultural and political movements that underlie European and Western Civilization<br>(b) Intellectual skills.<br>•  think critically and imaginatively about the subject matter;<br>•  identify and address key problems relevant to it;<br>•  construct coherent and independent historical arguments of their own.<br>(c) Practical skills.<br>The module will develop students ability to:<br>•  critically discuss primary sources in historical perspective<br>•  select, sift and synthesise information from secondary sources and the Internet;<br>•  demonstrate appropriate footnoting and bibliographical skills;<br>•  use the University intranet to access the library catalogue.<br>(d) Transferable skills.<br>•  express themselves clearly, coherently and fluently in written essay and oral presentations;<br>•  work and learn actively with others;<br>•  manage and take responsibility for their own learning;<br>•  respect the views of others;<br>•  use IT to word process their assessed essay.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module will cover the social, economic, and political developments of greatest consequence for European history and, by extension, for Western civilization. Topics will be taken up chronologically. These include Greek city-states; Roman republican period and empire; the basic teachings of Christianity and their impact on the classical world; the contribution of Benedictine monasticism and the Investiture Controversy; the age of exploration; the Reformation and absolutism.<br>The module will also train students to use primary historical sources.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
