...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Quantitative Analysis for Business',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Available to Qualifying Year IBL, IBC, IBM students who do not take P11127 QM1B. (Students who choose this module may have restricted choices on Quantitative modules in later years)',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>Module provides a grounding in practical aspects of quantitative analysis.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding:</p><p>This module develops a knowledge and understanding of:</p><ul> <li>The management of resources and operations.</li> <li>The development, management and exploitation of information systems and their impact upon organizations.</li></ul><p>Intellectual skills:</p><p>This module develops:</p><ul> <li>Effective quantitative problem solving and decision making skills.</li></ul><p>Professional practical skills:</p><p>This module develops:</p><ul> <li>Numeracy and quantitative skills including data analysis, interpretation and extrapolation.</li> <li>Effective performance within a team environment, including leadership, team building, influencing and project management skills.</li> <li>The ability to conduct research into business and management issues, either individually or as part of a team, including a familiarity with a range of business data and research resources and appropriate methodologies.</li></ul><p>Transferable (key) skills:</p><p>This module develops:</p><ul> <li>Effective oral and written communication skills in a range of traditional and electronic media.</li> <li>Statistical techniques and their application in a business context.<p> </p></li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p><strong>Any</strong> student who has done Gaokao cannot take this module.</p><p>This module provides a grounding in practical aspects of quantitative analysis with an emphasis on understanding and analysing data. Students will learn to apply statistical techniques to formulate and solve quantitative business problems. Students will develop skills in the use of spreadsheets for statistical analysis and in interpreting statistical results. A group project forms part of the assessment allowing students to improve their team working and management skills.</p></div>',
...
type: 'Coursework 1',
weight: '30.00',
requirements: 'one 2500 word group project'
}, {
type: 'Exam 1',
weight: '70.00',
