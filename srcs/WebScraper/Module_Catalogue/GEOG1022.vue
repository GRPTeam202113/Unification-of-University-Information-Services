...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Principles of Ecology',
...
staffName: 'Dr Tengwen Long',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce students to fundamental ecological concepts and theories and to gain a greater understanding of the diversity of ecological systems and the processes involved with ecosystem functioning.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A.Knowledge and Understanding - to learn of:<br>1) Ecology and its component sub-disciplines.</p><p>B.Intellectual Skills - the ability to:<br>1) Critically analyse and interpret information and data<br>2) Derive and analyse material from a range of sources.</p><p>C.Practical/Professional Skills - the ability to:<br>1) Undertake invertebrate identification<br>2) Work safely in the laboratory.</p><p>D.Transferable/Key Skills - the ability to:<br>1) Communicate via poster<br>2) Be successful in team working<br>3) Find relevant information in the library and the web<br>4) Improve time management.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><br>This module introduces the principles of ecology at a first year level. The module covers:<br><br><br>1. Evolutionary aspects of ecology.<br><br>2. Organisms and their envrionment: physical, chemical and biotic factors limiting species distribution; capture and utilisation of resources by organisms; the niche concept; life cycles and dispersal.<br><br>3. Population Ecology: intraspecific and interspecific competition; predation; parasitism and mutualism.<br><br>4. Community Ecology: diversity and stability of communities; patterns of species richness; the concept of a climax community; energy flow and nutrient cycling.<br><br>5. Ecology of Habitats.<br><br> </p></div>',
...
type: 'Coursework 1',
weight: '5.00',
requirements: 'Project with Poster output'
}, {
type: 'Exam 1',
weight: '45.00',
requirements: 'MCQ and Short Essays, Autumn'
}, {
type: 'Exam 2',
weight: '50.00',
requirements: 'Short Essays, Spring'
}],
...
staffTelephone: '+86 (0)574 8818 0000-8719',
