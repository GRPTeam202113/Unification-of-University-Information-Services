...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Advanced Mathematical Methods for Civil Engineering',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>HG2MMC provides a Part I provision to equip students with both confidence and competence in a range of fundamental advanced mathematical techniques and basis for applying these to the quantitative study and analysis of problems in Civil Engineering. There is a strong emphasis on connecting these with the Civil Engineering modules taken in their second year.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding of mathematics necessary to support application of key engineering principles. To apply mathematical methods, tools and notations proficiently in the analysis and solution of engineering problems.</p><p>A student who completes this module successfully should be able to:</p><p>&lt;li&gt;L01 – Understand complex numbers and their use and manipulation in developing enhanced mathematical calculations to solve algebraic equations.</p><p>&lt;li&gt;L02 – Understand standard methods to solve second order linear ODEs, including the use of complex numbers.</p><p>&lt;li&gt;L03 – Apply initial and boundary values to ODEs, and use these to find solutions to problems relevant to Civil Engineering.</p><p>&lt;li&gt;L04 – Understand some important types of PDEs and standard methods to solve them.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module covers fundamental tools to manipulate complex numbers as well as ordinary and partial differential equations relevant to engineering. The module will cover:</p><p>&lt;li&gt;Complex numbers and their application to differential equations.</p><p>&lt;li&gt;Second order linear ordinary differential equations (homogeneous and inhomogeneous).</p><p>&lt;li&gt;Methods for partial differential equations relevant to Civil Engineering problems.<br> </p></div>',
...
weight: '35.00',
requirements: 'Inclass written assignment, 1hr:assessing basic mathematical skills and straight forward application of knowledge from the lectures to short standard problems.'
}, {
...
type: 'Exam 1',
weight: '30.00',
requirements: 'General exam &ndash; advanced:1 paper of 3 hours assessing H22H12, H22SA2, H22G12, H22FOM &amp; HG2MMC. This paper will return a single mark, contributing 30% of the overall module mark in each module.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
