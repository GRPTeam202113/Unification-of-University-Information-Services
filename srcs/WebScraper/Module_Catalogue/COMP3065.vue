...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Computer Vision',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Part II undergraduate students in the School of Computer Science. Also available to students from other Schools with the agreement of the module convenor. This module is part of the AI, Modelling and Optimisation theme in the School of Computer Science. Available to JYA/Erasmus students.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Tianxiang Cui',
generalFurtherActivityDetail: '<br>Method and Frequency of Class and timing of class: one two-hour lectures per week, with<br>practical problems being tackled in a single coursework. One one-hour lab session will be held,<br>in which students work on practical programming assignments and their coursework. And one-<br>hour tutorial session will be held discussing further lecture materials and lab solutions.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide a grounding in existing techniques and current research in computer vision.<br>To give experience in implementing computer vision solutions to real world problems.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><span style="color: rgb(0, 57, 101); text-transform: none; text-indent: 0px; letter-spacing: normal; font-family: Arial, "MS Sans Serif"; font-size: medium; font-style: normal; font-weight: normal; word-spacing: 0px; float: none; display: inline !important; white-space: normal; orphans: 2; widows: 2; background-color: rgb(255, 255, 255); font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-style: initial; text-decoration-color: initial;">Understanding of current techniques in image analysis and computer vision and an awareness of their limitations. An appreciation of the underlying mathematical principles of computer vision. Experience in designing and implementing computer vision systems. Intellectual Skills: Apply knowledge of computer vision techniques to particular tasks. Evalutate and compare competing approaches to vision tasks. Evaluate vision systems. Professional Skills: Develop a working knowledge of computer vision/image analysis algorithms and evaluate the applicability of various algorithms and operations to particular tasks. Transferable Skills: Apply knowledge of the methods and approaches presented to problem domains use the available resources (libraries, internet, etc) to supplement the course material.</span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>You’ll examine current techniques for the extraction of useful information about a physical situation from individual and sets of images. You’ll cover a range of methods and applications, with particular emphasis being placed on the detection and identification of objects, recovery of three-dimensional shape and analysis of motion. You’ll learn how to implement some of these methods in the industry-standard programming environment MATLAB. You’ll spend around four hours a week in lectures, tutorial and laboratory sessions.</p></div>',
assessmentFurtherActivityDetail: '<br>Method and Frequency of Class and timing of class: one two-hour lectures per week, with<br>practical problems being tackled in a single coursework. One one-hour lab session will be held,<br>in which students work on practical programming assignments and their coursework. And one-<br>hour tutorial session will be held discussing further lecture materials and lab solutions.',
methodAndFrequency: [{
activity: 'Computing',
...
type: 'coursework 1',
weight: '40.00',
requirements: 'Practical programming project in Python including project proposal, codes and final report'
}, {
type: 'Exam 1',
weight: '60.00',
requirements: 'Two-hour written exam'
}],
staffOffice: 'Room 426, Sir Peter Mansfield Buildin',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 (0) 574 88180000',
