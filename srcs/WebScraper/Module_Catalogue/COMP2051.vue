...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Artificial Intelligence Methods',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Compulsory for Part I Computer Science and Artificial Intelligence (EA07) students. Available to Part I Computer Science (EA05) students. Not available to students taking AE2AMI (10cr).',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To build on first year AI module and further an appreciation of various AI techniques.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br> •Ability to describe some advanced AI techniques and have a good understanding of AI techniques.</p><p>Intellectual Skills: <br> •Understand and describe various AI techniques and where they might be applied.</p><p>Professional Skills: <br> •The ability to understand available AI techniques and select those appropriate to a given situation.</p><p>Transferable Skills: <br> •Problem solving, ability to compare and contrast AI techniques.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p>COMP1037 Fundamentals of Artificial Intelligence and COMP Programming Paradigms are the prerequisites of this module</p><p>This module builds on the first year Introduction to AI, which covers the ACM learning outcomes, and introduces new areas. The emphasis is on building on the AI research strengths in the School. As a Launchpad it gives brief introductions to topics including AI techniques, fuzzy logic and intelligent agents, and modern search techniques such as Genetic Algorithms, Tabu Search, Simulated Annealing, and Genetic Programming, etc.</p></div>',
...
type: 'Exam 1',
weight: '50.00',
requirements: '<p style="margin-bottom:11px"><span style="font-size:11pt"><span style="line-height:107%"><span style="font-family:Calibri,sans-serif">2 hour exam. Answering questions on the topics taught in lectures.</span></span></span>'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
