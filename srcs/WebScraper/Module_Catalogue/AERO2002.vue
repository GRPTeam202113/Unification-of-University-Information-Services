...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Aerospace Propulsion',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><span style="margin: 0px; line-height: 107%; font-family: "Times New Roman",serif; font-size: 12pt;"><font color="#000000">The aim for this module is that students can assess an appropriate propulsion unit for a defined aircraft mission using their prior knowledge of aerodynamics combined with the material taught in this module. </font></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><span style="margin: 0px; line-height: 107%; font-family: "Times New Roman",serif; font-size: 12pt;"><font color="#000000">On successful completion of this module students will be able to:<br>•  L01 – Comprehend relevant thermodynamics and be able to apply them in the analysis of propulsion units<br>•  L02 – Use their prior knowledge of aerodynamics to analyse blade systems relating to propulsion units (propeller, compressor/turbine blades)<br>•  L03 –. evaluate and appraise an appropriate system and components for propulsion scenarios<br>•  L04 –. Record the salient details from an experimental and/or computational investigation and conduct accurate and appropriate data analysis.<br>Offering School:  Department of Mechanical, Materials and Manufacturing Engineering</font></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p style="margin: 0px 0px 11px; line-height: normal;"><span style="margin: 0px; font-family: "Times New Roman",serif; font-size: 12pt;"><font color="#000000">This module will cover fundamental thermodynamics including key underlying equation sets such as the first and second law of thermodynamics, perfect gas relationships and analysis of relevant cycles for Aerospace propulsion such as the Brayton cycle.  This content will be linked to the Aerospace Aerodynamics from H41AAD to show how thermodynamics and aerodynamics are used jointly in the design of components and systems for aerospace propulsion. The principles of aircraft propulsion are further developed with a focus on jet engines including the principles of gas turbine engines, their layout and the application of compressible flow and turbomachinery principles. Factors influencing design and choice of engine configuration are introduced.</font></span></p><p style="margin: 0px 0px 11px; line-height: normal;"><span style="margin: 0px; font-family: "Times New Roman",serif; font-size: 12pt;"><font color="#000000"> </font></span></p><p><span style="margin: 0px; line-height: 107%; font-family: "Times New Roman",serif; font-size: 12pt;"><font color="#000000">Re-assessment<br>Students who fail this module overall and are required to complete a re-assessment will be re-assessed by exam. The re-assessment exam mark alone will be used to determine whether students satisfy progression requirements.</font></span></p></div>',
