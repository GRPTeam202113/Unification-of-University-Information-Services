...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Intercultural Communication (BA)',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'Optional for BA English Language and Applied Linguistics, BA English Language and Literature, BA English and International Business',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to provide:<br>•an opportunity to understand basic concepts in intercultural communication<br>•an opportunity to develop the ability in applying theories to the analysis of real-life cases in intercultural communication</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>By the end of this module, students should be better able to:<br>• understand the key concepts and theories in intercultural communication<br>• adapt these frameworks for practical investigation<br>• carry out empirical research of language in intercultural context<br>• communicate a systematic analysis of language through both oral presentation and written essay<br>• critically evaluate work within the discipline</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module explores some main themes that have been investigated in the field of Intercultural Communication. Intercultural Communication (IC) is an extremely broad field of study and has attracted intellectual interest of researchers from various disciplines. We will mainly focus on the contributions of researchers specialized in intercultural communication from disciplines of Education, Psychology and Sociolinguistics. The major themes and concepts that we are going to explore include key concepts and theories in intercultural communication, studies of cultural values and its impact on interpersonal communication and world views, barriers to successful communication such as stereotyping, prejudice and ethnocentrism, cultural adaptation, nonverbal communication, and management of multicultural workplaces etc.</p><p>Attendance in the first two weeks of class is obligatory for enrolment in this module.</p><p>Please note: This module is assessed at the end of Spring semester. First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (e.g. essay) or other form, as decided by the School.</p><p> </p></div>',
...
type: 'Coursework',
weight: '80.00',
requirements: '3,000-word individual written assessment (research project/essay)'
}, {
type: 'Presentation',
weight: '10.00',
requirements: '5-min individual Oral presentation with written PPTs'
}, {
type: 'Participation',
weight: '10.00',
requirements: 'Weekly learning journals and participation in seminars'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
