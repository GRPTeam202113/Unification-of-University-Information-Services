...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">Education Aims: </span></span></p><p style="margin-bottom:0in;margin-bottom:.0001pt;line-height:normal;"><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To consolidate on the base A-level mathematics (or the equivalent). </span></span></p><p style="margin-bottom:0in;margin-bottom:.0001pt;line-height:normal;"><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To develop skills and build confidence in using methods of calculus. </span></span></p><p style="margin-bottom:0in;margin-bottom:.0001pt;line-height:normal;"><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To motivate the need for precision when doing mathematics. </span></span></p><p><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To provide familiarity with techniques of differential and integral calculus.</span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully will be able to:</p><p>L1 - calculate limits and derivatives of functions from first principles;<br><br>L2 - determine whether a given real function of a single variable is continuous;<br><br>L3 - evaluate elementary integrals using various techniques of integration;<br><br>L4 - solve elementary differential equations;<br><br>L5 - find partial derivatives and apply the chain rule for functions of more than one variable;<br><br>L6 - find stationary points for functions of two variables and determine their type;<br><br>L7 - evaluate double integrals both directly and by change of variable;</p><p>L8 - use the mathematical software to plot 2D and 3D graphs of functions.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>In the autumn semester the module introduces the basic elements of differential and integral calculus of functions of one variable. The syllabus consolidates A-level work and, to some extent, goes beyond. Basic concepts of functions, limits, continuity, differentiation, integration are studied and applied to Taylor series and differential equations.</p><p>In the spring semester the calculus of functions of several variables is studied and topics include partial derivatives, chain rules, the vector operator grad, Lagrange multipliers and multiple integrals.</p><p>The focus is on the development of skills and confidence in applying the methods of calculus. The module does, however, illustrate the need for mathematical rigour.</p></div>',
...
weight: '7.00',
requirements: 'Spring class test'
}, {
type: 'Inclass Exam 1 (Written)',
weight: '8.00',
requirements: 'Autumn Class Test'
}, {
type: 'Coursework 1',
weight: '5.00',
