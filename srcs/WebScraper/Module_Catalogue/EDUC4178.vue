...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Understanding Education Knowledge',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To develop critical perspectives on knowledge and practice in educational settings. To consider how policy, research, professional, pedagogic and practical knowledge is created, contested and/or consumed by education policymakers, professionals and practitioners. To develop the skills and qualities of researching education professionals include becoming a reflexive practitioner.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br> •Mapped and understood the conflicting perspectives and policy debates that bear on the field of theory and practice of education<br> •engaged with and assessed a range of theoretical perspectives on education knoweldge and its contexts and applications<br> •knowledge about alternative research approaches to researching education knowledge, contexts and practices. </p><p>Intellectual Skills: <br> •A critical appreciation of the interrelationship between theory and practice of education. <br> •The ability to synthesise complex material from disparate sources including knowing how to produce written and verbal arguments about educational matters. </p><p>Professional Practice Skills: <br> •Improved ability to critically reflect upon and apply research evidence to professional practice and development. <br> •Understanding of how to engage colleagues in well-informed debates about decisions relating to their own professional field.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The first module in the Professional Doctorate explores what it means to be a researching professional by developing critical perspectives on knowledge and practice in educational settings. It considers how policy, research, professional, pedagogic and practical knowledge is created, contested and/or consumed by education policymakes, professionals and practitioners. Based on a variety of education case studies, the second half of this module allows participants to explore these forms of knowledge across three sector-based strands: Schools; Further and Higher Education; Lifelong, Community and Work-based Education.</p></div>',
...
type: 'Assignment',
weight: '100.00',
requirements: '6000 word written assignment or equivalent'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
