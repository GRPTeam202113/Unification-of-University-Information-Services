...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Numerical Methods in Economics',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To provide a detailed understanding of numerical methods used in Economics.<br>2. To develop an understanding of how the discussed methods can be applied to various economic problems<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>By the end of the module, students should have enhanced their abilities in the following dimensions as detailed in the Programme Specification:<br>Knowledge and Understanding<br> A5 Show understanding of relevant mathematical and statistical techniques.<br>Intellectual Skills<br> B3 Be able to evaluate, analyse and present quantitative data.<br>Key/Transferable Skills<br> D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> D2 Communicate effectively and clearly in written and oral formats.<br> D3 Use appropriate IT packages effectively.<br> D5 Undertake independent study of a problem or subject.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>• Basic numerical method: Grid Search<br>• Iterative numerical methods: Bisection and Newton-Raphson<br>• Nested numerical methods<br>• Extensions to Newton methods in multi-dimensional problems<br>• Dynamic programming: Bellman equation and value function iteration method<br>• Applications of Dynamic programming<br><br>ECON1049 Mathematical Economics and Econometrics is the requisite of this module.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
