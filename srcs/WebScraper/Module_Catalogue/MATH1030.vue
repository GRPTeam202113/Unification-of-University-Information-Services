...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="margin-bottom:0in;margin-bottom:.0001pt;line-height:normal;"><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To give a concrete introduction to linear mathematics and associated techniques. </span></span></p><p style="margin-bottom:0in;margin-bottom:.0001pt;line-height:normal;"><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To develop skills, competency and confidence in using the range of techniques. </span></span></p><p><span style="font-family:symbol;"><span style="font-size:12.0pt;">·</span></span><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">  To consolidate pre-university knowledge of the techniques of linear mathematics.</span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully will be able to:</p><p>L1 - carry out calculations using complex numbers;<br><br>L2 - use vector methods in geometry to find equations of lines and planes;<br><br>L3 - manipulate matrices and compute determinants;<br><br>L4 - solve systems of linear equations;<br><br>L5 - calculate eigenvalues and eigenvectors of matrices;<br><br>L6 - apply Gram-Schmidt orthogonalisation;<br><br>L7 - apply elementary results concerning vector spaces, linear transformations and inner product spaces;</p><p>L8 - use the mathematical software to define vectors and matrices and use them to solve problems in linear algebra.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module introduces students to many concepts and techniques of mathematics that will be used in subsequent modules. Firstly the basic concepts of complex numbers, vector algebra and matrix algebra are established. Then these ideas are extended to vector spaces, linear transformations and inner product spaces. Throughout the emphasis is on developing techniques that are widely applicable.</p></div>',
...
staffTelephone: '+86(0)574 8818 0000 (#8052)',
