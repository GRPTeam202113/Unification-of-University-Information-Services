...
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding<br>This module develops a knowledge and understanding of: <br>    • Relevant quantitative techniques, including mathematical and statistical methods. <br>    • Economic data and its appreciation.</p><p>Intellectual skills<br>This module develops: <br>    • Effective quantitative problem solving and decision making skills.</p><p>Professional practical skills<br>This module develops: <br>    • Numeracy and quantitative skills including data analysis, interpretation and extrapolation.</p><p>Transferable (key) skills<br>This module develops:<br>    • Effective self-management in terms of time, planning and behaviour, motivation, self-starting, individual initiative and enterprise.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><strong>PRE-REQUISITE</strong>   </p><p>Please note that for this module, the following pre-requisites apply:</p><ul> <li>Grade C at A level mathematics (or equivalent) is a pre-requisite.</li></ul><p><em>(Please ignore</em>    Requisites: N/A     <em>below)</em></p><p> </p><p>This module contains:</p><p>Economic application of calculus<br>Confidence intervals<br>Introduction to hypothesis testing<br>Partial differentiation<br>Optimisation of two variables<br>Probability<br>Random Variables<br>Sampling Distributions.</p></div>',
