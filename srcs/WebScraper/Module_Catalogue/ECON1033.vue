...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Introduction to Microeconomics',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To provide a firm foundation in the fundamentals of microeconomics theory and their application to real world situations;<br>2. To develop analytical skills using the main mathematical approaches and diagrams;<br>3. To develop the ability to communicate and report findings, particularly via tutorial essays, presentations and exercises.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A1 Demonstrate a broad knowledge of core areas of economics (Introducing).<br>A4 Demonstrate understanding of verbal, graphical, mathematical and econometric representation of economic ideas and analysis, including the relationship between them.<br>Intellectual Skills:<br>B1 Work with abstract concepts and in a context of generality.<br>Professional Practical Skills:<br>C1 Discuss and analyse government policy.<br>C4 Understand the context in which a problem is to be addressed.<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module will cover fundamental topics in microeconomics such as consumer theory, producer theory, perfectly competitive market, monopoly and market failures.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
