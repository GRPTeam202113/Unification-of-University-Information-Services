...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Professional Interpreting',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The module will enable students to develop the competence and confidence to interpret between Chinese and English in the consecutive mode. They shall be able to interpret ideas expressed in one language into another as smoothly and idiomatically as possible. The practice will also sensitize them to issues related to the fundamental concepts and models in consecutive interpretation.</p></div>',
...
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module equips students with the advanced knowledge and skills required to interpret between English and Chinese in consecutive mode at conference settings. It focuses on delivering the speaker’s intended message to the audience, with emphasis on the overall performance of the interpreter and the impact of interpreting upon the audience, in addition to accuracy and completeness. Techniques are developed for communication with the audience. Teamwork skills and ethics will be introduced.</p></div>',
...
weight: '10.00',
requirements: 'Starting in Week 2 onwards, public speaking and presentation.'
}, {
type: 'Continuous assessment 2',
weight: '40.00',
requirements: 'In Week 6, consecutive interpreting, around 3-5 minutes each in both directions.'
}, {
type: 'Continuous assessment 3',
weight: '50.00',
requirements: 'In Week 11, consecutive interpreting, around 5 minutes each in both directions.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
