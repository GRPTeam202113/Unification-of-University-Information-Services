...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Econometrics I',
...
staffName: 'Dr Qian Wang',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To provide the necessary matrix and statistical tools to conduct theoretical econometric analysis at an advanced level;<br>2. To develop the analytical skills required to demonstrate the theoretical properties of different econometric estimation and testing procedures under various modelling assumptions;<br>3. To provide a sound understanding of the applicability and limitations of the multivariate linear regression model as a vehicle for econometric analysis for economic data.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A5 Show understanding of relevant mathematical and statistical techniques.<br>Intellectual Skills:<br>B3 Be able to evaluate, analyse and present quantitative data<br>Professional Practical Skills:<br>C2 Understand the sources and content of economic data and evidence, as well as appropriate methods of analysis (developing)<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br>D3 Use appropriate IT packages effectively.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module builds upon the econometric techniques covered in Introductory Econometrics. Students will be introduced to matrix algebra, statistical techniques and the multivariate linear regression model, which will provide the main framework for analysis.</p><p>ECON1049 Mathematical Economics and Econometrics is the requisite of this module.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
