...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Corporate Entrepreneurship',
...
staffName: 'Xiaodan Yu',
generalFurtherActivityDetail: '<br>11 one hour lectures and two one hour seminars.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module develops an understanding of corporate entrepreneurship (CE) and an appreciation of how larger firms can be designed to be more entrepreneurial, flexible and innovative. The module aims are as follows:</p><ul> <li>To introduce students to the importance of CE</li> <li>To provide an understanding of the various dimensions of CE and the various forms of CE</li> <li>To compare CE with independent entrepreneurship</li> <li>To analyze the conditions that foster CE</li> <li>To recognize the barriers that limit managers and their companies" to be entrepreneurial.</li> <li>To develop an understanding of the various organizational processes involved in CE (e.g. Resource acquisition and development; innovation management; and cultural change).</li> <li>To review the conceptual and empirical work relating to the relationship between CE and various organizational outcomes.</li></ul></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><br>A. Knowledge and understanding:<br></p><li> International issues in business and management <br></li><li> The management and development of people within organizations. <br></li><li>The management of resources and operations. <br></li><li> The development, management and exploitation of information systems and their impact upon organizations. <br></li><li> The development of appropriate business policies and strategies to meet stakeholder needs within a changing environment.<br>B.Intellectual skills:<br></li><li> The cognitive skills of critical thinking, analysis and synthesis, including the ability to identify assumptions, evaluate statements in terms of evidence, to detect false logic or reasoning, to identify implicit values, and to define terms adequately and to generalise appropriately. <br></li><li> The ability to create, evaluate and access a range of options, together with the capacity to apply ideas and knowledge to a range of business and other situations.<br>C.Professional practical skills:<br></li><li> Qualitative skills including the ability to work with case studies. <br></li><li> The ability to apply business models to business problems and phenomena. <br></li><li> Effective performance within a team environment, including leadership, team building, influencing and project management skills. <br></li><li> The ability to conduct research into business and management issues, either individually or as part of a team, including a familiarity with a range of business data and research resources and appropriate methodologies.<br>D.Transferable (key) skills:<br></li><li> Effective oral and written communication skills in a range of traditional and electronic media. <br></li><li> Effective self-management in terms of time, planning and behaviour, motivation, self-starting, individual initiative and enterprise. <br></li><li> Learning to learn and developing an appetite for reflective, adaptive and collaborative learning.<br></li><li> The interpersonal skills for effective listening, negotiating, persuasion and presentation.<br><p></p></li></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The current business climate demands that companies, large or small, develop the capability to anticipate and respond to changes in their external environment. These changes may represent opportunities or threats for companies. Entrepreneurship has been viewed as a means through which economic actors identify and pursue such opportunities. It is often assumed that large, established organizations are constrained by bureaucracy and are not as flexible and entrepreneurial new small firms. There are, however, several examples of large companies (such as Sony, 3M and IBM), which have been able to create and sustain a competitive advantage by being consistently innovative and entrepreneurial. This module explores entrepreneurship in larger companies. Corporate entrepreneurship is a term used to describe entrepreneurial behaviour inside established mid-sized and large organizations.</p><p>Re-assessment format is decided by the school.</p></div>',
assessmentFurtherActivityDetail: '<br>11 one hour lectures and two one hour seminars.',
methodAndFrequency: [{
activity: 'Lecture',
