...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Undergraduate English in Specific Academic Contexts a (Arts & Social Science Pathways)',
...
staffName: 'Ms Shayna Kozuch',
generalFurtherActivityDetail: '<br>Supplemented by a further 140 hours of self-directed study.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><span lang="EN-GB" style="color: rgb(0, 57, 101); font-family: "Calibri",sans-serif; font-size: 12pt; mso-fareast-font-family: "Times New Roman"; mso-bidi-font-family: "Times New Roman"; mso-ansi-language: EN-GB; mso-fareast-language: ZH-CN; mso-bidi-language: AR-SA;">To equip students with the necessary language, strategies and skills that will enable them to read, write, speak and listen across a range of subject-specific contexts within the academic field of Arts, Humanities &amp; Social Science.</span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><br>a) Knowledge and Understanding<br></p><li>the ability to apply appropriate academic reading skills and sub-skills and take a critical approach to academic reading within Arts and Social Science disciplines e.g. the ability to evaluate the validity of arguments and identify a writer¡¦s stance.<br></li><li>an understanding of what is typically expected in discipline-specific written examinations and coursework assignments at the undergraduate level and the study approaches needed to meet these requirements.<br></li><li>an understanding of the process of writing coursework assignments and the ability to manage this effectively.<br></li><li>an awareness of the vocabulary appropriate to academic writing in specific Arts &amp; Social Science disciplines and the ability to use this effectively.<br></li><li>the ability to take part in lectures and seminars on topics relating to specific Arts &amp; Social Science disciplines.<br></li><li>the ability to read and write discipline-specific material effectively under timed conditions.<br>b) Intellectual Skills<br></li><li>critical thinking, analysis and synthesis.<br>c) Transferable/Key Skills<br></li><li>the ability to apply appropriate reading strategies in order to comprehend written academic discourse specific to particular Arts &amp; Social Science disciplines.<br></li><li>the ability to present and communicate ideas and arguments effectively in specific Arts &amp; Social Science oral and written contexts.<br><p></p></li></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module develops language and skills for reading, writing, listening and speaking, with specific reference to undergraduate Arts &amp; Social Science academic contexts. It covers the following areas. <br><br>applying core reading skills to discipline-specific texts<br><br>identifying the purpose and organization of discipline-specific texts<br><br>locating and understanding key information in discipline-specific texts<br><br>interpreting and incorporating data and graphic information<br><br>recognizing stance, hedging and how ideas in discipline-specific texts are linked<br><br>understanding the particular requirements of different writing tasks within Arts &amp; Social Science contexts <br><br>note-taking from written sources, summarizing and paraphrasing<br><br>synthesizing sources and developing academic arguments<br><br>writing discipline-specific evaluative/argumentative type essays under exam conditions<br><br>appropriate application of academic referencing conventions<br><br>further development of seminar discussion skills within discipline-specific contexts e.g. persuading others of a point of view; evaluating others contributions and achieving consensus<br><br>systematic development of core vocabulary relating to specific disciplines<br><br>consolidation of listening based note-taking skills within discipline-specific contexts<br><br>development of higher level listening skills e.g. ability to deduce meanings from context; ability to recognize the function of intonation; ability to recognize digressions and other irrelevant matter <br><br></p></div>',
...
type: 'Exam 1',
weight: '40.00',
requirements: '1.5 hour Written exam based on common genres from the discipline'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
