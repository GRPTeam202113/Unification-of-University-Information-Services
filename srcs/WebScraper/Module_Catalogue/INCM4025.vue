...
credit: '20.00',
level: '4',
targetStudents: 'Ma students in International Communications and related programmes at the University of Nottingham Ningbo campus. There is a limited number of places on this module. Students are reminded that enrolments which are not agreed by the Offering School in advance may be cancelled without notice.',
...
generalFurtherActivityDetail: '<br>Hours of indpendent study: 270 hours.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This course aims to enable students to recognise and reflect critically on the communication potential of digital games.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>1)Knowledge and Understanding: This module will provide students with:a)an understanding of the communication potentials of (digital) gamesb)a knowledge of the theoretical debates around the core concepts of game and play2) Intellectual Skills: This module will encourage:a)Application of particular models and theories to concrete real world examples and case studiesb)The ability to reflect critically upon one¡¯s own consumption of media3)Transferable (Key) Skills: This module will enhance transferable skills such as:a)Retrieving, presenting and communicating complex information and argument clearly in oral and written formsb)Planning and organization skills, including working to deadline and managing resources</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module explores digital games - from casual smartphone games to virtual worlds - as communication in two senses. Firstly as communication from a designer or publisher to a user (topics include representation, effect, education, and news). Secondly as communication amongst users facilitated by a game (topics include virtual worlds and fan culture). The module introduces the foundational debates of contemporary Game Studies (including concepts such as simulation, rule, game, and play; and perspectives such as narratology, ludology, and cybertext).</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
assessmentFurtherActivityDetail: '<br>Hours of indpendent study: 270 hours.',
methodAndFrequency: [{
activity: 'Lecture',
