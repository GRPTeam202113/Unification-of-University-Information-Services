...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Introduction to Renewable Energy',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Undergraduates registered for courses in the Department of Architecture and Built Environment There is a limited number of places on this module. Students are reminded that enrolments which are not agreed by the Offering School in advance may be cancelled without notice.',
