...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Professional Translation',
...
assessmentTable: [{
type: 'Translation Assignments',
weight: '60.00',
requirements: 'Altogether 6 assignments including 2 group projects in both directions will be translated during the semester.&nbsp;About 700 words for each assignment; 700 words for each member in group projects.'
}, {
type: 'Examination',
weight: '40.00',
requirements: 'Around 300 words each, in both directions.&nbsp;'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
