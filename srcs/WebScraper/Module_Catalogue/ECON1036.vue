...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Economic Integration II',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Year 2 Economic students and year 2 IBE &amp; FAM students from NUBS and students from other schools in FHSS',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>• To provide a review of the trend and related economic issues of regional economic integration in the world, with a special focus on Asia<br>• To build on the basic theoretical framework taught in Semester I module on Economic Integration I and provide students a basis for simple analysis of economic effects of various regional trading arrangements<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><ul> <li>demonstrate understanding of the different stages/forms of economic integration from free trade area to complete economic integration</li> <li>demonstrate knowledge of recent trend in economic integration in the Asia region and various related economic issues</li> <li>be able to analyse in theory the effects of regional economic integration</li> <li>be able to apply some simple methods for evaluation of the economic impacts of various regional trading arrangement scenarios</li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module looks at: economic integration in Asia, theory (basic and extension) and methods for assessing economic integration arrangements, Comparing economic integration in ASEAN and in EU, China’s Belt and Road Initiatives, Brexit</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Exam 1',
weight: '100.00',
requirements: '90 minutes written exam at the end of semester (100% )'
}],
