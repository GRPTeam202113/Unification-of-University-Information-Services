...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Global Environmental Processes',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To give students:</p><p>1. a general understanding of the physical, chemical and biological development of the Earth since the start of the Universe</p><p>2. an understanding of the cyclical movement of the major materials such as carbon and nitrogen between biological and non-biological forms.</p><p>3. an understanding of how physical, ecological and environmental conditions affect global environments, habitats and people</p><p>4. an outline of the importance of change in affecting physical and biological conditions on earth</p><p>5. a platform for interpreting large scale geographical and environmental issues. On completion of the module the students will have developed an ability to think analytically about physical, ecological and environmental processes and understand, synthesise and critically evaluate current debates in environmental change within a broader conceptual and scientific framework.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding of:1. A2: current trends and developments within the life and environmental sciences 2. A3: appropriate terminology, nomenclature and classification 3. A4: the Earth as a system 4. A6: temporal and spatial scalesIntellectual Skills - the ability to: 1. B3: understand complex ideas and relate them to specific problems or questions Practical/Professional Skills - the ability to: 2. C2: articulate knowledge and understanding of scientific concepts Transferable Skills - the ability to: 3. D5: use and access information and communication technology</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module has an overall theme to study the global environmental processes of the Earth. There will be covered the context as below. The introduction covers the history of the universe, from the big bang to the evolution of the Earth surface environment, via formation of galaxies, stars, elements and the solar system. We describe the major global systems and their circulations as they are today - solids (plate tectonics, formation and erosion of crustal rocks), liquids (oceans, temperature and salinity gradients) and gases (atmosphere, weather and climate). We also examine the global processes of the environmental systems as we will cover the range of processes on a global scale with the knowledge of atmospheric (i.e. global and regional climate and weather issues), coasts and oceans, glaciers, glaciation and quaternary environmental change processes, soil and drylands, rivers and geomorphological processes and bio-geochemical processes to inform an understanding of global systems of wide range environmental issues. This module has 6 major themes and contained 20 lectures (L1-L11: 1st semester; L12-L20: 2nd semester ref GEOG1025timetable): <br>    1st theme: Fundamental of Environmental Sciences and Physical Geography <br>    2nd theme: The earth formation and continents <br>    3rd theme: Climate and weather <br>    4th theme: Hydrology and Geomorphology<br>    5th theme: Environmental Change <br>    6th theme: Bio-geochemical processes <br> </p></div>',
...
type: 'Exam 1',
weight: '50.00',
requirements: '2 essays (2 hours exam) / Autumn'
}, {
type: 'Exam 2',
weight: '50.00',
requirements: '30 MCQs and 2 essays (2 hours exam)/ Spring'
}],
staffOffice: 'Room 341D, Sir Peter Mansfield Building',
staffAddress: '199 Taikang East Road, Ningbo, 315100, China',
staffCampus: 'University of Nottingham Ningbo China',
staffTelephone: '+86 (0) 574 88180000-9471',
