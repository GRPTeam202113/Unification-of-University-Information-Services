...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Fluid Mechanics and the Built Environment 1',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Architecture and Environmental Design Year 2 Students',
...
type: 'Report',
weight: '15.00',
requirements: '1500 word lab report'
}, {
type: 'Exam 1',
weight: '70.00',
