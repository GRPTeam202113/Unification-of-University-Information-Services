...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Complex Functions',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of this module is to introduce the theory of functions of a complex variable, a topic which is very important for applications.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">A student who completes this module successfully will be able to:</span></span></p><p><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">L1 - apply the Cauchy-Riemann equations to identify analytic functions;<br>L2 - compute contour integrals;<br>L3 - calculate Taylor and Laurent series of analytic functions;<br>L4 - identify singularities of analytic functions and calculate residues;<br>L5 - evaluate real definite integrals using residues.</span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module provides an introduction to the theory and applications of functions of a complex variable, using an approach oriented towards methods and applications. The elegant theory of complex functions is developed and then used to evaluate certain real integrals. Topics to be covered will include: analytic functions and singularities; series expansions; contour integrals and the calculation of residues; applications of contour integration.</p></div>',
