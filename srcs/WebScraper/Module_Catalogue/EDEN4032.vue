...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Advanced English Discourse Skills (for non-English speakers only)',
year: 'Academic Year 2022',
credit: '20.00',
level: '4',
targetStudents: 'Students taking the MA in Interpreting and Translation at the University of Nottingham Ningbo, China Available to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The primary aim of the module is to increase knowledge of the vocabulary, grammar and functions of English or Chinese, and develop speaking, listening, reading and writing skills appropriate to a range of academic and professional situations and texts, to a level equivalent to IELTS 7.5. It encompasses: extending students’ command of English or Chinese in specific areas (politics, business, economics, society, science, technology, et cetera). The module will present students with a range of appropriate registers and genres of discourse with the aim of developing key skills for translating and interpreting (critical reading/listening, summarizing and paraphrasing, oral presentation, etc.).</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding <br>A1 Knowledge and understanding of linguistic, textual and cultural issues relating to translation, and techniques for resolving difficulties <br>A2 Knowledge and understanding of linguistic, interpersonal, ethical, business and cultural issues relating to interpreting, and techniques for resolving difficulties <br>A3 Enriched knowledge and understanding of the lexis, structures and functions of English Intellectual skills <br>B1 Critical analysis of source materials and strategies for resolving translation problems <br>B2 Critical analysis of interpreting assignments and strategies for resolving problems Professional, practical skills <br>C3 Presentation, public speaking skills <br>C6 Clear written and oral communication in both languages Transferable (key) skills <br>D1 Oral and written communication and presentation skills <br>D2 Independent learning skills</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module aims to develop specific aspects of student written and spoken English to the level required for professional translators and interpreters. Discourse in relation to media, business, science and technology will be analysed and discussed through lectures and seminars with a view to enhance the student awareness of the generic features of specific texts through understanding authentic speeches, giving oral presentations as well as writing with relevant discourse skills on related topics.</p><p>The module includes formative assessment and feedback of writing, which does not contribute to the final mark.</p><p><br>Please note: This module is assessed by the end of Autumn and Spring semester. First sit/ Re-sit assessments are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
assessmentTable: [{
type: 'Semester 1 Timed Reading and Writing Coursework',
weight: '10.00',
requirements: 'Summarizing content of written text'
}, {
type: 'Reading & Writing Exam',
weight: '20.00',
requirements: 'Summarizing Content&amp;nbsp; of written text'
}, {
type: 'Listening Exam',
weight: '20.00',
requirements: '<br />Listening for specifics / Listening for general comprehension. Approx. 15 questions'
}, {
type: 'Semester 2 Exam -Reading & Writing  Element',
weight: '50.00',
requirements: '500-word essay responding to an exam question<br />-Using information from written input texts and exam&rsquo;s listening element'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
