...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Discrete Mathematics and Graph Theory',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Single Honours students from the School of Mathematical Sciences who have successfully completed Part I. Requisites: MATH1028Analytical and Computational Foundations.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This course provides a self-contained account of the basic ideas of Discrete Mathematics (e.g. combinatronics, generating functions, graph theory) which will enable those attending to acquire the necessary knowledge and skills to solve problems in the topic and to establish the grounding for further study in this area.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this course successfully will be able to:</p><p>L1 - solve counting problems involving permutations and combinations;</p><p>L2 - use generating functions to address enumerating questions;</p><p>L3 - solve recurrence equations with a view to applications to counting problems;</p><p>L4 - prove statements about graphs, including paths, trees, graph colouring, planarity and minimum spanning trees;</p><p>L5 - apply results of graph theory to problems in other subjetcs.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The aim of Discrete Mathematics is the study of discrete and finite rather than continuous quantities. This includes counting problems, graphs and other quantities parametrised by integers. As such Discrete Mathematics is of great importance for various branches of Pure Mathematics, Mathematical Physics, Statistics and Computer Sciences. The course will cover a range of Discrete Mathematics topics, including an introduction to advanced aspects of combinations and permutations, ordinary and exponential generating functions, recurrence relations and applications to counting problems, graphs, digraphs, Eulerian and Hamiltonian trails, planar graphs, graph colouring, trees and minimum spanning tree algorithms.</p></div>',
