...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Sustainable Chemistry',
...
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>1. A knowledge of what constitutes sustainable chemistry, understanding of the significance of new technologies such as synthetic biology, and recognition of the problems in achieving sustainability.<br>2. Intellectual Skills: Applications of this knowledge to a range of chemical, materials and technological problems.<br>3. Transferable/Key Skills: Problem-solving, written communication and numerical skills.<br>Elements of the following knowledge, skills and behaviours;<br>•    The ways in which advanced science and technology is developed, established techniques of scientific enquiry and research methodologies.<br>•    The internal and external regulatory environment pertinent to the science sector and area of specialisation, for example Medicines &amp; Healthcare Products  Regulatory Authority (MHRA) , Control of Major Accident Hazards (COMAH),  Good Laboratory Practice (GLP).<br>•    The business environment in which the company operates including personal role within the organisation, ethical practice and codes of conduct.<br>•    Comply with regulations including compliance with business rules pertaining to record keeping, data integrity, traceability &amp; confidentiality.<br>•    Lead continuous performance improvement within the scientific and technical environment using process mapping &amp; analysis and root cause analysis that is informed by other appropriate principles, such as lean, six sigma, project and change management.<br>•    Works autonomously and interact effectively including challenging assumptions within a wide, multi-disciplinary project team<br>•    Takes account of the impact of work on others, especially where related to diversity and equality</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is an introduction to the main concepts that underpin the field of Green Chemistry.  The module seeks to develop an understanding of the fundamental concepts that frame Green and Sustainable Chemistry and chemical applications. This module runs alongside more specialised modules taken by the students on this course within the School of Chemistry. This is a "Commentary" module that aims to add context to information received in other modules. Extensive use will be made of case studies and structured examples.</p></div>',
...
type: 'Exam 1',
weight: '100.00',
requirements: '2 hour written exam. If a further re-assessment is allowed under Undergraduate Course Regulation 19, the form of the re-assessment for this module will be 100% coursework.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
