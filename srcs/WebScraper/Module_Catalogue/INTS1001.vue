...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Introduction to International Relations',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Offer to students from school of International Studies Available to JYA/Erasmus students.',
