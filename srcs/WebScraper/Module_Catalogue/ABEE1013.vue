...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Performance of Construction Materials',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Compulsory for BEng Hons Architectural Environment Engineering, and elective for EF06 BArch.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module seeks to provide a basic understanding of building materials and structure within the context of environmental design.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>1). Awareness of key construction materials<br>2). Understanding of the behaviour of simple structures<br>3). Ability to use rule of thumb and calculation to design simple structures</p><p>Students will meet Engineering Council learning outcomes;</p><p>SM3    Ability to apply and integrate knowledge and understanding of other engineering disciplines to support study of their own engineering discipline.<br>EA1    Understanding of engineering principles and the ability to apply them to analyse key engineering processes<br>EA2    Ability to identify, classify and describe the performance of systems and components through the use of analytical methods and modelling techniques<br>D1    Understand and evaluate business, customer and user needs, including considerations such as the wider engineering context, public perception and aesthetics<br>P2    Knowledge of characteristics of particular materials, equipment, processes, or products<br>P6    Understanding of appropriate codes of practice and industry standards<br>G1    Apply their skills in problem solving, communication, working with others, information retrieval, and the effective use of general IT facilities</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span style="color:#515151;"><span style="font-family:arial,sans-serif;"><span style="font-size:9.0pt;">This module explores the properties of key construction materials and provides an overview of how they are used to generate the structure to support a building and its imposed loads. The relationships between material selection and both passive and active </span></span></span><span style="font-family:arial,sans-serif;"><span style="font-size:9.0pt;">environmental <span style="color:#515151;">design are covered as are issues surrounding the coordination of active environmental systems and structure.</span></span></span></p></div>',
...
type: 'Coursework 1',
weight: '100.00',
requirements: 'Design exercise - calculations and 1000 word narrative.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
