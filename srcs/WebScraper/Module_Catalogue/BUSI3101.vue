...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Corporate Restructuring and Governance',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Available to Business School students.Compulsory for IBE students.',
...
generalFurtherActivityDetail: '<br>10 weekly one-hour lectures plus 2 one-hour tutorials.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The aim of the module is to introduce participants to analysis of different forms of corporate restructuring, with a focus on the internal and external factors influencing restructuring as well as the effects of restructuring on a variety of firm level outcomes.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><strong>Knowledge and understanding</strong><br>This module develops a knowledge and understanding of:</p><p> •The development and operation of markets for resources, goods and services<br> •The development of appropriate business policies and strategies to meet stakeholder needs within a changing environment<br> •The application of economics and strategy<br> •To develop an informed opinion about topical debates on executive pay (eg long-term incentive plans and stock options); take-over defences (eg shark repellents; white knights) and leveraged and management buy-outs</p><p> </p><p><strong>Intellectual skills</strong><br>This module develops:</p><p> •The cognitive skills of critical thinking, analysis and synthesis, including the ability to identify assumptions, evaluate statements in terms of evidence, to detect false logic or reasoning, to identify implicit values, and to define terms adequately and to generalise appropriately</p><p> </p><p><strong>Professional practical skills</strong><br>This module develops:</p><p> •The ability to conduct research into business and management issues, either individually or as part of a team, including a familiarity with a range of business data and research resources and appropriate methodologies</p><p> </p><p><strong>Transferable (key) skills</strong><br>This module develops:</p><p> •Effective self-management in terms of time, planning and behaviour, motivation, self-starting, individual initiative and enterprise<br> •Learning to learn and developing an appetite for reflective, adaptive and collaborative learning</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module examines the antecedents and consequences of corporate restructuring. Factors triggering corporate restructuring are considered in a number of alternative organisational settings. In particular, the role of corporate governance in inducing and shaping corporate restructuring receives special attention (in particular, executive compensation and the market for corporate control). The process of restructuring is discussed against a background of resource-based, agency and behavioural theories of the firm. The impact of corporate restructuring on the size, complexity, incentive systems and ownership structure of large firms is examined. Finally, the evidence relating to the effects of corporate restructuring on performance, employment, R&amp;D and corporate governance is examined.</p><p>Re-assessment format is decided by the school.</p></div>',
assessmentFurtherActivityDetail: '<br>10 weekly one-hour lectures plus 2 one-hour tutorials.',
methodAndFrequency: [{
activity: 'Lecture',
