...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Practice and Management',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to achieve the following General Attributes of the RIBA Criteria. </p><p>On completion of this module students will have:</p><p><br>1. knowledge of the context of the architect and the construction industry, and the professional qualities needed for decision making in complex and unpredictable circumstances; (GA.5)</p><p><br>2. the ability to identify individual learning needs and understand the personal responsibility required for further professional education. (GA.6) also fulfilled in part of the Royal Institute of British Architects (RIBA) Validation Criteria at Parts 1, 2 and 3, specifically the General Criteria (GC) at Part 1, for students participating the course.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Students on completing this module will have: </p><p>1. knowledge and understanding of how the current planning system and development control legislation works at strategic and practical levels, including social, environmental and economic aspects, and the relevance of these to design development. (GC4.3) </p><p>2. an understanding of the idea of professionalism and its importance and relevance in today’s society including the architect’s duty and responsibility to clients, building users, constructors, co-professionals and the wider society. (GC6.1) </p><p>3. an understanding of the role of the architect as part of the building team, recognising changing methods and improvements in the construction industry. (GC6.2)</p><p>4. knowledge and an understanding of the component costs of different building costs, constructional systems, and specification choices, and the impact of these on architectural design. (GC10.1) </p><p>5. an understanding of the standard procedures for managing costs on a traditionally procured building. (GC10.2) </p><p>6. knowledge of the Planning, Building Control and CDM legislative frameworks both in principle and practice. (GC11.1) (GC4.3) </p><p>7. knowledge of the different roles of clients, consultants and contractors under different building procurement methods. (GC11.2) </p><p>8. knowledge of how architects organise and manage their business practices including good management techniques. This will include placing this knowledge in the context of changes that have affected the management of building contracts in recent years. (GC11.3) </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module introduces the student to the management and practice systems that are used by the consultant team to work together in production of a building design and subsequently its construction on site. The assessment method will be by way of an assignment and by an end of semester interview with a professional panel consisting of practising architects, who are already teaching within the school on a full or part-time basis. The interview will last approximately 20 minutes and seek to test the student understanding of issues taught in the module as well as assessing a professional aptitude and approach. A topic relating to the course will be given to each student and the assignment will also be discussed at the interview. The assignments will be read and marked by the examiners carrying out the interviews.</p></div>',
...
type: 'Coursework 1',
weight: '40.00',
requirements: 'Individual report'
}, {
type: 'Coursework 2',
weight: '40.00',
...
type: 'Coursework 3',
weight: '20.00',
requirements: 'Group meeting (oral)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
