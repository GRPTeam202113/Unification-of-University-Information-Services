...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Mathematics for Computer Scientists',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science only. This module is part of the Foundations of Computer Science theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Anthony Graham Bellotti',
generalFurtherActivityDetail: '<br>Activities may take place every teaching week of the Semester or only in specified weeks. It is usually specified above if an activity only takes place in some weeks of a Semester<br><br>Further Activity Details:<br>Tutorials will be hands-on working through mathematics problems from the course. <br>Coursework will be set in two parts: each taking about one week from setting date to submission deadline.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p style="margin-bottom:11px"><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">To provide students with the basic mathematical skills needed within a Computer Science degree course. </span></span></span></span></span></span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="margin-bottom:11px"><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">Knowledge and Understanding: Understanding of basic mathematical concepts, definitions and notation. Intellectual Skills: The ability to understand and apply simple logical reasoning. Transferable Skills: The ability to use mathematics to solve problems in computer science. </span></span></span></span></span></span></p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p><span style="color:#000000;"><span style="font-size:12px;"><span style="line-height:normal"><span style="font-family:Calibri,sans-serif"><span lang="EN-US"><span style="font-family:"Arial",sans-serif">You will cover the basic concepts in mathematics which are of relevance to the development of computer software. Topics which will be covered include: propositional and predicate logic; proof techniques; sets, functions and relations; counting and probability; linear algebra; and calculus for optimization problems. You will spend around five hours per week in lectures and tutorials for this module.</span></span></span></span></span></span></p></div>',
...
type: 'Coursework',
weight: '25.00',
requirements: 'Mathematics-based questions'
}, {
type: 'Exam',
weight: '75.00',
