...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Third Year Project',
year: 'Academic Year 2022',
credit: '30.00',
level: '3',
targetStudents: 'Final year BEng students on courses offered by the Department of Electrical and ElectronicEngineeringAvailable to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The module aims to give experience of completing a major investigation, including planning the work to<br>meet a final deadline and reporting on the work both in a structured written report and by an oral<br>presentation.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>By the end of the module students should be able to:<br>plan and structure future project activities for substantial time ahead;<br>undertake frequent regular efforts towards a distant aim in combination with their regular studies;<br>achieve particular long term objectives set at the start of the project;<br>communicate their findings and developments through discussion with the project moderator,<br>written thesis and oral presentation.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Engineers working in industry usually find that they become involved in extended practical or theoretical<br>projects. This module provides an opportunity for students to work in a similar situation. Students indicate<br>their project preferences, then work under the supervision of an expert member of staff, write a dissertation<br>on their work and present it publicly. Reassessment of this module, if required, will be by resubmission of the<br>final thesis.</p><p>Students will have weekly individual tutorials with their project supervisor, but otherwise they will be expected to work alone. Four halfday<br>workshops will support professional skill related to project work, including project planning and report writing. Each student will<br>prepare and deliver an individual presentation to staff and peers at the end of the project. Students will also be expected to attend two<br>days of presentations, forming an audience for their peers.</p></div>',
...
type: 'Thesis',
weight: '80.00',
requirements: 'Written thesis submission deadline:May 12 2015, 15:00'
}, {
type: 'Coursework 1',
weight: '10.00',
requirements: 'Interim report and presentation'
}, {
type: 'Presentation 1',
weight: '10.00',
requirements: 'Oral presentation'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
