...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Programming Paradigms',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Qualifying year undergraduate students in the School of Computer Science. This module is part of the Programming theme in the School of Computer Science.',
offeringSchool: 'School of Computer Science',
taughtSemesters: 'Spring China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Chris RoadKnight',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To teach the basic principles of program design and implementation using the object-oriented and functional approaches to programming. </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A sound understanding of the basic principles of object-oriented and functional programming.</p><p>Intellectual Skills:<br>The ability to compare and contrast different programming paradigms.</p><p>Professional Skills:<br>The ability to design and implement programs in Java and Haskell.</p><p>Transferable Skills:<br>The ability to solve problems using object-oriented and functional techniques.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p> </p><p>COMP1034 Mathematics for Computer Scientists and COMP1038 Programming Algorithms are the prerequisites of this module.</p><p>In this module you will learn the basic principles of the object-oriented and functional approaches to programming, using the languages Java and Haskell. You will also see how they can be used in practice to write different kinds of programs. You will spend around 5 hours per week in lectures and labs for this module. </p></div>',
...
type: 'Coursework 1',
weight: '10.00',
requirements: 'Programming exercises'
}, {
type: 'Coursework 2',
weight: '15.00',
requirements: 'Programming exercises'
...
type: 'Exam 1',
weight: '75.00',
requirements: '2.5 hrs written examination'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
