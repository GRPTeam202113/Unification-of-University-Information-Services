...
export default {
  name: 'module',
  data() {
    return {moduleName: 'Current Issues in International Communications',
...
type: 'Project 1',
weight: '30.00',
requirements: '5 minutes per person'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
