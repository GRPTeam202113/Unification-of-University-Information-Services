...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Environmental Science & Society',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Students registered on the Environmental Science programme at The University of Nottingham Ningbo, China. Available to JYA/Erasmus students.',
offeringSchool: 'School of Geographical Sciences',
taughtSemesters: 'Full year China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Odette Paramor',
generalFurtherActivityDetail: '<br>Seminar sessions are held every other week for 1 hour. These debates are unassessed.',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce students to the role and limitations of environmental science within the context practical environmental decision making. At the end of this module students should have a basic understanding of (1) general scientific methods (2) the limits and assumptions of science and (3) the social context of science based decision making.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p><strong>Knowledge and understanding of:</strong></p><p>A2. Current trends and developments with the life and environmental sciences</p><p>A3. Appropriate terminology, nomenclature and classification</p><p>A5. Human systems and their interaction with global systems</p><p>A7. Environmental issues</p><p><strong>Intellectual Skills - the ability to: </strong></p><p>B1. Critically analyse and interpret published information and data</p><p>B2. Think independently while giving due weight to the arguments of others</p><p>B3. Understand complex ideas and relate them to specific problems or questions</p><p><strong>Practical/Professional Skills - the ability to:</strong></p><p>C2. Articulate knowledge and understanding of scientific concepts</p><p>C3. Write and construct scientific documents (e.g. papers, reports, posters etc) using appropriate styles, conventions, and terminology</p><p><strong>Transferable Skills - the ability to: </strong></p><p>D2. Communicate effectively in writing</p><p>D5. Use and access information and communication technology</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module introduces students to the role and limitations of Environmental Science within the context practical environmental decision making.</p><p>The three themes of the module are:</p><p>1. General scientific methods.</p><p>2. The limits and assumptions of science</p><p>3. The social context of science based decision making. These are illustrated through a series of environmental case studies e.g. genetic engineering in agriculture, climate change, wild species conservation, fishery management, sea dumping, use of models, radiation protection, state of environment reporting, sustainable development goals.<br><br><br><br><br> </p></div>',
assessmentFurtherActivityDetail: '<br>Seminar sessions are held every other week for 1 hour. These debates are unassessed.',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Coursework 1',
weight: '30.00',
requirements: 'Learning Portfolio, 2000 word coursework'
}, {
type: 'Coursework 2',
weight: '20.00',
...
type: 'Exam 1',
weight: '50.00',
requirements: 'Examination (end of Autumn Semester)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
