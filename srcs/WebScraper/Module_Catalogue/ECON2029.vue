...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Macroeconomic Theory',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Only available for students studying Microeconomic Theory AND Macroeconomic Theory OR Principles of Microeconomics AND Principles of Macroeconomics OR BSc Jt Hons Maths and Economics students OR those on an Economics Exchange.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To develop the tools, skills and knowledge base necessary to operate as a practicing macroeconomist;<br>2. To build a comprehensive understanding of economic forces that determine the fluctuation of economic activities in both the short and the medium run;<br>3. To be familiar with different growth models and their implications as well as empirical evidence on economic growth;<br>4. To build skills to analyze the impacts of fiscal policies and monetary policies.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A1 Demonstrate a broad knowledge of core areas of economics.<br>A2 Apply core economic theory and economic reasoning to applied topics.<br>A3 Show understanding of analytical methods, both theory- and model-based.<br>A4 Demonstrate understanding of verbal, graphical, mathematical and econometric representation of economic ideas and analysis, including the relationship between them.<br>A5 Show understanding of relevant mathematical and statistical techniques.<br>A6 Extensive knowledge and skills in specific specialisms in economics.<br>Intellectual Skills:<br>B4 Be able to frame analysis of problems, identifying which parameters should be taken as fixed and why they might change<br>Professional Practical Skills:<br>C1 Discuss and analyze government policy.<br>C3 Be familiar with differing approaches to analyzing a given economic problem and the history and development of economic ideas<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module will cover a broad range of macroeconomic topics that provides a general introduction to students on the modern macroeconomics. In particular, the module will focus on:</p><p> The causes and the dynamics of both the short and medium run fluctuations of output and employment<br> Fiscal and monetary policies during the business cycle<br> Long run economic growth</p><p>In the short run, we develop a generalization of the classical model of aggregate demand. In the medium run, we examine the labor market to explain what determines the natural rate of unemployment. In the long run, we introduce the most used approach to growth theory: the Solow model.</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p><p>Pre-Requisite: ECON1034 Introduction to Macroeconomics</p></div>',
