...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Thermodynamics & Fluid Mechanics 2',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Students registered on the Mechanical Engineering programme at The University of Nottingham Ningbo China.. Available to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To apply concepts and principles of thermofluids to fluid mechanics, thermodynamics and heat transfer situations in simplified applied situations.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module students will be able to: LO1-Comprehend the concepts of practical thermofluid systems (knowledge and comprehension) LO2-Represent applications of thermofluids in conceptual form by appropriate formulae (comprehension) LO3-Quantify the scale of thermofluid situations by appropriate use of thermofluid data tables (application of knowledge) LO4-Apply the conceptual principles of fluid mechanics and thermodynamics to practical situations (application of knowledge) LO5-Analyse complex thermodynamic and fluid systems from real applications (analysis)</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>An intermediate module in thermodynamics and fluid mechanics applicable to a wide range of engineering practice, including � basic equations for thermo-fluid flows � laminar and turbulent boundary layers � heat exchangers � thermal mixtures and combustion � dimensional analysis and similarity � condensable vapour cycles � compressible flow � pumps and compressors � heat transfer � refrigeration and air conditioning <br><br></p></div>',
...
type: 'Coursework 1',
weight: '15.00',
requirements: 'Thermodynamics practical work C 2 assignments'
}, {
type: 'Course work 2',
weight: '15.00',
requirements: ' '
...
type: 'Exam 1',
weight: '40.00',
requirements: '2 hour close book exam'
}, {
type: 'Mid-term exam',
weight: '30.00',
requirements: '<span style="font-size:10.5pt"><span style="font-family:DengXian"><font color="#000000">One-hr closed book exam</font></span></span>'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
