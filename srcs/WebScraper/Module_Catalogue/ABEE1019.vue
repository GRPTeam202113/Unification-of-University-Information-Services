...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Environmental Sciences for Architects 1',
...
staffName: 'Dr Sung-Hugh Hong',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module aims to provide an understanding of the environment as an integral part of the process of design – to whom it is closely intertwined in both teaching and assessment - highlighting the importance of sustainability (environmental, social and economic) as it applies to the welfare of future generations. In so doing, it seeks to encourage consideration of environmental issues – specifically focused on the design of the visual/luminous environment – from the outset of a project, giving students the ability to reflect on the appropriate environmental strategies that respond to the needs of the occupant, building programme and prevailing climate, and the ability to explore many of these in a rigorous manner.<br>The module also aims to introduce students to some simple analytical tools and techniques that allow them to explore and understand their proposed environmental strategies within their immediate context, thus helping them to validate their design ideas and assumptions.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of this module, students will demonstrate:<br>1. An awareness of the importance of the environmental agenda and environmental / architectural science as it applies to contemporary design challenges.<br>2. An understanding of the importance of solar energy flows both on the building envelope and internal building spaces and how they will affect the operation of a building, its energy consumption (and resultant carbon emissions) and occupant comfort / satisfaction.<br>3. A fundamental knowledge of the context-specific environmental strategies as they relate to different climates, occupant expectations and building programmes.<br>4. An ability to research and identify those strategies and energy flows that are relevant to the immediate context and explore and critically reflect on them in a rigorous manner using a range of analytical and observational tools and techniques.<br>5. An ability to interpret, manage, manipulate and communicate complex and interrelated information in a manner that is appropriate, rigorous, creative and legible.<br>6. Organizational skills, an ability to manage time carefully and work as part of a team.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Environmental Science for Architects 1 is a semester long module that introduces students to the principles of environmental science theories and their complex interrelationship that influence human experience of the natural and built environment. The module objective is to develop an understanding of the role that measurable environmental forces have in establishing user comfort and satisfaction within built environment and as the basis of sustainable building design practice. The module seeks to integrate the fields of human behavioural psychology and physiology to the physical quantification of environmental stimuli, with a view to achieving an understanding of the role that physical factors have in obtaining comfort and satisfaction inside and outside buildings through the aid of analytical tools such as climatic analysis, psychrometric process, comfort standards and average daylight factors.</p></div>',
...
type: 'Coursework 1',
weight: '100.00',
requirements: 'Group Work (6-7). 3000-word technical report (A3).'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
