...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Introduction to Macroeconomics',
...
staffName: 'Chunfei Weng',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1.To provide a sound basis in the fundamentals of macroeconomics and their application to both theoretical and real world situations<br>2.To develop analytical skills using the major methods of mathematics and diagrams and<br>3.To promote the ability to communicate and report findings via tutorial exercises and essays.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A1 Demonstrate a broad knowledge of core areas of economics (introducing).<br>A4 Demonstrate understanding of verbal, graphical, mathematical and econometric representation of economic ideas and analysis, including the relationship between them.<br>Intellectual Skills:<br>B2 Reason logically and work analytically.<br>B4 Be able to frame analysis of problems, identifying which parameters should be taken as fixed and why they might change<br>Professional Practical Skills:<br>C1 Discuss and analyse government policy.<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module provides an introduction to modern macroeconomic analysis. Macroeconomics is concerned with some of the most pressing and fundamental questions economists can ask, such as: What determines economic growth? Why do economies exhibit expansions ("booms") and contractions ("busts") in output? What drives employment and wages, saving and investment? What causes inflation and why is it a problem? What, if anything, can governments do to improve the performance of an economy?<br>Microeconomics is concerned with the analysis of economic agents and markets at the individual level. Macroeconomics is concerned with the aggregate implications of microeconomic behaviour at the economy-wide level. So there is a clear connect between the actions of individual agents in the economy and the aggregate performance of the economy. This is the starting point for modern macroeconomic analysis - though macroeconomics has not always been understood or taught in these terms, and prior study of macroeconomics at A-level or equivalent is not based on this modern understanding of macroeconomics built on "microfoundations". Consequently prior study of economics is not necessary for taking this module and students who have studied macroeconomics previously may have to re-think how they understand the aggregate economy.</p><p>ECON1033 Introduction to Microeconomics is the requisite for this module.<br>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
