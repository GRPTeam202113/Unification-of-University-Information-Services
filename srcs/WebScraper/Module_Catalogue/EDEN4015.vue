...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Dissertation (MA IHE)',
year: 'Academic Year 2022',
credit: '60.00',
level: '4',
targetStudents: 'Masters students in the School of Education',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The module aims to allow the student to engage in a substantive piece of scholarship on a subject related to their Masters programme, chosen in consultation with the supervisor and under one to one tutorial guidance.<br>This module will provide students with:<br>•  the opportunity to research in depth a topic of their choice, under the direction of a subject specialist;<br>•  the skills required to carry out sustained independent research.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A. Knowledge and Understanding<br>•    Students will develop knowledge and understanding of a topic related to scholarly interests and critical skills developed during the MA course.<br>B. Intellectual Skills<br>Students will develop the ability:<br>•    to evaluate current research and scholarship relating to a chosen topic;<br>•    to analyse individual texts or topics within an intellectual framework informed by current scholarship.<br>C. Professional Skills<br>Students will develop the ability:<br>•    to articulate knowledge and understanding of the chosen area of study;<br>•    to carry out research in a variety of media;<br>•    to evaluate the material developed or acquired;<br>•    to present their research accurately.<br>D. Transferable Skills<br>•    critical analysis, independent study skills, theoretical and empirical research skills, report writing and presentation.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The researching and writing of a substantive piece of scholarship within the field of the MA. Students will choose a topic in consultation with their MA Course Leader and an appropriate supervisor. The topic will normally be based on interests and skills students have developed in the course of the modules already studied. The dissertation should be between 12000 and 15000 words or equivalent.<br>Please note this module is assessed at the end of Spring semester.  First sit/ Resit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
assessmentFurtherActivityDetail: '<br>',
methodAndFrequency: [],
assessmentTable: [{
type: 'Coursework 1',
weight: '100.00',
requirements: '15000 words (+/- 10%) - dissertation'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
