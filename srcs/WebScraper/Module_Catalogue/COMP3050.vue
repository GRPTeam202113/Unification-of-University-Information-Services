...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Individual Dissertation Single Honours',
year: 'Academic Year 2022',
credit: '40.00',
level: '3',
targetStudents: 'Available to all Part II undergraduate students on BSc Computer Science (EA05) and BSc Computer Science with Artificial Intelligence (EA07).',
...
type: 'Dissertation',
weight: '75.00',
requirements: '15,000 word dissertation (excluding appendices) in printed in electronic form (PDF). Any source code must also be included with the electronic submission.'
}, {
type: 'Practical',
weight: '15.00',
requirements: 'Demonstration of project results.'
}, {
type: 'Report',
weight: '10.00',
requirements: 'Project plan including ethics clearance.'
}],
