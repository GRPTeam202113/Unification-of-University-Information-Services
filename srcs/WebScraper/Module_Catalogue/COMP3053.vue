...
credit: '10.00',
level: '3',
targetStudents: 'Part II undergraduate students in the School of Computer Science. Also available to students from other Schools with the agreement of the module convenor.This module is part of the Software Engineering theme in the School of Computer Science.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce concepts and techniques for software testing and quality assurance. To describe quality assurance standards and metrics. To introduce techniques for systematic software testing. To give an insight into the use of artificial and computational intelligence for automated software testing. To review recent industry trends on software quality assurance and testing. </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding: <br> •Knowledge and understanding of evaluation and testing of software systems.</p><p>Intellectual skills:<br> •Ability to use formal methods of software analysis.</p><p>Professional skills:<br> •Ability to test software in a systematic way and carry out quality assurance process, experience of using specialised testing software.</p><p>Transferable skills: <br> •Abstract thinking, systematic approach to problem solving.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 8pt; line-height: normal;"><span style="font-size: 12px;"><strong><span style="font-family: arial,sans-serif;"><span style="color: rgb(0, 57, 101);">Prerequisites: </span></span></strong><span style="font-family: arial,sans-serif;"><span style="color: rgb(0, 57, 101);">AE1PGP or AE1PGA or equivalent basic programming skills.</span></span></span></p><p>Through two to three hours of lectures each week, you will be introduced to concepts and techniques for software testing and will be given an insight into the use of artificial and computational intelligence for automated software testing. You will also review recent industry trends on software quality assurance and testing. </p></div>',
...
type: 'Coursework 1',
weight: '40.00',
requirements: 'Several assignments researching, reporting, presenting and assessing a given topic within the remit of the module.'
}, {
type: 'Exam 1',
weight: '60.00',
requirements: '1.5 hour written examination'
}],
