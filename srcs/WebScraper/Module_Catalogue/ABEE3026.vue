...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Integrated Design in Architecture 3',
...
staffName: 'Prof Ali Cheshmehzangi',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module builds on previous IDA modules to develop the context for integrated building design to an advanced level and to support its application through holistic design practices. </p><p> </p><p>Through a series of keynote lectures, workshops and tutorials, a range of technical topics will be covered that prescribe a range of multi-disciplinary inputs that an architect is likely to confront when devising a real project. </p><p> </p><p>Such thematic topics include daylight-sunlight, materials, façade, structure, building fabric and acoustics. This module runs in parallel to the studio. The intention is that knowledge and skills gained from teaching activities/self-initiated studies will provide ready-made inputs for application to studio projects as part of its design process. </p><p> </p><p>The intended end result of learning is the ability to produce architecture that is developed with technical issues relevant to the site, building type and local microclimate. Not only should the studio brief’s functional and formal criteria be fulfilled, but all technical issues explored within this module must be synthesised in the design process. The result is that what might seem to otherwise lie outside of studio practice is worked in seamlessly to the production of final architectural proposals. Students will be expected to evidence how they have achieved the aims of the Integrated Design teaching stream, both as an exploratory process and manifested within the studio module’s final project.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>On successful completion of the module students should be able to demonstrate at a more advanced level:</p><p>1. Architectural design skills that integrate the Comprehensive Design Project’s technical requirements relevant to the particular building type, programme and site conditions (GC1.1, GC1.2); </p><p>2. An ability to think holistically about architectural design design considering all the different facets taught cumulatively throughout the Integrated Design stream’s modules (IDA 1-3) (GC8); </p><p>3. Knowledge of the relationship between technology and architectural design (GC2, GC9); </p><p>4. The relevant precedents of historical, cultural and theoretical background that contributes to the technical strategy for constructing/engineering of buildings (GC2, GC7, GC8); </p><p>5. Technical issues such as structural, constructional and material considerations that provides input to the design of a building, especially for the purposes of a Comprehensive Design Project (GC1, GC2, GC8, GC9);</p><p>6. The contribution that the integration of environmental design makes towards creating a richer, aesthetically pleasing and sustainable architecture (GC2, GC8, GC9); </p><p>7. Skills that enable the selection of appropriate technologies and formulation of appropriate technical strategies to apply to design proposals in a fully integrated manner (GC1, GC9); </p><p>8. Skills relating to critical thinking, relevant decision making and an ability to appraise technical issues in relation to integrating them into the design process (GC1, GC8, GC9). In their professional career, graduates of the module will demonstrate the ability to design in an integrated way. As future professionals students should be able to.</p><p>9. Critically appraise and develop design proposals through the co-ordination of applied technical inputs, technologies and environmental design concepts in real time practice (GC1, GC8); </p><p>10. Determine the appropriateness of architectural and technical solutions towards achieving fully functional, inhabitable, durable and engaging buildings (GC1, GC8). </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module encourages the notion that integrated design is a holistic practice, in which technical issues from the fields of structural engineering, construction and environmental design inform the development of studio projects in the related module Architecture Design Studio 3.</p><p>To enable this aim, teaching content is delivered through weekly lectures during the Autumn Semester that draw on multi-disciplinary themes relevant to making inhabitable architecture, and through skills-based workshops and technical tutorials during the Spring Semester. These inputs form the backdrop to a self-initiated line of enquiry whose summary technical report (with defined chapter structure) will document its studies investigations whose findings will demonstrate their practical application towards the definitive architectural proposals in the studios Comprehensive Design Project. Each study is expected to be worked up in real time from the outset, as it is presumed that technical integration is essential to the design process, in ways similar to the framework of progressive work stages that architects follow when designing buildings in professional practice.</p></div>',
...
type: 'Coursework 1',
weight: '40.00',
requirements: 'Project Report comprising text and supporting illustrations (drawings, diagrams and relevant images) 3000 words. The Project Report will comprise of 3 parts: 1.1 Project Introduction 1.2 Project Journal &amp; 1.3 Project Reflection'
}, {
type: 'Coursework 2',
weight: '60.00',
requirements: 'Project Development: Technical Summary (PROD TECH SUM): Summary report of technical investigations. 3,000 word illustrated technical report, including 3 parts.'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
