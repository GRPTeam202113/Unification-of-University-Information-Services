...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Languages and Computation',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Part I undergraduate students in the School of Computer Science only.',
...
type: 'Coursework 1',
weight: '25.00',
requirements: 'Problem sheets with theoretical and small programming problems.'
}, {
type: 'Exam 1',
weight: '75.00',
