...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Foundational Business Analytics',
...
generalFurtherActivityDetail: '<br>Total Contact Hours 44 hours (4/week over 11 weeks) <br>200 hours in Total. <br>Background study 56 hours <br>Coursework: 50 hours <br>Revision: 50 hours',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To develop understanding and practical skills in core descriptive analytic techniques. This will cover fundamental statistical knowledge, general programming skills and approaches to common problems within business analytics. Students will also complete the module with appropriate evaluation and communication skills to produce results that are effective in real-world situations.<br> </p></div>',
...
assessmentTable: [{
type: 'In-class Computer-based test',
weight: '25.00',
requirements: '1.5 Hour In-class Computer-based test'
}, {
