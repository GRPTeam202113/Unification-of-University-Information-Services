...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Microeconomics: consumer and firm behaviour',
...
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module covers foundations of consumer theory, decision-making under risk, elements of the theory of imperfect competition, and incomplete information in markets.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
