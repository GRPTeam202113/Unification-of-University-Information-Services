...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Industrial Design Professional Practice 3B',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Target Students: Third year BEng undergraduate Product Design and Manufacture students from Department of M3. Also available to Exchange students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p><span lang="EN-GB" style="background: white; margin: 0px; color: rgb(81, 81, 81); line-height: 107%; font-family: "Arial",sans-serif; font-size: 9pt;">Education Aims:  By the end of the module students will be able to use the FEA tools within solidworks to inform them how to improve part design.<span style="margin: 0px;">  </span>They will have an understanding of who to gain information on the sustainability of their choices in manufacture and materials.<span style="margin: 0px;">  </span>They will have greater skills and understanding in the use of Engineering drawing production and reading.</span></p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="margin: 0px 215px 0px 0px; line-height: normal;"><i><span lang="EN-GB" style="margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;">On successful completion of this module students will have:</span><span lang="EN-GB" style="margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;"> </span></i></p><p style="margin: 0px 176px 0px 0px; line-height: normal;"><br><span lang="EN-GB" style="margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;"><span style="background: white; margin: 0px;">•  LO1 - Demonstrate ability to use the FEA analysis tools within solidworks to improve the performance of parts</span><br><span style="background: white; margin: 0px;">•  LO2 – Understand the limitations of and be able to demonstrate ability to use the sustainability analysis tools within solidworks to inform design decisions.</span><br><span style="background: white; margin: 0px;">•  LO3 – Know how to Analyse and check Engineering Drawings to produce a consistent level of design communication.</span></span></p><p style="margin: 0px 176px 0px 0px; line-height: normal;"><span lang="EN-GB" style="background: white; margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;"> </span></p><p style="margin: 0px 176px 0px 0px; line-height: normal;"><span lang="EN-GB" style="background: white; margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;"> </span></p><p style="margin: 0px 215px 0px 0px; line-height: normal;"><span lang="EN-GB" style="background: white; margin: 0px; color: rgb(81, 81, 81); font-family: "Arial",sans-serif; font-size: 9pt;">Offering School:  Department of Mechanical, Materials and Manufacturing Engineering</span></p></div>',
...
type: 'Coursework',
weight: '100.00',
requirements: '<span lang="EN-GB" style="background: rgb(238, 238, 238); margin: 0px; color: rgb(81, 81, 81); line-height: 107%; font-family: &quot;Arial&quot;,sans-serif; font-size: 9pt;">Portfolio of work</span>'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
