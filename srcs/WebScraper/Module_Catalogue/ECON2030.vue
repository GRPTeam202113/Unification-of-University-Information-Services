...
export default {
  name: 'module',
  data() {
    return {moduleName: 'International Trade',
year: 'Academic Year 2022',
credit: '10.00',
level: '2',
targetStudents: 'Year 3 Economics students',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To provide an introduction to core theories of international trade.<br>2. To see how these theories help us think about the pattern of trade and welfare gains from international trade.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A3 Show understanding of analytical methods, both theory- and model-based.<br>A6 Extensive knowledge and skills in specific specialisms in economics (introducing)<br>Intellectual Skills:<br>B1 Work with abstract concepts and in a context of generality.<br>Professional Practical Skills:<br>C1 Discuss and analyse government policy.<br>C3 Be familiar with differing approaches to analysing a given economic problem and the history and development of economic ideas<br>Transferable (key) Skills:<br>D1 Apply mathematical, statistical and graphical techniques in an appropriate manner.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This course will introduce students to international trade theory and its applications.</p><p>ECON 1033 Introduction to Microeconomics is the requisite of this module.</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
