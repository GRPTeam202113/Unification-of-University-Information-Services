...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'The Japanese Colonial Empire',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Students interested in Modern Japanese history or imperialism and colonialism in general',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module explores the history of the Japanese colonial empire. For several centuries before the Meiji era, Japan consisted of three main islands, Honshu (本州), Shikoku (四), and Kyushu (九州).  Yet from the mid-19th century to the mid-20th century, while confronting other western imperial powers, modern Japan reconstructed itself and expanded way beyond its traditional territories, covering internal colonies, such as Hokkaido and Okinawa, as well as other colonized regions, including Taiwan and Korean peninsula formally and Manchuria, coastal China, Southeast Asia informally in its heyday. Although Japan’s colonial empire collapsed seven decades ago, its legacies still affect the peoples of East Asia today, not only in their views of their own past, but also in their interactions with their neighbours at present and in the future. </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>a)Knowledge and understanding<br>•Summarize the historical chronologies, and political and social processes of imperial Japan.<br>•Identify the key elements in the legacies of colonial Japan involved in framing modern East Asia<br>•Engage in some of the leading debates on the colonial histories</p><p>b)Academic skills<br>•Think historically<br>•Plan, conduct and present a research project<br>•Convey their thought effectively in an academic setting</p><p>C) Students will have the opportunity to acquire a wide range of transferable skills.<br>•The content of the module will help students to grasp complex ideas and concepts, evaluate competing arguments, and practice their reasoning skills.<br>•In lectures students will develop listening and note taking skills.<br>•The seminars will provide an opportunity for students to engage in discussions and debates, and work effectively in small groups.<br>•The written assignment will encourage students to conduct independent research.<br>•The written assignment will help students to develop their writing skills.<br>•The exam will provide an opportunity to work under time constraints.</p><p> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module specifically introduce students to the rise and fall of the Japanese colonial empire in East Asia from the late 19th century until the mid-20th century. There will be three components: (1) how the Japanese colonialist values came into being as a response to the radical transformation of the political order in East Asia; (2) how imperial Japan came to dominate Okinawa, Taiwan, Korea, and Manchuria; 3) and how its colonial empire finally collapsed. The module will also present evidence on how the colonial eras of these regions have been told and retold through competing narratives. By examining these narratives students will be invited to reflect critically on how historical memories have been shaped and how historical writings have been influenced by different socio-political circumstances.</p><p>Please note: This module is assessed at the end of  Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
type: 'Coursework 1',
weight: '50.00',
requirements: '2,500 words of coursework (Essay and weekly posting)'
}, {
type: 'Exam 1',
weight: '50.00',
