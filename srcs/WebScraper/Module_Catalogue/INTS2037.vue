...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'The Silk Road: cultural interactions and perceptions',
year: 'Academic Year 2022',
credit: '20.00',
level: '2',
targetStudents: 'Year 3 (L2) International Studies, International Communications and Exchange Students',
...
generalFurtherActivityDetail: '<br>The module will consist of 1-hour lectures and 2-hour seminars. The total amount of student input into this module over the semester will be of 200 hours',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The Silk Road is an excellent example of a series of linked communities across a wide geographical space. The connections between them changed at different times. This discipline-bridging module will develop an appreciation of how the different disciplines that focus on the Silk Road overlap and inter-relate with each other. Thus scientific and non-scientific disciplines will be combined. An example is the combination of the contributions from history, archaeology, geography and archaeological science. Such a combination will illuminate and inform the ways in which the movement of peoples and things along the Silk Road over time occurred and helped to define it. Interpretation of the evidence is frequently not particularly straightforward. This module is designed to make students ask questions about the evidence that they are presented with. By the end of the module knowledge of discipline-bridging methodologies will be gained on a temporal and geographical scale that students rarely encounter in other modules.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding:<br>A student who completes this programme successfully should be able to answer questions related to a series of ways of approaching the Silk Road. The student will develop an understanding of historical, archaeological, scientific, geographical and contemporary perceptions of the Silk Road. The module will challenge his/her intellectual understanding of individual site studies as against connected communities and the ways in which different types of data can be used to support the interpretations. The student will develop a clear understanding for why discipline-bridging is used and the types of results that can be expected. The student will also appreciate why specific techniques are used to investigate the evidence.</p><p>Intellectual:<br>Students should be able to think in a cross-disciplinary way, bringing together contrasting data sources to interpret the origins and movement of people and things. They will also become aware of how such a Route was and is perceived, underlining cultural differences and similarities. They will be able to answer research questions in the investigation of similarly connected communities in other geographical areas and during different time periods.</p><p>Practical and professional:<br>Students will develop further the bibliographic and writing skills gained in the first year of their degrees</p><p>Transferable (Key) skills:<br>Students will learn to discuss and debate interpretations and defend their ideas orally in a large group situation. They will develop problem solving abilities and their critical assessment of the various approaches to answering the same question. They will also learn about a range of techniques involved in discipline-bridging in the study of the Silk Road. </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This discipline-bridging cross-campus module will involve colleagues from across the three campuses of the University of Nottingham. The Silk Road will be presented as a range of archaeological, historical and scientific themes. Broad cultural themes will be balanced with the presentation of specific case studies, such as the definitions of the silk roads, Byzantine, Islamic and later medieval Silk Roads, luxury production, trade and exchange from the Roman and later periods and Ming Dynasty links with the west. Furthermore scientific techniques and their role in the interpretation of trade and exchange along the Silk Roads will be considered between for example China, central Asia, Scandinavia and the Middle East will be included.</p><p>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.<br> </p></div>',
assessmentFurtherActivityDetail: '<br>The module will consist of 1-hour lectures and 2-hour seminars. The total amount of student input into this module over the semester will be of 200 hours',
methodAndFrequency: [{
activity: 'Lecture',
...
type: 'Coursework 1',
weight: '70.00',
requirements: '4000 word essay'
}, {
type: 'Coursework 2',
weight: '30.00',
requirements: 'Group Communication Project'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
