...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Fluid Mechanics',
year: 'Academic Year 2022',
credit: '10.00',
level: '1',
targetStudents: 'Year 1 students registered on the following courses: Chemical Engineering, Chemical Engineering with Environmental Engineering, and Environmental Engineering students. Available to JYA/Erasmus students.',
offeringSchool: 'Department of Chemical and Environmental Engineeri',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Kien Woh Kow',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This module provides basic understanding and concepts of fluid mechanics essential to chemical and environmental engineering applications. It also forms a basis for later moduli involving heat and mass transfer in fluids.</p><p>To ensure that students are able to apply appropriate quantitative science and engineering tools to the analysis of problems.</p><p>To ensure that students possess relevant practical skills acquired through laboratory work.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="margin: 0in 0in 8pt;"><span lang="EN-GB"><font color="#000000" face="Calibri" size="3">A2.1.1 Understand the principles of fluids and solids formation and processing.</font></span></p><p style="margin: 0in 0in 8pt;"><span lang="EN-GB"><font color="#000000" face="Calibri" size="3">The principles of fluids are to be covered and assessed via final exam.</font></span></p><p style="margin: 0in 0in 8pt;"><span lang="EN-GB"><font color="#000000" face="Calibri" size="3">A2.1.2 Be proficient in applying these principles to problems involving fluid flow, heat transfer, mass transfer and reaction engineering.</font></span></p><p style="margin: 0in 0in 8pt;"><span lang="EN-GB"><font color="#000000" face="Calibri" size="3">The skills to apply the principles of fluid flow for problem-solving are to be developed via tutorial sessions and assessed via final exam.</font></span></p><p style="margin: 0in 0in 8pt;"> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module covers the essential fluid mechanics needed by engineers to design tanks, vessels, piping systems and pumps and to understand their operation. It provides an introduction into the fundamentals of fluid mechanics, including physical properties of fluids, fluid statics, elementary fluid dynamics, viscous flow in pipes. Assessed through week 8 activities, laboratories and an individual module exam. It also forms a basis for later modules on heat and mass transfer in fluids.</p></div>',
...
type: 'Exam 1',
weight: '60.00',
requirements: 'One exam, 1 hour 30 minutes'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
