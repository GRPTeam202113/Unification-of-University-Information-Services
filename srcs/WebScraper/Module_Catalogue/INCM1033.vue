...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Cultures of Everyday Life',
...
staffName: 'Dr Lili Hernandez',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><ul> <li>To enable students to question the taken-for-grantedness of the "everyday".</li> <li>To provide students with the ability to appreciate the dense, complex and contradictory nature of day to day experience. For instance, to see how the everyday is both idiosyncratic and normative.</li> <li>To offer students an understanding of public consecrated representations of everyday life (e.g. soaps, dramas, museums and archives) with a view to unmasking their ideological effects.</li> <li>To gain understanding of everyday cultures such as fashion, film, tourism, music, love and the like.</li> <li>To enable students to critically discuss cultural, psychological and philosophical implications of everyday life in a modern world.</li> <li>To provide students with knowledge and understanding of theories of everyday life, refusing the taken-for-grantedness of their own everyday.</li> <li>To offer students a critical foundation to identify the ordinary and the extraordinary woven into the fabric of everyday life.</li> <li>To develop a creative approach to everyday life.<p> </p></li></ul></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><ul> <li>Intellectual skills: Students will be able to critically discuss aspects of the everyday that are overall taken for granted. They will present their readings, reflections, impressions and insights about the everyday in both written and oral form, developing the skill of seeing it anew.</li> <li>Professional/practical skills: use theoretical source materials and examples across a range of aspects of the everyday, take notes summarising and articulating knowledge of theoretical concepts while developing an understanding of the evasiveness of day to day experience.</li> <li>Further skills: communicate clearly in oral presentations, display analytical skills, demonstrate well-structured written commentary based upon a critical/evaluative reading of sources, contribute to discussion, responding to and developing the ideas of others, use information retrieval skills, develop judgement.<p> </p></li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module offers an introduction to theories of everyday life. The module deals with everyday life not as a palpable reality to be gathered up and described. Instead, it addresses theories that have attempted to represent aspects of everyday life that remain hidden, making visible the invisible. While we may take the idea of the everyday for granted, associating it with routine, familiar and repeated experiences, our everyday lives are, simultaneously, punctuated by the exceptional, the random and the disruptive. Traditional theoretical attempts to account for the everyday tend to overlook aspects of daily life that refuse system and order: sociology, anthropology, cultural and media studies, for example, deal with activities such as work and leisure but neglect the unique texture of everyday experience. This course thus emphasises the everyday world as problematic and fraught with difficulty in terms of seeing, theorising and representing, and looks at a wide range of attempts to register it.</p><p>Please note: This module is assessed at the end of Spring semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
...
assessmentTable: [{
type: '1,500 word essay',
weight: '30.00',
requirements: 'The essay will be on one lecture topic that will not be used for the final written project assessment.<br />Electronic submission only'
}, {
type: '1,250 word seminar reports',
weight: '10.00',
requirements: 'Hardcopy and Electronic copy submission<br />Seminar reports include self-assessment worksheet and that week&rsquo;s seminar report.<br />Students must bring one copy of the self-assessment and seminar report to each seminar and at the end of the seminar both documents will be stamped/signed by the tutor. The student will retain the documents with the stamps/signature. On the Friday of the week of the last seminar students must upload to Turnitin 5 self-assessments and 5 seminar reports with the stamp/signature. Each is worth 10 points for a total of 100 points.'
}, {
type: '2,000 word written project',
weight: '60.00',
requirements: 'Same assessment as last year.<br />Electronic submission only'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
