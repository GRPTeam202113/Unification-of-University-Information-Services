...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Strategic Management: Perspective, Process and Practice',
year: 'Academic Year 2022',
credit: '20.00',
level: '3',
targetStudents: 'IBM, IBE and IBC',
offeringSchool: 'Nottingham University Business School China',
taughtSemesters: 'Full year China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Ms Zhijing Zhu',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide students with the key tools, concepts and frameworks of strategic analysis and develop their abilities of strategy implementation.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><div><strong><em>Knowledge and understanding: </em></strong></div><div>This module develops a knowledge and understanding of:</div><ul> <li>The dynamic and changing nature of business and the consideration of the future of organisations within the global business environment, including the management of risk.</li> <li>The management of resources.</li> <li>The development of appropriate policies and strategies within a changing environment to meet stakeholder interests.</li> <li>The need for individuals and organisations to manage responsibly and sustainably and behave ethically in relation to social, cultural, economic and environmental issues.</li> <li>The development of strategic priorities to deliver business at speed in an environment where digital technology has reshaped traditional revenue and business models.</li></ul><div><strong><em>Intellectual skills: </em></strong></div><div>This module develops:</div><ul> <li>The ability to analyse facts and circumstances to determine the cause of a problem and identifying and selecting appropriate solutions.</li> <li>Conceptual and critical thinking, analysis, synthesis and evaluation.</li></ul><div><br><strong><em>Professional practical skills: </em></strong></div><div>This module develops:</div><ul> <li>Commercial acumen based on an awareness of the key drivers for business success, causes of failure and the importance of providing customer satisfaction and building customer loyalty.</li></ul><div><br><strong><em>Transferable (key) skills: </em></strong></div><div>This module develops:</div><ul> <li>Self-management and a readiness to accept responsibility and flexibility, to be resilient, self-starting and appropriately assertive, to plan, organise and manage time.</li> <li>Articulating and effectively explaining information.</li> <li>Building and maintaining relationships.</li></ul></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module covers strategic analysis, positioning, creating and sustaining competitive advantage, diversification, internationalization, stakeholder engagement, strategic decision making, strategy implementation, strategic leadership and strategic change.</p><p>Re-assessment format is decided by the school.</p></div>',
...
assessmentTable: [{
type: 'Team-based Computer Simulation',
weight: '30.00',
