...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Principles of Accounting',
year: 'Academic Year 2022',
credit: '10.00',
level: '4',
targetStudents: 'Core module on MSc International Business programme Available to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To provide course members with an appreciation of the roles and techniques of accounting in the context of international business reporting and management.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and understanding: The dynamics of the global economy and international business &amp;/or an awareness of cultural, legal/regulatory, political, and economic differences across countries &amp;/or an appreciation of management issues from a global perspective.</p><p> Customers and stakeholders - customer expectations, service and orientation</p><p> Finance - the sources, uses and management of finance</p><p> The use of accounting and other information systems for managerial applications</p><p> The management of resources</p><p> The management of projects</p><p> Information systems and business intelligence - the development, management, application and implementation of information systems and their impact upon organisations</p><p> Communications – the comprehension and use of relevant communications for application in business and management, including the use of digital tools</p><p>Intellectual Skills: This module develops:</p><p> Being able to think critically and be creative: manage the creative processes in self and others; organise thoughts, analyse, synthesise and critically appraise. This includes the capability to identify assumptions, evaluate statements in terms of evidence, detect false logic or reasoning, identify implicit values, define terms adequately and generalise appropriately</p><p> Being able to solve complex problems and make decisions: establish criteria, using appropriate decision-making techniques including identifying, formulating and solving business problems; and the ability to create, identify and evaluate options; the ability to implement and review decisions</p><p> Using information and knowledge effectively in order to abstract meaning from information and to share knowledge, including the use of quantitative skills</p><p>Professional Practical Skills: This module develops:</p><p> The ability to conduct research and enquiry into business and management issues either individually or as part of a team through research design, the collection and analysis of qualitative data, synthesis and reporting</p><p> The ability to conduct research and enquiry into business and management issues either individually or as part of a team through research design, the collection and analysis of quantitative data, synthesis and reporting</p><p> Effective performance within team environments and the ability to recognise and utilise individuals" contributions in group processes and to negotiate and persuade or influence others; team selection, delegation, development and management.  </p><p>Transferable (key) Skills: This module develops:</p><p> Effective communication: networking, listening, oral and written communication of complex ideas and arguments, using a range of media, including the preparation of business reports</p><p> High personal effectiveness: critical self-awareness, self-reflection and self-management; time management; conflict  resolution, displaying commercial acumen, the ability to continue to learn through reflection on practice and experience</p><p> Soft skills: understanding the needs of others and empathy towards them; sensitivity to diversity in people and in different situations</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The roles of accounting in business and its link to global capital markets; International accounting harmonisation; Comparative international accounting; Financial statement analysis; Managerial accounting for planning and control; Discounted cash flow and valuation</p></div>',
...
type: 'Exam 1',
weight: '100.00',
requirements: '2 Hour Examination (100%)'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
