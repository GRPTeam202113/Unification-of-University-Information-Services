...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Coding and Cryptography',
year: 'Academic Year 2022',
credit: '10.00',
level: '3',
targetStudents: 'Single Honours students from the School of Mathematical Sciences who have successfully completed Part I. Requisites: MATH1028 Analytical and Computational Foundations,MATH1030 Linear Mathematics.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>This course provides an introduction to coding theory in particular to error-correcting codes and their uses and applications. It also provides an introduction to cryptography, including classical mono- and polyalphabetic ciphers as well as modern public key cryptography and digital signatures, their uses and applications.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this course successfully will be able to:</p><p>L1 - define and explain concepts in the theory of error correcting codes;</p><p>L2 - state and prove results about error correcting codes;</p><p>L3 - construct examples of error correcting codes and apply techniques for error correction;</p><p>L4 - define and explain key concepts in cryptography;</p><p>L5 - explain how some common classical and modern cryptographic systems work;</p><p>L6 - apply simple algorithms to encrypt and decrypt messages;</p><p>L7 - analyze an encrypted message and find the corresponding plain text message and/or encryption key;</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This course consists of two main topics of coding theory: error-correction codes and cryptography.</p><p>In digital transmission (as for mobile phones), noise that corrupts the message can be very harmful. The idea of error-correcting codes is to add redundancy to the message so that the receiver can recover the correct message even from a corrupted transmission. The course will concentrate on linear error-correcting codes (such as Hamming codes), where encoding, decoding and error correction can be done efficiently.</p><p>In cryptography, the aim is to transmit a message such that an unauthorised person cannot read it. The message is encrypted and decrypted using some method, called a cipher system.</p><p>There are two main types of ciphers: private and public key ciphers. We will discuss basic classical mono and polyalphabetic ciphers as more modern public key cipher like, for instance, RSA and the elementary properties from number theory needed for them. Key exchange protocols and digital signatures (DSA) are included.</p></div>',
