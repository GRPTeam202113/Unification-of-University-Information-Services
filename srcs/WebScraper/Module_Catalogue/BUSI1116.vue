...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Entrepreneurship: Theory & Practice',
year: 'Academic Year 2022',
credit: '20.00',
level: '1',
targetStudents: 'Any Available to JYA/Erasmus students.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><div>This module will encourage students to:</div><div>Consider entrepreneurship in theory and practice. Approach ideas generation in a creative manner.<br>Understand the usefulness of entrepreneurial skills in multiple contexts.<br>Understand the role and nature of new business concepts and their development.</div></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>The dynamic and changing nature of business and the consideration of the future of organisations within the global business environment, including the management of risk</p><p>The development, access and operation of markets for resources, goods and services.</p><p>The management of customer expectations, relationships and development of service excellence.</p><p>The sources, uses and management of finance.</p><p>The management of resources.</p><p>The comprehension and use of relevant communications for application in business and management, including the use of digital tools.</p><p>The use of risk management techniques and business continuity planning to help maximise achievement of strategic objectives</p><p>The need for individuals and organisations to manage responsibly and sustainably and behave ethically in relation to social, cultural, economic and environmental issues.</p><p>Taking innovative business ideas to create new products, services or organisations including the identification of Intellectual Property and appreciation of its value.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The course presents a formal analysis of entrepreneurship in theory and practice leading on to a consideration of creativity and business concept generation. The course concludes with the practical application of these theories and concepts in business planning and business concept presentation.</p><p> </p></div>',
...
type: 'Groupwork',
weight: '30.00',
requirements: 'Video of infographic. This will detail the root causes of the challenge chosen, highlighting the key issues -Group work (30%)'
}, {
type: 'Coursework 1',
weight: '20.00',
requirements: 'Reflective blog portfolio. This will cover 4 reflections - 500 words each -&nbsp;it is expected that each post will link to content from certain weeks on the course. E.g. the first blog will relate to the first three session and will review the content, and link to the first blended learning session so must refer to the webinar with an entrepreneur. It is expected to include academic literature where references are expected (20%)'
}, {
type: 'Coursework 2',
weight: '50.00',
requirements: 'Portfolio of the semester (50%) which would include;-Reflective blog covering the content for each week, this will be the length of tweets (140 characters max.)-Discussion of how the idea developed, providing evidence from seminars and group work sessions to demonstrate the development.-Discuss the business idea in the form of a mini business plan (the presentation poster should be included) (3,000 words)'
}],
...
staffTelephone: '+86 (0)574 88180000 ext. 8423',
