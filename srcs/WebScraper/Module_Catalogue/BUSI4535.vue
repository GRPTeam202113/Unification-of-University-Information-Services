...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Capital Market Analysis',
year: 'Academic Year 2022',
credit: '20.00',
level: '4',
targetStudents: 'Core Module for N323 MSc Finance and Investment Available to JYA/Erasmus students.',
offeringSchool: 'Nottingham University Business School China',
taughtSemesters: 'Autumn China',
requisites: 'N/A',
additionalRequirements: 'N/A',
staffName: 'Dr Xiaogang Bi',
generalFurtherActivityDetail: '<br>',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The module aims to introduce students to the characteristics of the equity asset class, to identify relevant data sources for returns from individual equities and equity markets, to explain how pattern in returns can be investigated, to show how equities can be combined in portfolios, and to show how the performance of portfolios and portfolio managers can be measured.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><div>Knowledge and understanding<br>This module develops a knowledge and understanding of:<br>•The dynamics of the global economy and international business &amp;/or an awareness<br>of cultural, legal/regulatory, political, and economic differences across countries &amp;/or<br>an appreciation of management issues from a global perspective.<br>•Markets - the development and operation of markets for resources, goods and services<br>•Finance - the sources, uses and management of finance</div><div>Intellectual skills<br>This module develops:<br>•Being able to think critically and be creative: manage the creative processes in self and others; organise thoughts, analyse, synthesise and critically appraise. This includes the capability to identify assumptions, evaluate statements in terms of evidence, detect false logic or reasoning, identify implicit values, define terms adequately and generalise appropriately</div><div>•Being able to solve complex problems and make decisions: establish criteria, using appropriate decision-making techniques including identifying, formulating and solving business problems; and the ability to create, identify and evaluate options; the ability to implement and review decisions</div><div>•Using information and knowledge effectively in order to abstract meaning from information and to share knowledge, including the use of quantitative skills</div><div><br>Professional practical skills: This module develops:<br>•The ability to conduct research and enquiry into business and management issues either individually or as part of a team through research design, the collection and analysis of quantitative data, synthesis and reporting<br>•Effective performance within team environments and the ability to recognise and utilise individuals" contributions in group processes and to negotiate and persuade or influence others; team selection, delegation, development and management.  Leadership and performance management: selecting appropriate leadership style for different situations; setting objectives, motivating, monitoring performance, coaching and mentoring</div><div>Transferable (Key) skills<br>This module develops:<br>•Effective communication: networking, listening, oral and written communication of complex ideas and arguments, using a range of media, including the preparation of business reports<br>•High personal effectiveness: critical self-awareness, self-reflection and self-management; time management; conflict  resolution, displaying commercial acumen, the ability to continue to learn through reflection on practice and experience.</div></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>The module examines the equity asset class as an example of a long term, generally risky, financial security. The module looks at the way performance of an investment in equities is characterised, and how such investments have performed in the past. The processes of equity portfolio construction, management and performance measurement are then examined. The perspective adopted is that of the purchaser, not the issuer, of equity. </p></div>',
...
type: 'Coursework 1',
weight: '20.00',
requirements: '2,500 word Group Coursework (20%)&nbsp;'
}, {
type: 'ACP',
weight: '20.00',
requirements: 'ACP (20%)'
