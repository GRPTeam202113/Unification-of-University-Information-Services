...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Analytical and Computational Foundations',
...
staffName: 'Dr Vladimir Toussaint',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>The overall aims, as part of the first-year Mathematics core, are to build upon pre-university knowledge, focusing on the development of skills, knowledge and confidence in applying a range of concepts, techniques and software required across the spectrum of mathematics, and to provide an introduction to, motivation for, and practice in, logical reasoning and rigorous mathematical thinking.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>A student who completes this module successfully should be able to:</p><p>L1 - prove statements by using basic sets, logic and induction where appropriate;<br><br>L2 - manipulate and solve simple inequalities;<br><br>L3 - identify bounds and maximum/minimum elements where appropriate;<br><br>L4 - apply tests for convergence of sequences and series;<br><br>L5 - determine limits of functions;<br><br>L6 - state and apply definitions of countable and uncountable sets;<br><br>L7 - use the mathematical software to perform iterative tasks, such as implementing numerical methods to calculate approximate roots of polynomials or limits of iteratively defined sequences.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p style="margin-bottom:12.0pt;line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">This module is one of three linked 20-credit year-long core modules introducing students to a broad range of essential mathematical concepts and techniques that underpin all the School of Mathematical Sciences" degree programmes. It has two mathematical components: </span></span></p><p style="margin-bottom:12.0pt;line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">Mathematical reasoning (the language of mathematics, the need for rigour, and methods of proof); </span></span></p><p style="margin-bottom:12.0pt;line-height:normal;"><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">Elementary analysis. </span></span></p><p><span style="font-family:times new roman,serif;"><span style="font-size:12.0pt;">In addition, the course includes timetabled computer workshops and a few associated lectures which introduce a mathematical software package (such as Python). This material will be used to support all three core modules, and be assessed equally across all three core modules.</span></span></p></div>',
...
type: 'Coursework 1',
weight: '5.00',
requirements: 'Computing coursework'
}, {
type: 'Inclass Exam 1 (Written)',
weight: '8.00',
requirements: 'Autumn Inclass Test'
}, {
type: 'Inclass Exam 2 (Written)',
weight: '7.00',
requirements: 'Spring Inclass Test'
}, {
type: 'Coursework 2',
weight: '5.00',
requirements: 'Computing coursework'
