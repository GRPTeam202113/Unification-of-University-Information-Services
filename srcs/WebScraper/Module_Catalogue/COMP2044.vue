...
credit: '10.00',
level: '2',
targetStudents: 'Part I undergraduate students in the School of Computer Science. Also available to students from other Schools with the agreement of the module convenor.This module is part of the Human-Computer Interaction theme in the School of Computer Science.',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>To introduce students to the study of HCI by examining different design approaches and evaluation methods and to encourage a systematic approach to the design and evaluation of the user interface in contemporary computing systems. Particular attention is paid to the use of prototyping as an aid to interface development through iterative evaluation.</p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br> •Understanding the importance of considering the human in the design of interactive computer systems.<br> •Knowledge of different design and evaluation methods.<br> •Understanding of the issues and problems facing the interface designer and an appreciation of the relationship between physical and software constraints in device design.</p><p>Intellectual Skills:<br> •Ability to understand and evaluate interface specifications.</p><p>Professional Skills:<br> •Ability to recognise good and bad usability characteristics.<br> •Ability to design and evaluate user interfaces.<br> •Knowledge of interdisciplinary working practices. </p><p>Transferable Skills:<br> •Ability to solve interface design problems.<br> •Ability to structure and communicate ideas effectively.</p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module is part of the Human Computer Interaction theme in The School of Computer Science. This module aims to teach an understanding of people interactions with technology and how to apply this knowledge in the design of usable interactive computer systems. The module will introduce the concept of usability and will examine different design approaches and evaluation methods. Specifically, this module will cover an understanding of different styles of interaction with technology, an analysis of user needs, design standards, low fidelity prototyping techniques and a comparison of evaluation techniques.</p></div>',
...
type: 'Coursework 1',
weight: '50.00',
requirements: 'Design and prototype exercise'
}, {
type: 'Coursework 2',
weight: '50.00',
requirements: 'Weekly Workshop exercises and a Group Report'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
