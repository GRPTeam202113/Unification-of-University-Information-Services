...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Current Economic Issues',
...
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><p>1. To illustrate current issues in the world economy<br>2. To examines potential policy responses<br>3. To apply economic theory to topical issues of regional integration<br>4. To critically assess relevant policy and policy alternatives.<br> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p>Knowledge and Understanding:<br>A2 Apply core economic theory and economic reasoning to applied topics.<br>Intellectual Skills:<br>B4 Be able to frame analysis of problems, identifying which parameters should be taken as fixed and why they might change<br>Professional Practical Skills:<br>C1 Discuss and analyse government policy.<br>C3 Be familiar with differing approaches to analysing a given economic problem and the history and development of economic ideas<br>C4 Understand the context in which a problem is to be addressed.<br>Transferable (key) Skills:<br>D2 Communicate effectively and clearly in written and oral formats.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>This module focuses on a range of current issues facing the world economy, seeks to illustrate how economists model such issues, and examines potential policy responses.<br>1. Globalisation : Trends and Consequences<br>2. International Trade in Services<br>3. Trade, Economic Growth, an Introduction<br>Please note: This module is assessed at the end of Autumn semester.  First sit/ Re-sit exams are scheduled normally in the summer and can take the same form as the missing/ failed component of the assessment (exam, essay etc.) or other form, as decided by the School.</p></div>',
