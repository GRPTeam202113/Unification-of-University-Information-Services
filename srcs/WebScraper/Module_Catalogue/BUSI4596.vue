...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Essentials of International Marketing',
year: 'Academic Year 2022',
credit: '10.00',
level: '4',
targetStudents: 'Business School MSc International business students onl',
...
type: 'Coursework 1',
weight: '100.00',
requirements: '4000 words Individual Assignment'
}],
staffOffice: '',
staffAddress: '',
staffCampus: '',
