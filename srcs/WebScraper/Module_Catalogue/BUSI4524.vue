...
<script>
    export default {
        ...
        data () {
            return {
moduleName: 'Entrepreneurship in Context',
year: 'Academic Year 2022',
credit: '20.00',
level: '4',
targetStudents: 'Core module for EB16 Entrepreneurship, Innovation and Organisation students Available to JYA/Erasmus students.',
...
generalFurtherActivityDetail: '<br>Total Contact Hours: 44 hours (11 X 4 Hour)<br>Independent Study: 156 hours (e.g. 6 hours per week on background reading and case study preparation (66 hours), 30 hours preparing for presentation element of assessment and 60 hours of exam revision)',
educationAims: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_AIMS$0" style="word-wrap: break-word;"><br><div>The module aims to develop a comprehensive understanding both of entrepreneurship theories and of how the characteristics of various settings in which it takes place, shape the nature of entrepreneurial activity. It is designed to:</div><div>x Examine the different theoretical perspectives used in entrepreneurship research and assess their usefulness for understanding the nature of entrepreneurship and the individuals engaging in entrepreneurship<br>x Consider how context shapes entrepreneurial activity<br>x Deliver insights into various settings of entrepreneurial activity e.g. social enterprise, family business, technology businesses<br>x Broaden students" appreciation of how and why entrepreneurial activity takes place<br>x Provide a critical viewpoint on how the process of entrepreneurship unfolds</div><p style="text-align:justify;text-justify:inter-ideograph;"> </p></div>',
learningOutcome: '<div class="PSLONGEDITBOX" id="UN_QAA_CRSE_OUT_UN_LEARN_OUTCOME$0" style="word-wrap: break-word;"><br><p style="text-autospace:none;">• The dynamics of the global economy and international business &amp;/or an awareness<br>of cultural, legal/regulatory, political, and economic differences across countries &amp;/or<br>an appreciation of management issues from a global perspective.<br>• Business innovation – creativity, intrapreneurial – and entrepreneurial behaviour and enterprise development, and the management and exploitation of intellectual property <br>• The importance of sustainability issues, including an understanding of the challenges<br>and opportunities arising from the activities of people and organisations on the economic, social and environmental conditions of the future.<br> </p></div>',
summaryOfContent: '<div class="PSLONGEDITBOX" id="UN_PAM_CRSE_DTL_UN_SUMMARY_CONTENT$0" style="word-wrap: break-word;"><br><p>Definitions of entrepreneurship/entrepreneurial activity; the theoretical perspectives underpinning the study of entrepreneurship; Understanding what shapes the practice of entrepreneurship both in different settings (e.g. social entrepreneurship, technology, family business, international entrepreneurship, environmental business, social media) and due to contextual influences (e.g. influence of gender, policy).</p></div>',
assessmentFurtherActivityDetail: '<br>Total Contact Hours: 44 hours (11 X 4 Hour)<br>Independent Study: 156 hours (e.g. 6 hours per week on background reading and case study preparation (66 hours), 30 hours preparing for presentation element of assessment and 60 hours of exam revision)',
methodAndFrequency: [{
activity: 'Lecture',
...
weight: '30.00',
requirements: 'Group Presentation (30 mins plus 15 mins Q&amp;A) (20% of which is the academics&rsquo; mark and 10% peer assessed). PowerPoint slides must be submitted.'
}, {
type: 'Exam 1',
weight: '70.00',
requirements: '2h exam'
}],
