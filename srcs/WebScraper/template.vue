<template>
    <div class ="module">
        ...
        <el-row>
            ...
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
            <el-col :span="18">
                <span class="content"><h3>{{ generalFurtherActivityDetail }}</h3></span>
            </el-col>
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
        </el-row>
        <br><br><br><br>
        ...
        <el-row>
            ...
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
            <el-col :span="18">
                <span class="content"><h3>{{ educationAims }}</h3></span>
            </el-col>
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
        </el-row>
        <el-row>
            ...
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
            <el-col :span="18">
                <span class="content"><h3>{{ summaryOfContent }}</h3></span>
            </el-col>
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
        </el-row>
        <el-row>
            ...
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
            <el-col :span="18">
                <span class="content"><h3>{{ learningOutCome }}</h3></span>
            </el-col>
            <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
        </el-row>
        <br><br><br><br>
                ...
                <el-card :body-style="{ padding: '0px' }">
                    <el-row>
                        <el-col :span="12">
                            ...
                            <div class="staffIntro">{{ staffIntro }}</div>
                            ...
                            <div class="staffLink">
                                ...
                                <el-link href="https://element.eleme.io" type="primary" target="_blank">Link to Google scholar</el-link>
                            </div>
                        </el-col>
                        <el-col :span="12"><img class="staffPicture" src="../assets/Module/daveTowey.png"></el-col>
                    </el-row>
                </el-card>
            </el-col>
            ...
            <el-col :span="10">
                <el-card :body-style="{ padding: '0px' }">
                    ...
                    <el-row>
                        <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
                        <el-col :span="3">
                            <span class="attribute"><h3>Telephone:</h3></span>
                        </el-col>
                        <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
                        <el-col :span="18">
                    ...
                    <el-row>
                        <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
                        <el-col :span="3">
                            <span class="attribute"><h3>Email:</h3></span>
                        </el-col>
                        <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
                        <el-col :span="18">
                            <span class="contactContent"><h3><el-link href="https://element.eleme.io" type="primary" target="_blank">Email</el-link></h3></span>
                        </el-col>
                        <el-col :span="1"><div class="grid-content bg-purple-white"></div></el-col>
                    </el-row>
                </el-card>
    ...
    export default {
        ...
        data () {
            return {
                ...
                generalFurtherActivityDetail: 'Four introductory lectures; two group meetings per week, plus lectures supporting professional and quality issues.',
                educationAims: 'This is education aims ............',
                summaryOfContent: 'This is the summary of the content.....',
                learningOutCome: 'This is the learning outcome.....',
                staffName: 'Dave Towey',
                staffIntro: 'Professor, Deputy Head of School. Deputy Director of IDIC',
                staffDepartment: 'Computer Science/Faculty of Science and Engineering',
                ...
                staffEmail: 'Dave.Towey@nottingham.edu.cn',
                assessmentTable: [{
                    type: 'Project 1',
                    weight: '80.00',
                ...
                assessmentFurtherActivityDetail: 'This is the assessment further activity'
            }
        }
    }
</script>
